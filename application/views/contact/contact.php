<div id="frame">
    ...
    <div id="masthead">
        <img
            src="/assets/img/1214368304544.jpg"
            border="0" alt="Child playing with plane" title="Child playing with plane" height='115' width='980'/>
    </div>
    <!--<END_MHB001 >-->
    <!-- <End> -->
    <!-- Navigation -->
...
//alert(str);
    ...
    if (isDoubleclickTriggered === 'false') {
        if (typeof TagIT != 'object' || (typeof TagIT.handlesDoubleClick == 'function' || !TagIT.handlesDoubleClick)) {
            ...
            dataLayer.push({"pageTitle": 'Ford Romania | Contact | Ford Company | Ford RO'});
