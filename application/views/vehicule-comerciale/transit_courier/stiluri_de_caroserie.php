...
<div id="mediaplayer1">
    ...
    <div class="mdp2Box">
        ...
        <div id="mdp">
            <img src='/assets/img/transit_courier/1214480059274.jpg' alt='Utilitara ideală pentru dumneavoastră' onclick="omnitureViewPhoto()">
        </div>
...
if(typeof(sford)=='object') omnitureMDPFullScreen('1205071929119'); return false;" >
                    ...
                    <td id="mdp2Description" style="width:50%">
                        <a id="mdpCaption">
                            Utilitara ideal&#259; pentru dumneavoastr&#259;
                        </a>
                    </td>
                    <td id="mdp2Right">
                    </td>
...
<div class="center_item">
    <div class="btoArticleTitle">Utilitara ideală pentru dumneavoastră</div>
    <div class="btoArticleText">
        <div class="btoArticleAbstract">
            <div>O gamă completă de culori de exterior, jante şi multe echipamente opţionale vă permit să alegeţi specificaţiile pentru vehiculul perfect. Dacă doriţi să includeţi dotări şi mai specializate (orice, de la culori unice ale caroseriei la sisteme de încărcare interioare pe comandă), cereţi dealerului dumneavoastră să vă pună în legătură cu Grupul nostru special de operaţii vehicule (SVO).</div>
        </div>
    </div>
</div>
<div class="center_item">
    ...
    <div class="tab001_header">
        ...
        <div
            ...
            <table cellpadding="0" cellspacing="0" border="0" title="Van">
                <thead>
                <tr>
                    <td class="tab001_header_arrow"><a href="/VehiculeComerciale/Transit-Courier/StiluriDeCaroserie/tabid=tab0" class="tab_anchor"></a></td>
                    <td class="tab001_header_label" valign="middle" style="height:41px;vertical-align:middle;">
                        ...
                        <a
                                href="/VehiculeComerciale/Transit-Courier/StiluriDeCaroserie/tabid=tab0"
                        ...
                        <div class="BTIOneItem">
                            <div class="BTIImage">
                                <div class="imgZoom">
                                        ...
                                        <img
                                                src="/assets/img/transit_courier/1214480058979.jpg"
                                                border="0" width="97"
                                                height="97"
                                                alt="Van"
                                                title="Van"
                                            ...
                                            <tr>
                                                <td style="border: 0px; text-align: justify;">
                                                    <ul>
                                                        ...
                                                        <li>Volum compartiment de &icirc;ncărcare: 2,3 metri cubi (SAE)</li>
                                                        <li>&Icirc;ncărcare prin peretele despărţitor: 2,59 m</li>
                                                        <li>Sarcină utilă max aprox.: 660 kg</li>
                        ...
                        <div class="BTIOneItem">
                            <div class="BTIImage">
                                <div class="#">
                                    ...
                                    <div>
                                        <a href="/cs/BlobServer?blobtable=MungoBlobs&#38;blobcol=urldata&#38;blobwhere=1214480056757&#38;blobkey=id" target="_blank" id="izid72937231205071921594" class="imgZoom_png" title='Zoom' onclick="overlayStart('/cs/BlobServer?blobtable=MungoBlobs&#38;blobcol=urldata&#38;blobwhere=1214480056757&#38;blobkey=id','image','Kombi','Închide'); return false;"></a>
                                    </div>
                                </div>
                            </div>
                            <div class="BTIarticleTitle">
