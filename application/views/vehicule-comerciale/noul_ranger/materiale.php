...
<!--<START_MHB001 >-->
<div id="masthead">
    <img src="/assets/img/noul_ranger/1214423958737.jpg" border="0" alt="Ranger" title="Ranger"  height = '115'  width = '980' />
</div>
<!--<END_MHB001 >-->
<!-- <End> -->
<!-- Navigation -->
    ...
    <div class="left_item">
        ...
        <div class="navmenu">
            ...
            <ul id="nextSteps" class="nextSteps">
                ...
                <li class="selected"><p>Materiale desc&#259;rcabile</p></li>
            </ul>
...
<div class="center_item">
    ...
    <div class="btoArticleText">
        <div class="btoArticleAbstract">
            Dacă vă interesează un anumit model, consultaţi ofertele noastre actuale. Sau vizitaţi cel mai apropiat dealer, pentru cele mai bune oferte disponibile.
        </div>
    </div>
</div>
<div class="center_item">
    ...
    <div id="tab001_container">
        <div class="tab001_header">
            ...
            <div
                ...
                <table cellpadding="0" cellspacing="0" border="0" title="Lista de preţuri">
                    <thead>
                    <tr>
                        <td class="tab001_header_arrow"><a href="/VehiculeComerciale/NoulRanger/MaterialeDescarcabile/tabid=tab0" class="tab_anchor"></a></td>
                        <td class="tab001_header_label" valign="middle" style="height:41px;vertical-align:middle;">
                            ...
                            <a
                                    href="/VehiculeComerciale/NoulRanger/MaterialeDescarcabile/tabid=tab0"
                                    onclick="tab001SelectTab('0');
if(typeof(sford)=='object')setOmnitureTabName('Lista de pre&#355;uri');
return false;"
                                    onmouseover="tab001HoverTab('0', true);"
                                    onmouseout="tab001HoverTab('0', false);"
                                    class="tab_anchor">Lista de preţuri</a></td>
                    </tr>
                    </thead>
                </table>
            </div>
            <div
                    ...
                    style="text-align:center;">
                <table cellpadding="0" cellspacing="0" border="0" title="Broşură">
                    <thead>
                    <tr>
                        <td class="tab001_header_arrow"><a href="/VehiculeComerciale/NoulRanger/MaterialeDescarcabile/tabid=tab1" class="tab_anchor"></a></td>
                        <td class="tab001_header_label" valign="middle" style="height:41px;vertical-align:middle;">
                            <!-- 	TD 8174 jhe method has been called from here to escape special characters -->
                            <a
                                    href="/VehiculeComerciale/NoulRanger/MaterialeDescarcabile/tabid=tab1"
                                    onclick="tab001SelectTab('1');
if(typeof(sford)=='object')setOmnitureTabName('Bro&#351;ur&#259;');
return false;"
                                    onmouseover="tab001HoverTab('1', true);"
                                    onmouseout="tab001HoverTab('1', false);"
                                    class="tab_anchor">Broşură</a></td>
                    </tr>
                    </thead>
                </table>
            </div>
                ...
                <div id="tab001-contentpane-0" class="tab001-pane-selected">
                    <div class='tab001_TabReco_ShowBTI001Collection' >
                            ...
                            <div class="BTIOneItem">
                                ...
                                <div class='BTIarticleBody'>
                                    <div class='BTIarticleText'>
                                        <a TITLE="Listă de prețuri Ford Ranger (824 KB)" HREF="/cs/BlobServer?blobtable=MungoBlobs&amp;blobcol=urldata&amp;blobheadervalue1=attachment%3Bfilename%3D%22Lista+de+preturi+Ford+Ranger.pdf%22&amp;blobheadervalue2=abinary%3Bcharset%3DUTF-8&amp;blobheadername1=Content-Disposition&amp;blobheadername2=MDT-Type&amp;blobheader=application%2Fpdf&amp;blobwhere=1214477438297&amp;blobkey=id" CLASS="download" onClick="if (typeof sford == 'object') omnitureLinkDownloadClick('brand:pricelist download:confirm:<nameplate>','event15,event43','','event:pricelist:pdf','download pricelist','pdf download','',false,'ford ranger','2013','truck');" >Descărcaţi lista completă de preţuri (PDF)</a>.
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="BTIRow">
                            <div class="BTIOneItem">
                                <div class="BTIarticleTitle">
                                    Informaţii suplimentare despre fişierul în format PDF
                                </div>
                                <div class='BTIarticleBody'>
                                    <div class='BTIarticleText'>
                                        <p>Fişierul &icirc;n format PDF a fost creat pentru a vă permite să vizualizaţi şi să&nbsp;tipăriţi fişiere fără a avea nevoie de programul &icirc;n care au fost create. Adobe&trade; vă pune la dispoziţie o aplicaţie soft gratuită (Acrobat Reader) care vă permite să lucraţi cu aceste fişiere. Dacă aţi instalat deja această aplicaţie pe computerul dumneavoastră, &icirc;n mod normal o puteţi găsi la &quot;Programe&quot;, &icirc;n &quot;Meniul Start&quot;. &Icirc;n caz contrar, accesati linkul de mai jos pentru a o descărca. </p>
                                        <p><a href="http://www.adobe.com/go/getreader/">Descarcă Acrobat Reader de pe adobe.com</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class='tab001_TabReco_ShowBTI001Collection' >
                        <div class="BTIRow">
                            <div class="BTIOneItem">
                                ...
                                <div class='BTIarticleBody'>
                                    <div class='BTIarticleText'>
                                        <div><a TITLE="Brosura Ranger (7,87 MB)" HREF="/cs/BlobServer?blobtable=MungoBlobs&amp;blobcol=urldata&amp;blobheadervalue1=attachment%3Bfilename%3D%22Brosura+Ranger.pdf%22&amp;blobheadervalue2=abinary%3Bcharset%3DUTF-8&amp;blobheadername1=Content-Disposition&amp;blobheadername2=MDT-Type&amp;blobheader=application%2Fpdf&amp;blobwhere=1214481485461&amp;blobkey=id" CLASS="download" onClick="if (typeof sford == 'object') omnitureLinkDownloadClick('brand:brochure download:<nameplate>','event15,event43','brochure:anonymous:pdf','event: brochure:pdf','download','brochure download','brochure:anonymous:pdf',false,'ford ranger','2013','truck');" >Descărcaţi broşura.</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
