...
<script type="text/javascript">var sford = new Object;
    sford.tabName = '';
    sford.pageName = 'brand:owner:service:motorcraft service:tyres:ford fiesta';
    ...
    sford.tagHighlights = '';
    sford.tagDownload = '';
    s.pageName = 'brand:owner:service:motorcraft service:tyres:ford fiesta';
...
//alert(str);
    ...
    if (isDoubleclickTriggered === 'false') {
        if (typeof TagIT != 'object' || (typeof TagIT.handlesDoubleClick == 'function' || !TagIT.handlesDoubleClick)) {
            ...
            dataLayer.push({"pageTitle": 'Anvelope Ford Fiesta | Ford RO'});
    ...
    <div class="left_item">
        ...
        <div class="navmenu">
            ...
            <ul id="nextSteps" class="nextSteps">
                ...
                <li class="selected"><p>Fiesta</p></li>
...
<div id="container_main">
    ...
    <div id="container_center">
        <div class="center_item">
            <div class="btoArticleTitle"><h1><font size="5">Anvelope de iarnă Ford Fiesta</font></h1></div>
            <div class="btoArticleText">
                <div class="btoArticleAbstract">
                    <div>E usor sa găseşti anvelopele potrivite modelui tau Ford Fiesta. <br> <br> <br> <img
                            width="100%" alt="Ford Tyre Sizing Guide" src="/assets/img/service/tyres_masthead.jpg"/><br>
                        <br> &Icirc;ncepe prin a arunca o privire &icirc;n ghidul nostru practic despre diferitele
                        dimensiuni ale anvelopelor, menţionate mai sus. Apoi, foloseşte-te de tabelele de mai jos pentru
                        a identifica cauciucurile potrivite maşinii tale Fiesta.
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="tab001_header">
                    ...
                    <div
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" title="Modele şi preţuri">
                            <thead>
                            <tr>
                                <td class="tab001_header_arrow"><a href="Fiesta/tabid%3dtab0" class="tab_anchor"></a>
                                </td>
                                <td class="tab001_header_label" valign="middle"
                                    style="height:41px;vertical-align:middle;">
                                    <!-- 	TD 8174 jhe method has been called from here to escape special characters -->
                                    <a
                                        href="Fiesta/tabid%3dtab0"
                    ...
                    <div class="tab001_content">
                        <div id="tab001-contentpane-0" class="tab001-pane-selected">
                            <div class="tab001_TabTop_IntroText">
                                <div class="btoArticleTitle"><h2><font size="5">Ghid pentru anvelope Ford Fiesta</font>
                                    </h2></div>
                                <div class="btoArticleText">
                                    <div class="btoArticleAbstract">
                                        <div>
                                            ...
                                            Toate preţurile afişate sunt preţuri recomandate de v&acirc;nzare cu TVA
                                            inclus. Nu includ manopera pentru montare şi echilibrare anvelope.<br> <br>
                                            <table width="100%" class="floatedTable">
                                                ...
                                                <tr>
                                                    <td width="25 %" valign="middle" class="CusTab-light">175/65 R14 82T TL WINTER 1
                                                    </td>
                                                    <td width="25 %" valign="middle" class="CusTab-light">Motorcraft*</td>
                                                    <td width="25 %" valign="middle" class="CusTab-light-pric"
                                                        style="text-align: center;"><span style="font-size: medium;">150* lei</span>
                                                    </td>
                                                </tr>
                                                <tr tr="" class="CusTab-dark">
                                                    <td width="25 %" valign="middle">175/65 R14 82T G-FORCE WINTER</td>
                                                    <td width="25 %" valign="middle">BFGoodrich</td>
                                                    <td width="25 %" valign="middle" class="CusTab-light-pric"
                                                        style="text-align: center;"><span style="font-size: medium;">190* lei</span>
                                                    </td>
                                                </tr>
                                                <tr tr="" class="CusTab-light">
                                                    <td width="25 %" valign="middle">175/65 R14 82T TL ALPIN A4 GRNX</td>
                                                    <td width="25 %" valign="middle">Michelin</td>
                                                    <td width="25 %" valign="middle" class="CusTab-light-pric"
                                                        style="text-align: center;"><span style="font-size: medium;">266* lei</span>
                                                    </td>
                                                </tr>
                                                <tr tr="" class="CusTab-dark">
                                                    <td width="25 %" valign="middle">195/50 R15 82H TL WINTER 1 TG</td>
                                                    <td width="25 %" valign="middle">Motorcraft*</td>
                                                    <td width="25 %" valign="middle" class="CusTab-light-pric"
                                                        style="text-align: center;"><span style="font-size: medium;">179* lei</span>
                                                    </td>
                                                </tr>
                                                <tr tr="" class="CusTab-light">
                                                    <td width="25 %" valign="middle">195/50 R15 82V G-FORCE WINTER 2</td>
                                                    <td width="25 %" valign="middle">BFGoodrich</td>
                                                    <td width="25 %" valign="middle" class="CusTab-light-pric"
                                                        style="text-align: center;"><span style="font-size: medium;">260* lei</span>
                                                    </td>
                                                </tr>
                                                <tr tr="" class="CusTab-dark">
                                                    <td width="25 %" valign="middle">195/50 R15 82T TL ALPIN A4 GRNX</td>
                                                    <td width="25 %" valign="middle">Michelin</td>
                                                    <td width="25 %" valign="middle" class="CusTab-light-pric"
                                                        style="text-align: center;"><span style="font-size: medium;">338* lei</span>
                                                    </td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        ...
                                        <div class='BTIarticleBody'>
                                            <div class='BTIarticleText'>
                                                <div><em>*Toate preturile afisate in aceasta oferta sunt preturi recomandate si contin
                                                        TVA conform legislatiei in vigoare. Pretul nu include montajul, echilibrarea si
                                                        sistemul de monitorizare a presiunii in anvelope. Anvelopele Motorcraft sunt
                                                        marca Tigar. Aceasta oferta: este supusa unor termene si conditii; este valabila
                                                        in limita stocului disponibil si poate varia in functie de seria de sasiu.
                                                        Campanie valabila pana la data de 31 martie 2017.</em>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div id="tab001-contentpane-1" class="tab001-pane-unselected">
                            <div class="tab001_TabTop_IntroText">
                                ...
                                <div class="btoArticleText">
                                    <div class="btoArticleAbstract">
                                        <div>Pentru a-ţi facilita alegerea, am reunit diferite produse şi preţuri şi
                                            le-am grupat &icirc;n 3 categorii:<br> <br> <strong> Premium</strong>:
                                            Michelin<br> <strong>Calitate</strong>: BF Goodrich, , Kebler <br> <strong>Buget</strong>:
                                            Tigar<br>
                                            <ul>
                                                <li>Toate preţurile recomandate de v&acirc;nzare includ TVA.</li>
                                                <li>&Icirc;n plus, toate anvelopele sosesc &icirc;nsoţite de un control
                                                    de siguranţă al tuturor elementelor (standard).
                                                </li>
                                                <li>Toate operaţiunile sunt executate de tehnicieni instruiţi de Ford.
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
