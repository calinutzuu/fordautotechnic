...
//alert(str);
    ...
    if (isDoubleclickTriggered === 'false') {
        if (typeof TagIT != 'object' || (typeof TagIT.handlesDoubleClick == 'function' || !TagIT.handlesDoubleClick)) {
            ...
            dataLayer.push({"pageTitle": 'Anvelope Ford Ka | Ford RO'});
...
<div id="container_center">
    <div class="center_item">
        <div class="btoArticleTitle"><h1><font size="5">Anvelope de iarnă Ford Ka</font></h1></div>
        <div class="btoArticleText">
            <div class="btoArticleAbstract">
                <div>E usor sa găseşti anvelopele potrivite modelui tau Ford Ka. <br> <br> <img width="100%"
                    ...
                    identifica cauciucurile potrivite maşinii tale Ka.
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="tab001_header">
                ...
                <div
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" title="Modele si preturi">
                        <thead>
                        <tr>
                            <td class="tab001_header_arrow"><a href="Ka/tabid%3dtab0" class="tab_anchor"></a></td>
