...
<script type="text/javascript">var sford = new Object;
    sford.tabName = '';
    sford.pageName = 'brand:owner:sync support:applink:catalogue:<tab name>';
    sford.dlwasSent = false;
    sford.eVar11 = 'brand:owner:sync support:applink:catalogue:<tab name>';
    sford.hier1 = 'owners:sync support:sync applink:catalogue';
    sford.tagViewPhoto = '';
    sford.tagHighlights = '';
    sford.tagDownload = '';
    s.pageName = 'brand:owner:sync support:applink:catalogue:<tab name>';
    s.hier1 = 'owners:sync support:sync applink:catalogue';
    s.channel = 'owners';
    s.eVar4 = 'rum';
    s.prop4 = 'rum';
    s.eVar11 = 'brand:owner:sync support:applink:catalogue:<tab name>';
    s.prop11 = 'brand:owner:sync support:applink:catalogue:<tab name>';
    s.eVar14 = 'ford-ro';
    s.prop14 = 'ford-ro';
    s.eVar15 = 'ford-owner';
...
//alert(str);
    ...
    if (isDoubleclickTriggered === 'false') {
        if (typeof TagIT != 'object' || (typeof TagIT.handlesDoubleClick == 'function' || !TagIT.handlesDoubleClick)) {
            ...
            dataLayer.push({"pageTitle": 'SYNC AppLink Catalogul | Ford Service | Ford RO'});
        ...
        <div class="left_item">
            ...
            <div class="navmenu">
                ...
                <ul id="nextSteps" class="nextSteps">
                    ...
                    <li class="selected"><p>SYNC AppLink Catalogul</p></li>
    ...
    <div id="container_main">
        <div id="container_center">
            <div class="center_item">
                <div class="btoArticleTitle">Catalogul de aplicaţii Ford</div>
                <div class="btoArticleText">
                    <div class="btoArticleAbstract">
                        DISPONIBIL &Icirc;N CUR&Acirc;ND <br>
                        <br>
                        Aici vei găsi cele mai recente aplicaţii, concepute toate pentru a putea fi utilizate &icirc;mpreună
                        cu Ford SYNC AppLink. Aşa că, te invităm să răsfoiești şi să descarci aplicaţiile dorite din
                        magazinul Google Play sau iTunes App.
                    </div>
                </div>
            </div>
            <div class="center_item">
