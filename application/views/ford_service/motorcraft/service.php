...
<script type="text/javascript">var sford = new Object;
    sford.tabName = '';
    sford.pageName = 'brand:owner:service:motorcraft service:service options:<tab name>';
    sford.dlwasSent = false;
    sford.eVar11 = 'brand:owner:service:motorcraft service:service options:<tab name>';
    sford.hier1 = 'owners:service:motorcraft service';
    sford.tagViewPhoto = '';
    sford.tagHighlights = '';
    sford.tagDownload = '';
    s.pageName = 'brand:owner:service:motorcraft service:service options:<tab name>';
    s.hier1 = 'owners:service:motorcraft service';
    s.channel = 'owners';
    s.eVar4 = 'rum';
    s.prop4 = 'rum';
    s.eVar11 = 'brand:owner:service:motorcraft service:service options:<tab name>';
    s.prop11 = 'brand:owner:service:motorcraft service:service options:<tab name>';
    s.eVar14 = 'ford-ro';
    s.prop14 = 'ford-ro';
    s.eVar15 = 'ford-owner';
...
<div class="center_item">
    ...
    <div class="btoArticleText">
        <div class="btoArticleAbstract">
            <div><strong><span style="font-size: medium;">Servicii de calitate la preturi all-inclusive pentru autovehiculele Ford cu varsta de peste 4 ani</span></strong>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="tab001_header">
        ...
        <div
            ...
            <table cellpadding="0" cellspacing="0" border="0" title="Service">
                <thead>
                <tr>
                    <td class="tab001_header_arrow"><a href="Service/tabid%3dtab0" class="tab_anchor"></a></td>
                    <td class="tab001_header_label" valign="middle" style="height:41px;vertical-align:middle;">
                        ...
                        <a
                            href="Service/tabid%3dtab0.html"
                    ...
                    <div class="BTIRow">
                        <div class="BTIOneItem">
                            <div class="BTIImage">
                                <div class="imgNonZoom">
                                    <img
                                        src="/assets/img/service/1214513078495.jpg"
                                        border="0" width="97"
                                        height="97"
                    ...
                    <div class="BTIRow">
                        <div class="BTIOneItem">
                            <div class="BTIImage">
                                <div class="imgNonZoom">
                                    <img
                                        src="/assets/img/service/1214565085109.jpg"
                                        border="0" width="97"
                                        height="97"
                            ...
                            <div class='BTIarticleBody'>
                                <div class='BTIarticleText'>
                                    <div><em>Toate preturile afisate in aceasta oferta sunt preturi recomandate, in lei,
                                            contin TVA conform legislatiei in vigoare si includ pretul manoperei. Aceasta
                                            oferta: este supusa unor termene si conditii; este valabila in limita stocului
                                            disponibil, poate varia in functie de seria de sasiu si nu se aplica
                                            autovehiculelor utilitare echipate cu jante din aliaj si/sau a celor cu roti
                                            duble spate. Campanie valabila pana la data de 31 martie 2017.
                                    &nbsp;&nbsp;
