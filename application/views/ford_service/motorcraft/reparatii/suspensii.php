...
<script type="text/javascript">var sford = new Object;
    sford.tabName = '';
    sford.pageName = 'brand:owner:service:motorcraft service:repairs:shock absorbers';
    sford.dlwasSent = false;
    sford.eVar11 = 'brand:owner:service:motorcraft service:repairs:shock absorbers';
    sford.hier1 = 'owners:service:motorcraft service:repairs:shock absorbers';
    sford.tagViewPhoto = '';
    sford.tagHighlights = '';
    sford.tagDownload = '';
    s.pageName = 'brand:owner:service:motorcraft service:repairs:shock absorbers';
    s.hier1 = 'owners:service:motorcraft service:repairs:shock absorbers';
    s.channel = 'owners';
    s.eVar4 = 'rum';
    s.prop4 = 'rum';
    s.eVar11 = 'brand:owner:service:motorcraft service:repairs:shock absorbers';
    s.prop11 = 'brand:owner:service:motorcraft service:repairs:shock absorbers';
    s.eVar14 = 'ford-ro';
    s.prop14 = 'ford-ro';
    s.eVar15 = 'ford-owner';
...
//alert(str);
    ...
    if (isDoubleclickTriggered === 'false') {
        ...
        dataLayer.push({"pageTitle": 'Suspensii fa\u0163\u0103 | Ford RO'});
                ...
                <div class="BTIOneItem">
                    <div class="BTIImage">
                        <div class="imgNonZoom">
                            <img
                                src="/assets/img/service/1214513079088.jpg"
                                border="0" width="97"
                                height="97"
