...
<script type="text/javascript">var sford = new Object;
    sford.tabName = '';
    sford.pageName = 'brand:owner:service:motorcraft service:repairs:timing belt';
    sford.dlwasSent = false;
    sford.eVar11 = 'brand:owner:service:motorcraft service:repairs:timing belt';
    sford.hier1 = 'owners:service:motorcraft service:repairs:timing belt';
    sford.tagViewPhoto = '';
    sford.tagHighlights = '';
    sford.tagDownload = '';
    s.pageName = 'brand:owner:service:motorcraft service:repairs:timing belt';
    s.hier1 = 'owners:service:motorcraft service:repairs:timing belt';
    s.channel = 'owners';
    s.eVar4 = 'rum';
    s.prop4 = 'rum';
    s.eVar11 = 'brand:owner:service:motorcraft service:repairs:timing belt';
    s.prop11 = 'brand:owner:service:motorcraft service:repairs:timing belt';
    s.eVar14 = 'ford-ro';
    s.prop14 = 'ford-ro';
    s.eVar15 = 'ford-owner';
...
//alert(str);
    ...
    if (isDoubleclickTriggered === 'false') {
        ...
        dataLayer.push({"pageTitle": 'Kit curea de distribu\u0163ie \/ pomp\u0103 de ap\u0103 | Ford RO'});
...
<div id="container_main">
    ...
    <div id="container_center">
        <div class="center_item">
            <div class="btoArticleTitle">Kit curea de distribuţie şi pompă de apă</div>
                ...
                <div class="BTIOneItem">
                    <div class="BTIImage">
                        <div class="imgNonZoom">
                            <img
                                src="/assets/img/service/1214513079432.jpg"
                                border="0" width="97"
                                height="97"
                    ...
                    <div class='BTIarticleBody'>
                        <div class='BTIarticleText'>
                            <div><strong><span style="font-size: medium;">Pentru funcţionarea &icirc;ndelungată si &icirc;n siguranţă a motorului<br> </span></strong>
                                <ul>
