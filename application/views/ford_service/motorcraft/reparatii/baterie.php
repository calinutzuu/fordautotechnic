        ...
        <div class="navmenu">
                    ...
                    <div id="navsubmenu" class="navsubmenu">
                        ...
                        <ul class="navsubmenu">
                            <li class=''>
                                <a href='../Service'>Service</a></li>
                            <li class=''>
                                <a href='../Anvelope'>Anvelope de larna</a></li>
                            <li class=''>
            ...
            <ul id="nextSteps" class="nextSteps">
                ...
                <li id='menu1205094746089' class=''>
                    <a href='Ambreiaje'/>Kit ambreiaj</a>
                    <script type="text/javascript">
...
<div id="container_main">
    ...
    <div id="container_center">
        <div class="center_item">
            <div class="btoArticleTitle"><h1><font size="5">Baterii</font></h1></div>
            <div class="btoArticleText">
                <div><span style="font-size: medium;">Vehiculele Ford integreaza multe tehnologii sofisticate. Asadar, acestea necesita baterii avansate pentru a le alimenta.

Aceasta calitate inalta este egalata de preturi accesibile si de siguranta unei garantii de trei ani.</span>
                            ...
                            <div>
                                ...
                                <table class="CusTab" style="BORDER-COLLAPSE: collapse" cellspacing="0" cellpadding="0" border="0"
                                    ...
                                    <tr class="CusTab-dark">
                                        ...
                                        <td style="vertical-align: top;"><span style="font-size: large;">356 lei </span><br></td>
    ...
    <div id="container_right">
        ...
        <div class="right_item">
            ...
            <div class="skyscraper_promo">
                <a href='http://www.ford.ro/SBE/Motorcraft/OSBOV' target="_self">
                    <img
                        src="http://www.ford.ro/cs/BlobServer?blobtable=MungoBlobs&amp;blobcol=urldata&amp;blobwhere=1214513078990&amp;blobkey=id"
            ...
            <div class="skyscraper_promo">
                <a href='../../FordAsistenta12' target="_self">
                    <img
                        src="http://www.ford.ro/cs/BlobServer?blobtable=MungoBlobs&amp;blobcol=urldata&amp;blobwhere=1214544577603&amp;blobkey=id"
