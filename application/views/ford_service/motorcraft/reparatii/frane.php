...
<script type="text/javascript">var sford = new Object;
    sford.tabName = '';
    sford.pageName = 'brand:owner:service:motorcraft service:repairs:brakes';
    sford.dlwasSent = false;
    sford.eVar11 = 'brand:owner:service:motorcraft service:repairs:brakes';
    sford.hier1 = 'owners:service:motorcraft service:repairs:brakes';
    sford.tagViewPhoto = '';
    sford.tagHighlights = '';
    sford.tagDownload = '';
    s.pageName = 'brand:owner:service:motorcraft service:repairs:brakes';
    s.hier1 = 'owners:service:motorcraft service:repairs:brakes';
    s.channel = 'owners';
    s.eVar4 = 'rum';
    s.prop4 = 'rum';
    s.eVar11 = 'brand:owner:service:motorcraft service:repairs:brakes';
    s.prop11 = 'brand:owner:service:motorcraft service:repairs:brakes';
    s.eVar14 = 'ford-ro';
    s.prop14 = 'ford-ro';
    s.eVar15 = 'ford-owner';
...
//alert(str);
    ...
    if (isDoubleclickTriggered === 'false') {
        ...
        dataLayer.push({"pageTitle": 'Sisteme de fr\u00E2nare | Ford RO'});
    ...
    <div class="left_item">
        ...
        <div class="navmenu">
            ...
            <ul id="nextSteps" class="nextSteps">
                <li class="selected"><p>Sisteme de fr&acirc;nare</p></li>
...
<div class="center_item">
    <div class="btoArticleTitle">Sisteme de frânare</div>
    ...
    <div class="BTIOneItem">
        <div class="BTIImage">
            <div class="imgNonZoom">
                <img
                    src="/assets/img/service/1214513079767.jpg"
                    border="0" width="97"
                    height="97"
                    alt="Ford Brakes"
                    title="Ford Brakes"
...
<div class='BTIarticleBody'>
<div class='BTIarticleText'>
    <h2><font size="2">Plăcuţe de fr&acirc;nă la preţuri competitive pentru modelul tău
            Ford</font></h2>
