...
<script type="text/javascript">var sford = new Object;
    sford.tabName = '';
    sford.pageName = 'brand:owner:service:motorcraft service:repairs:engine anti-freeze';
    sford.dlwasSent = false;
    sford.eVar11 = 'brand:owner:service:motorcraft service:repairs:engine anti-freeze';
    sford.hier1 = 'owners:service:motorcraft service:repairs:engine anti-freeze';
    sford.tagViewPhoto = '';
    sford.tagHighlights = '';
    sford.tagDownload = '';
    s.pageName = 'brand:owner:service:motorcraft service:repairs:engine anti-freeze';
    s.hier1 = 'owners:service:motorcraft service:repairs:engine anti-freeze';
    s.channel = 'owners';
    s.eVar4 = 'rum';
    s.prop4 = 'rum';
    s.eVar11 = 'brand:owner:service:motorcraft service:repairs:engine anti-freeze';
    s.prop11 = 'brand:owner:service:motorcraft service:repairs:engine anti-freeze';
    s.eVar14 = 'ford-ro';
    s.prop14 = 'ford-ro';
    s.eVar15 = 'ford-owner';
...
//alert(str);
    ...
    if (isDoubleclickTriggered === 'false') {
        ...
        dataLayer.push({"pageTitle": '\u00CEnlocuire lichid de r\u0103cire (antigel) | Ford RO'});
...
<div id="container_main">
    ...
    <div id="container_center">
        <div class="center_item">
            <div class="btoArticleTitle">Înlocuire lichid de răcire (antigel)</div>
                ...
                <div class="BTIOneItem">
                    ...
                    <div class='BTIarticleBody'>
                        <div class='BTIarticleText'>
                            ...
                            <div>&nbsp;<br> <br> <em>*Toate preturile afisate in aceasta oferta sunt preturi recomandate
                                    in lei, contin TVA conform legislatiei in vigoare si includ pretul manoperei. Oferta
                                    nu include componentele tehnologice. Oferta nu se aplica autovehiculelor utilitare
