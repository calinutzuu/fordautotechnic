...
<script type="text/javascript">var sford = new Object;
    sford.tabName = '';
    sford.pageName = 'brand:owner:service:motorcraft service:repairs:air conditioning';
    sford.dlwasSent = false;
    sford.eVar11 = 'brand:owner:service:motorcraft service:repairs:air conditioning';
    sford.hier1 = 'owners:service:motorcraft service:repairs:air conditioning';
    sford.tagViewPhoto = '';
    sford.tagHighlights = '';
    sford.tagDownload = '';
    s.pageName = 'brand:owner:service:motorcraft service:repairs:air conditioning';
    s.hier1 = 'owners:service:motorcraft service:repairs:air conditioning';
    s.channel = 'owners';
    s.eVar4 = 'rum';
    s.prop4 = 'rum';
    s.eVar11 = 'brand:owner:service:motorcraft service:repairs:air conditioning';
    s.prop11 = 'brand:owner:service:motorcraft service:repairs:air conditioning';
    s.eVar14 = 'ford-ro';
    s.prop14 = 'ford-ro';
    s.eVar15 = 'ford-owner';
...
//alert(str);
    ...
    if (isDoubleclickTriggered === 'false') {
        if (typeof TagIT != 'object' || (typeof TagIT.handlesDoubleClick == 'function' || !TagIT.handlesDoubleClick)) {
            ...
            dataLayer.push({"pageTitle": 'Aer condi\u0163ionat | Ford RO'});
        ...
        <div class="navmenu">
            ...
            <ul id="nextSteps" class="nextSteps">
             ...
             <!--   <li id='menu1205094747404' class=''>
                ...
                <li class="selected"><p>Verificare vizuala AC</p></li>
                </li>
...
<div id="container_main">
    ...
    <div id="container_center">
        <div class="center_item">
            <div class="btoArticleTitle"><h1><font size="5">Asigură-te ca indiferent de temperatură vei sta la fel de
