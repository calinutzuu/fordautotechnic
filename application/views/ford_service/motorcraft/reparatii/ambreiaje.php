...
<script type="text/javascript">var sford = new Object;
    sford.tabName = '';
    sford.pageName = 'brand:owner:service:motorcraft service:repairs:clutch';
    sford.dlwasSent = false;
    sford.eVar11 = 'brand:owner:service:motorcraft service:repairs:clutch';
    sford.hier1 = 'owners:service:motorcraft service:repairs:clutch';
    sford.tagViewPhoto = '';
    sford.tagHighlights = '';
    sford.tagDownload = '';
    s.pageName = 'brand:owner:service:motorcraft service:repairs:clutch';
    s.hier1 = 'owners:service:motorcraft service:repairs:clutch';
    s.channel = 'owners';
    s.eVar4 = 'rum';
    s.prop4 = 'rum';
    s.eVar11 = 'brand:owner:service:motorcraft service:repairs:clutch';
    s.prop11 = 'brand:owner:service:motorcraft service:repairs:clutch';
    s.eVar14 = 'ford-ro';
    s.prop14 = 'ford-ro';
    s.eVar15 = 'ford-owner';
...
//alert(str);
    ...
    if (isDoubleclickTriggered === 'false') {
        ...
        dataLayer.push({"pageTitle": 'Kit ambreiaj | Ford RO'});
        ...
        <div class="navmenu">
            ...
            <ul id="nextSteps" class="nextSteps">
                <li id='menu1205094746698' class=''>
                    <a href='Frane'/>Sisteme de fr&acirc;nare</a>
                    <script type="text/javascript">
                        document.id('menu1205094746698').addClass("navnextSteps");
                    </script>
                </li>
                <li class="selected"><p>Kit ambreiaj</p></li>
                <li id='menu1205094748505' class=''>
                    <a href='Stergatoare'/>&#350;terg&#259;toare de parbriz</a>
                    <script type="text/javascript">
                        document.id('menu1205094748505').addClass("navnextSteps");
                    </script>
                </li>
                <li id='menu1205094744306' class=''>
                    <a href='CureaDeDistributie'/>Kit distribu&#355;ie</a>
                    <script type="text/javascript">
...
<div id="container_main">
    ...
    <div id="container_center">
        <div class="center_item">
            <div class="btoArticleTitle">Kit ambreiaj</div>
                ...
                <div class="BTIOneItem">
                    <div class="BTIImage">
                        <div class="imgNonZoom">
                            <img
                                src="/assets/img/service/1214513079349.jpg"
                                border="0" width="97"
                                height="97"
                                ...
                                <div>
                                    ...
                                    <table width="100%" cellspacing="0" cellpadding="0" border="0"
                                        ...
                                        <tr class="CusTab-dark">
                                            <td class="CusTab-dark-left">&Icirc;nlocuire set ambreiaj (placă, disc, rulment)
                                            </td>
                                            <td><span style="font-size: large">1.330 lei<br>             </span></td>
                                            <td><span style="font-size: large">1.490 lei<br>             </span></td>
                                            <td><span style="font-size: large">1.630 lei<br>             </span></td>
                                            <td><span style="font-size: large">1.930 lei<br>             </span></td>
                                            <td><span style="font-size: large">1.580 lei<br>             </span></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                    <br> <br> <em>Toate preturile afisate in aceasta oferta sunt preturi recomandate, in lei,
                                        contin TVA conform legislatiei in vigoare si includ pretul manoperei. Aceasta oferta:
                                        este supusa unor termene si conditii; este valabila in limita stocului disponibil, poate
                                        varia in functie de seria de sasiu si nu se aplica autovehiculelor utilitare echipate cu
                                        jante din aliaj si/sau a celor cu roti duble spate. Campanie valabila pana la data de 31
