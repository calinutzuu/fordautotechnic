...
<script type="text/javascript">var sford = new Object;
    sford.tabName = '';
    sford.pageName = 'brand:owner:service:motorcraft service:repairs:wiper blades';
    sford.dlwasSent = false;
    sford.eVar11 = 'brand:owner:service:motorcraft service:repairs:wiper blades';
    sford.hier1 = 'owners:service:motorcraft service:repairs:wiper blades';
    sford.tagViewPhoto = '';
    sford.tagHighlights = '';
    sford.tagDownload = '';
    s.pageName = 'brand:owner:service:motorcraft service:repairs:wiper blades';
    s.hier1 = 'owners:service:motorcraft service:repairs:wiper blades';
    s.channel = 'owners';
    s.eVar4 = 'rum';
    s.prop4 = 'rum';
    s.eVar11 = 'brand:owner:service:motorcraft service:repairs:wiper blades';
    s.prop11 = 'brand:owner:service:motorcraft service:repairs:wiper blades';
    s.eVar14 = 'ford-ro';
    s.prop14 = 'ford-ro';
    s.eVar15 = 'ford-owner';
...
//alert(str);
    ...
    if (isDoubleclickTriggered === 'false') {
        ...
        dataLayer.push({"pageTitle": '\u015Eterg\u0103toare de parbriz | Ford RO'});
    ...
    <div class="left_item">
        ...
        <div class="navmenu">
            ...
            <ul id="nextSteps" class="nextSteps">
                ...
                <li class="selected"><p>&#350;terg&#259;toare de parbriz</p></li>
    ...
    <div class="center_item">
            ...
            <div class="BTIOneItem">
                <div class="BTIImage">
                    <div class="imgNonZoom">
                        <img
                            src="/assets/img/service/1214513078412.jpg"
                            border="0" width="97"
                            height="97"
                            alt="Ford Wipers"
                            title="Ford Wipers"
        ...
        <div class="BTIRow">
            <div class="BTIOneItem">
                ...
                <div class='BTIarticleBody'>
                    <div class='BTIarticleText'>
                        <div><strong>Alege şi instalează produsul potrivit</strong><br> <br> Dealer-ul tău Ford te
                            poate ajuta &icirc;n alegerea lamelelor ştergătoarelor de parbriz care se potrivesc
                            maşinii tale. Ca o alternativă, poţi să alegi chiar tu din cele 2 opţiuni de mai jos şi
                            să faci online rezervarea pentru asiguratrea montajului. <br> <br> <strong>Lamele
                                obişnuite pentru ştergătoare de parbriz</strong></div>
                        <ul>
                            <li>Construcţie integral metalică şi cu protecţie &icirc;mpotriva coroziunii.</li>
                            <li>Echilibrează presiunea &icirc;n momentul ştergerii prin punctele de contact dispuse
                                uniform, permiţ&acirc;nd o vizibilitate ridicată la orice viteză
                            </li>
                        </ul>
