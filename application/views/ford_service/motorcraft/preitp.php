...
<script type="text/javascript">var sford = new Object;
    sford.tabName = '';
    sford.pageName = 'brand:owner:service:motorcraft service:mot check:<tab name>';
    sford.dlwasSent = false;
    sford.eVar11 = 'brand:owner:service:motorcraft service:mot check:<tab name>';
    sford.hier1 = 'owners:service:motorcraft service:mot check';
    sford.tagViewPhoto = '';
    sford.tagHighlights = '';
    sford.tagDownload = '';
    s.pageName = 'brand:owner:service:motorcraft service:mot check:<tab name>';
    s.hier1 = 'owners:service:motorcraft service:mot check';
    s.channel = 'owners';
    s.eVar4 = 'rum';
    s.prop4 = 'rum';
    s.eVar11 = 'brand:owner:service:motorcraft service:mot check:<tab name>';
    s.prop11 = 'brand:owner:service:motorcraft service:mot check:<tab name>';
    s.eVar14 = 'ford-ro';
    s.prop14 = 'ford-ro';
    s.eVar15 = 'ford-owner';
...
//alert(str);
    ...
    if (isDoubleclickTriggered === 'false') {
        ...
        dataLayer.push({"pageTitle": 'FORD MOTORCRAFT Pre-verificarea I.T.P. | Ford RO'});
    ...
    <div class="left_item">
        ...
        <div class="navmenu">
            ...
            <ul id="nextSteps" class="nextSteps">
                ...
                <li class="selected"><p>Pre-verificare I.T.P.</p></li>
...
<div class="center_item">
    <div class="btoArticleTitle">Pre-verificare I.T.P.</div>
...
<div id="tab001_container">
    <div class="tab001_header">
        ...
        <div
            ...
            <table cellpadding="0" cellspacing="0" border="0" title="Pre-verificarea I.T.P.">
                <thead>
                <tr>
                    <td class="tab001_header_arrow"><a href="Pre-verificareITP/tabid%3dtab0" class="tab_anchor"></a>
                    </td>
                    <td class="tab001_header_label" valign="middle" style="height:41px;vertical-align:middle;">
                        ...
                        <a
                            href="Pre-verificareITP/tabid%3dtab0"
                            onclick="tab001SelectTab('0');
if(typeof(sford)=='object')setOmnitureTabName('Pre-verificarea I.T.P.');
return false;"
                            onmouseover="tab001HoverTab('0', true);"
                            onmouseout="tab001HoverTab('0', false);"
                            class="tab_anchor">Pre-verificarea I.T.P.</a></td>
                </tr>
                </thead>
            </table>
        </div>
                        ...
                        <div class="BTIOneItem">
                            <div class="BTIImage">
                                <div class="imgNonZoom">
                                    <img
                                        src="/assets/img/service/1214513078661.jpg"
                                        border="0" width="97"
                                        height="97"
                                        alt="Ford MOT"
                                        title="Ford MOT"
                            ...
                            <div class="BTIarticleTitle">
                                Un mod sigur de a preveni un refuz ITP
                            </div>
                            <div class='BTIarticleBody'>
                                <div class='BTIarticleText'>
                                    <div>Dacă maşina ta este mai veche de 3 ani, atunci trebuie supusă controlului anual
                                        I.T.P. care să certifice îndeplinirea normelor standard în vigoare privitoare la
                                        siguranţa traficului şi a mediului înconjurător. Unul din cele mai bune locuri
                                        pentru efectuarea acestei inspecţii obligatorii este unul din Dealerii
                                        autorizaţi Ford.
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="BTIRow">
                        <div class="BTIOneItem">
                            <div class="BTIImage">
                                <div class="imgNonZoom">
                                    <img
                                        src="/assets/img/service/1214513078246.jpg"
                                        border="0" width="97"
                                        height="97"
                                        alt="Ford MOT"
                                        title="Ford MOT"
                            ...
                            <div class='BTIarticleBody'>
                                <div class='BTIarticleText'>
                                    <h2><font size="2">Ford Motorcraft &ndash; Pre-verificare I.T.P. &ndash;
                                            autoturisme</font></h2>

                                    <div>&nbsp;</div>
                                    <div><span style="font-size: x-large;"><span style="color: rgb(66, 89, 104);"><b>Gratuită</b></span></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="BTIRow">
                        <div class="BTIOneItem">
                            <div class="BTIImage">
                                <div class="imgNonZoom">
                                    <img
                                        src="/assets/img/service/1214513079183.jpg"
                                        border="0" width="97"
                                        height="97"
                                        alt="Ford Commercial Vehicle MOT"
                                        title="Ford Commercial Vehicle MOT"
                                        style="border: solid 1px #999999;">
                                </div>
                            </div>
                            <div class="BTIarticleTitle">
                            ...
                            <div class='BTIarticleBody'>
                                <div class='BTIarticleText'>
                                    <h2><font size="2">Ford Motorcraft Pre-verificare I.T.P. &ndash;
                                            autoutilitare</font></h2>
            ...
            <div id="tab001-contentpane-1" class="tab001-pane-unselected">
                <div class='tab001_TabReco_ShowBTI001Collection'>
                    <div class="BTIRow">
                        <div class="BTIOneItem">
                            <div class="BTIarticleTitle">
                                Avantajele alegerii unui Dealer Ford
                            </div>
                            <div class='BTIarticleBody'>
                                <div class='BTIarticleText'>
                                    <div><strong>Scapi de griji:</strong>
                                        <ul>
                                            <li>Pre-verificare I.T.P. este extrem de riguroasă din motive ce ţin de
                                                siguranţa traficului. Din această cauză, este foarte posibil ca
                                                rezultatul testului să indice nevoia efectuării unor reparaţii
                                                suplimentare.
                                            </li>
                                            <li>Cu Ford, poţi fi sigur că aceste reparaţii se vor realiza cu respectarea
                                                strictă a standardelor, de către tehnicieni instruiţi de Ford şi
                                                folosind piese originale Ford.
                                            </li>
                                            <li>Acest lucru certifică faptul că perioada de garanţie nu va fi afectată,
                                                put&acirc;nd ajuta totodată şi la păstrarea valorii maşinii &icirc;n
                                                eventualitatea revinderii.
                                            </li>
                                        </ul>
                                        <strong>Ai informaţia la zi si poţi sa circuli din nou:</strong>
                                        <ul>
                                            <li>&Icirc;n eventualitatea unor reparaţii suplimentare, vă vom informa de
                                                fiecare dată.
                                            </li>
                                            <li>Vă vom oferi preţuri competitive şi suma totală exactă, &icirc;nsoţită
                                                de un desfăşurător detaiat (&icirc;n scris) cu prestaţiile efectuate şi
                                                sumele facturate. Acest lucru reprezintă un element din istoricul
                                                maşinii menit să liniştească orice viitor cumpărător.
                                            </li>
                                            <li>Dacă nu vă putem repara autoturismul &icirc;n aceeaşi zi cu
                                                pre-verificarea I.T.P, vă vom oferi prompt o altă programare.
                                            </li>
                                            <li>Putem stabili de comun acord un moment potrivit pentru preluarea
                                                maşinii.
                                            </li>
                                        </ul>
                                    </div>
