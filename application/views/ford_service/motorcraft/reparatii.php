...
<script type="text/javascript">var sford = new Object;
    sford.tabName = '';
    sford.pageName = 'brand:owner:service:motorcraft service:repairs';
    sford.dlwasSent = false;
    sford.eVar11 = 'brand:owner:service:motorcraft service:repairs';
    sford.hier1 = 'owners:service:motorcraft service:repairs';
    sford.tagViewPhoto = '';
    sford.tagHighlights = '';
    sford.tagDownload = '';
    s.pageName = 'brand:owner:service:motorcraft service:repairs';
    s.hier1 = 'owners:service:motorcraft service:repairs';
    s.channel = 'owners';
    s.eVar4 = 'rum';
    s.prop4 = 'rum';
    s.eVar11 = 'brand:owner:service:motorcraft service:repairs';
    s.prop11 = 'brand:owner:service:motorcraft service:repairs';
    s.eVar14 = 'ford-ro';
    s.prop14 = 'ford-ro';
    s.eVar15 = 'ford-owner';
...
//alert(str);
    ...
    if (isDoubleclickTriggered === 'false') {
        ...
        dataLayer.push({"pageTitle": 'Repara\u0163ii uzuale| Ford RO'});
    ...
    <div class="left_item">
        ...
        <div class="navmenu">
            ...
            <ul id="currentContext" class="currentContext">
                ...
                <li><p>Repara&#355;ii uzuale</p></li>
            </ul>
            <div class="navdivider"></div>
            <ul id="nextSteps" class="nextSteps">
                <li id='menu1205094746698' class=''>
                    <a href='/FordService/Motorcraft/Reparatii/Frane'/>Sisteme de fr&acirc;nare</a>
                    <script type="text/javascript">
                        document.id('menu1205094746698').addClass("navnextSteps");
                    </script>
                </li>
                <li id='menu1205094746089' class=''>
                    <a href='/FordService/Motorcraft/Reparatii/Ambreiaje'/>Kit ambreiaj</a>
                    <script type="text/javascript">
                        document.id('menu1205094746089').addClass("navnextSteps");
                    </script>
                </li>
                <li id='menu1205094748505' class=''>
                    <a href='/FordService/Motorcraft/Reparatii/Stergatoare'/>&#350;terg&#259;toare de parbriz</a>
                    <script type="text/javascript">
                        document.id('menu1205094748505').addClass("navnextSteps");
                    </script>
                </li>
                <li id='menu1205094744306' class=''>
                    <a href='/FordService/Motorcraft/Reparatii/CureaDeDistributie'/>Kit distribu&#355;ie</a>
                    <script type="text/javascript">
                        document.id('menu1205094744306').addClass("navnextSteps");
                    </script>
                </li>
                <li id='menu1205094747404' class=''>
                    <a href='/FordService/Motorcraft/Reparatii/Antigel'/>Lichid de r&#259;cire (antigel)</a>
                    <script type="text/javascript">
                        document.id('menu1205094747404').addClass("navnextSteps");
                    </script>
                </li>
                <li id='menu1205094743125' class=''>
                    <a href='/FordService/Motorcraft/Reparatii/Suspensii'/>Suspensii</a>
                    <script type="text/javascript">
                        document.id('menu1205094743125').addClass("navnextSteps");
                    </script>
                </li>
                <li id='menu1205094745568' class=''>
                    <a href='/FordService/Motorcraft/Reparatii/AerConditionat'/>Verificare vizuala AC</a>
                    <script type="text/javascript">
                        document.id('menu1205094745568').addClass("navnextSteps");
                    </script>
                </li>
                <li id='menu1205094747414' class=''>
                    <a href='/FordService/Motorcraft/Reparatii/Baterie'/>Baterie</a>
                    <script type="text/javascript">
                        document.id('menu1205094747414').addClass("navnextSteps");
                    </script>
                </li>
            </ul>
...
<div class="center_item">
    <div class="btoArticleTitle">Reparaţii uzuale</div>
        ...
        <div class="BTIOneItem">
            ...
            <div class='BTIarticleBody'>
                <div class='BTIarticleText'>
                    <div><span style="font-size: small;"><strong>Piesele originale şi tehnicienii instruiţi de Ford
                                păstrează modelul tău Ford &icirc;n cele mai bune condiţii</strong></span><br> <br>
                        Atunci c&acirc;nd e nevoie de reparaţii generale, Ford Motorcraft are multe de oferit &ndash;
                        mereu la preţuri atractive şi incluz&acirc;nd piesele de schimb şi manopera. Noi oferim
                        valoare &icirc;n shimbul banilor şi folosim de fiecare dată cele mai noi echipamente şi piese de
                        origine. Toate acestea din partea companiei care &icirc;ţi cunoaşte modelul Ford mai bine dec&acirc;t
                        oricine altcineva.
                    </div>
                </div>
            </div>
    ...
    <div class="CATWrapper">
        <div class="CATRow">
            <div class="CATItem">
                ...
                <div class="CATarticleImg">
                    <div class="imgNonZoom">
                        <img
                            src="/assets/img/service/1214513079778.jpg"
                            border="0" width="178"
                            height="100"
                            alt="Ford Brakes"
                            title="Ford Brakes"
                ...
                <div class="CATarticleBody">
                    <div class="CATarticleText">
                        <div><a HREF="Reparatii/Frane">&gt; &Icirc;nlocuirea plăcuţelor de fr&acirc;nă </a></div>
                    </div>
                </div>
            </div>
            <div class="CATItem_2and3">
                ...
                <div class="CATarticleImg">
                    <div class="imgNonZoom">
                        <img
                            src="/assets/img/service/1214513079358.jpg"
                            border="0" width="178"
                            height="100"
                            alt="Ford Clutch Kits"
                            title="Ford Clutch Kits"
                            style="border: solid 1px #999999;">
                    </div>
                </div>
                <div class="CATarticleBody">
                    <div class="CATarticleText">
                        <div><a HREF="Reparatii/Ambreiaje">&gt; &Icirc;nlocuirea kitului de ambreiaj</a></div>
                    </div>
                </div>
            </div>
            <div class="CATItem_2and3">
                ...
                <div class="CATarticleImg">
                    <div class="imgNonZoom">
                        <img
                            src="/assets/img/service/1214513078421.jpg"
                            border="0" width="178"
                            height="100"
                            alt="Ford Wipers"
                            title="Ford Wipers"
                ...
                <div class="CATarticleBody">
                    <div class="CATarticleText">
                        <div><a HREF="Reparatii/Stergatoare">&gt; &Icirc;nlocuirea ştergatoarelor de parbriz</a>
                        </div>
                    </div>
                </div>
            </div>
        </div>
        <div style="height:0; overflow:hidden; margin:-1px 0 0 0; clear:both;"></div>
        <div class="CATRow">
            <div class="CATItem">
                <div class="CATarticleTitle">
                    <div class="CATarticleTitle_2">
                ...
                <div class="CATarticleImg">
                    <div class="imgNonZoom">
                        <img
                            src="/assets/img/service/1214513079441.jpg"
                            border="0" width="178"
                            height="100"
                            alt="Ford Timing Belt Kit"
                            title="Ford Timing Belt Kit"
                            style="border: solid 1px #999999;">
                    </div>
                </div>
                <div class="CATarticleBody">
                    <div class="CATarticleText">
                        <div><a HREF="Reparatii/CureaDeDistributie">&Icirc;nlocuire kit de distribiţie</a></div>
                    </div>
                </div>
            </div>
            <div class="CATItem_2and3">
                <div class="CATarticleTitle">
                    <div class="CATarticleTitle_2">
                        Lichid de racire / antigel
                    </div>
                </div>
                <div class="CATarticleImg">
                    <div class="imgNonZoom">
                        <img
                            src="/assets/img/service/1214513078836.jpg"
                            border="0" width="178"
                            height="100"
                            alt="Ford Antifreeze"
                ...
                <div class="CATarticleBody">
                    <div class="CATarticleText">
                        <div><a HREF="Reparatii/Antigel">&gt; &Icirc;nlocuirea lichidului de răcire /
                                antigelului</a></div>
                    </div>
                </div>
            </div>
            <div class="CATItem_2and3">
                ...
                <div class="CATarticleImg">
                    <div class="imgNonZoom">
                        <img
                            src="/assets/img/service/1214513079097.jpg"
                            border="0" width="178"
                            height="100"
                            alt="Ford Shock Absorber"
                            title="Ford Shock Absorber"
                            style="border: solid 1px #999999;">
                    </div>
                </div>
                <div class="CATarticleBody">
                    <div class="CATarticleText">
                        <div><a HREF="Reparatii/Suspensii">&gt; &Icirc;nlocuirea amortizoarelor</a></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="CATRow">
            <div class="CATItem">
                ...
                <div class="CATarticleImg">
                    <div class="imgNonZoom">
                        <img
                            src="/assets/img/service/1214546731313.jpg"
                            border="0" width="178"
                            height="100"
                            alt="Ford Air conditioning"
                            title="Ford Air conditioning"
                            style="border: solid 1px #999999;">
                    </div>
                </div>
                <div class="CATarticleBody">
                    <div class="CATarticleText">
                        <div><a HREF="Reparatii/AerConditionat">&gt; Verificare vizuală AC</a></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="CATItem_2and3">
            ...
            <div class="CATarticleImg">
                <div class="imgNonZoom">
                    <img
                        src="/assets/img/service/1214565085215.jpg"
                        border="0" width="178"
                        height="100"
                        alt="Ford Batteries"
            ...
            <div class="CATarticleBody">
                <div class="CATarticleText">
                    <div><a HREF="/FordService/Motorcraft/Reparatii/Baterie" >&gt; Schimb baterie </a></div></div>
            </div>
        </div>
