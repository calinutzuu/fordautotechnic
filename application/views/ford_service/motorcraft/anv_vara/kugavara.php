...
<div id="container_center">
    <div class="center_item">
        <div class="btoArticleTitle"><h1><font size="5">Anvelope vara Ford Kuga</font></h1></div>
                                ...
                                <div class="btoArticleAbstract">
                                    <div>
                                        ...
                                        <table class="floatedTable" width="100%">
                                            ...
                                            <tr>
                                                <td class="CusTab-light" valign="middle" width="25 %">235/55 R17 103V
                                                    EXTRA LOAD TL SUV SUMMER TG
                                                </td>
                                                <td class="CusTab-light" style="text-align: center;" valign="middle"
                                                    width="25 %">Motorcraft
                                                </td>
                                                <td style="text-align: center;" class="CusTab-light-pric"
                                                    valign="middle" width="25 %"><span style="font-size: medium;">355 lei</span>
                                                </td>
                                            </tr>
                                            <tr class="CusTab-dark" tr="">
                                                <td valign="middle" width="25 %">235/55 R17 103 H EL. TL LATITUDE CROSS
                                                    MI
                                                </td>
                                                <td style="text-align: center;" valign="middle" width="25 %">Michelin
                                                </td>
                                                <td style="text-align: center;" class="CusTab-light-pric"
                                                    valign="middle" width="25 %"><span style="font-size: medium;">722 lei</span>
                                                </td>
                                            </tr>
