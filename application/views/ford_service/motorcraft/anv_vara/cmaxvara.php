...
<script type="text/javascript">var sford = new Object;
    sford.tabName = '';
    sford.pageName = 'brand:owner:service:motorcraft service:tyres:ford c-max';
    ...
    sford.tagHighlights = '';
    sford.tagDownload = '';
    s.pageName = 'brand:owner:service:motorcraft service:tyres:ford c-max';
    ...
    <div class="left_item">
        ...
        <div class="navmenu">
            ...
            <ul id="nextSteps" class="nextSteps">
                ...
                <li class="selected"><p>C-MAX</p></li>
    ...
    <div class="center_item">
        ...
        <div class="btoArticleText">
            <div class="btoArticleAbstract">
                <div>E usor sa găseşti anvelopele potrivite modelui tau Ford C-MAX. <br> <br> <img
            ...
            <div class="tab001_header">
                ...
                <div
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" title="Modele şi preţuri">
                        <thead>
                        <tr>
                            <td class="tab001_header_arrow"><a href="C-MAX/tabid%3dtab0" class="tab_anchor"></a>
                            </td>
                                        ...
                                        <table class="floatedTable" width="100%">
                                            ...
                                            <tr>
                                                ...
                                                <td class="CusTab-light-pric" style="text-align: center;"
                                                    valign="middle" width="25 %"><span style="font-size: medium;">339 lei*  </span>
                                                </td>
                                            </tr>
                                            ...
                                            <tr tr="" class="CusTab-light">
                                                ...
                                                <td class="CusTab-light-pric" style="text-align: center;"
                                                    valign="middle" width="25 %"><span style="font-size: medium;">331 lei*  </span>
                                                </td>
                                            </tr>
                                            <tr tr="" class="CusTab-dark">
                                                ...
                                                <td class="CusTab-light-pric" style="text-align: center;"
                                                    valign="middle" width="25 %"><span style="font-size: medium;">345 lei*  </span>
                                                </td>
                                            </tr>
                                            <tr tr="" class="CusTab-light">
                                                <td valign="middle" width="25 %">205/55 R16 91H
                                            ...
                                            <tr tr="" class="CusTab-dark">
                                                ...
                                                <td class="CusTab-light-pric" style="text-align: center;"
                                                    valign="middle" width="25 %"><span style="font-size: medium;">381 lei*  </span>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
