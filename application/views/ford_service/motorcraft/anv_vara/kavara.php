...
<div id="cookieAlertBoxID" class="cookieAlertBox">
    <div class="midContent">
        ...
        <p align="left">Fi?ierele de tip cookie sunt esen?iale pentru ca dumneavoastr? s? utiliza?i la maximum site-ul
            ...
            ajutorul set?rilor dumneavoastr? de navigare din Ghidul Ford privind fi?ierele de tip cookie.</p><a
...
<script type="text/javascript">var sford = new Object;
    sford.tabName = '';
    sford.pageName = 'brand:owner:service:motorcraft service:tyres:ford ka';
    ...
    sford.tagHighlights = '';
    sford.tagDownload = '';
    s.pageName = 'brand:owner:service:motorcraft service:tyres:ford ka';
    ...
    <div class="left_item">
        ...
        <div class="navmenu">
            ...
            <ul id="nextSteps" class="nextSteps">
                ...
                <li id='menu1205096661725' class=''>
                    <a href='Transit'/>Transit</a>
                    <script type="text/javascript">
                        document.id('menu1205096661725').addClass("navnextSteps");
                    </script>
                </li>
            </ul>
...
<div class="center_item">
    <div class="btoArticleTitle"><h1><font size="5">Anvelope de vara Ford KA</font></h1></div>
    <div class="btoArticleText">
        <div class="btoArticleAbstract">
            <div>E usor sa găseşti anvelopele potrivite modelui tau Ford Ka. <br> <br> <img
                    src="/assets/img/tyres_masthead.jpg"
                    alt="Ford Tyre Sizing Guide" width="100%"/><br> <br> Începe prin a arunca o privire în ghidul nostru
                practic despre diferitele dimensiuni ale anvelopelor, menţionate mai sus. Apoi, foloseşte-te de tabelele
                de mai jos pentru a identifica cauciucurile potrivite maşinii tale Ka.
            </div>
        </div>
    </div>
</div>
...
<div class="tab001_header">
    ...
    <div
        ...
        <table cellpadding="0" cellspacing="0" border="0" title="Modele si preturi">
            <thead>
            <tr>
                <td class="tab001_header_arrow"><a href="Ka/tabid%3dtab0.html" class="tab_anchor"></a></td>
...
return false;"
                        ...
                        class="tab_anchor">Modele si preturi</a></td>
            </tr>
            </thead>
        </table>
    </div>
    ...
    <div class="tab001_content">
        <div id="tab001-contentpane-0" class="tab001-pane-selected">
            <div class="tab001_TabTop_IntroText">
                <div class="btoArticleTitle"><h2><font size="5">Ghid pentru anvelope Ford Ka</font></h2>
                </div>
                <div class="btoArticleText">
                    <div class="btoArticleAbstract">
                        <div>
                            ...
                            <table class="floatedTable" width="100%">
                                ...
                                <tr class="CusTab-header">
                                    ...
                                    <td style="text-align: center;" valign="middle" width="25 %">MARCA</td>
                                    <td style="text-align: center;" valign="middle" width="25 %">PRET</td>
                                </tr>
                                <tr>
                                    <td class="CusTab-light" valign="middle" width="34 %">175/65 R14 82T
                                    </td>
                                    <td class="CusTab-light" style="text-align: center;" valign="middle"
                                        width="25 %">Motorcraft*
                                    </td>
                                    <td style="text-align: center;" class="CusTab-light-pric"
                                        valign="middle" width="25 %"><span style="font-size: medium;">175 lei*</span>
                                    </td>
                                </tr>
                                <tr class="CusTab-dark" tr="">
                                    <td valign="middle" width="34 %">175/65 R14 82T
                                    </td>
                                    <td style="text-align: center;" valign="middle" width="25 %">BFGoodrich
                                    </td>
                                    <td style="text-align: center;" class="CusTab-light-pric"
                                        valign="middle" width="25 %"><span style="font-size: medium;">220 lei*</span>
                                    </td>
                                </tr>
                                <tr class="CusTab-light" tr="">
                                    <td valign="middle" width="40 %">175/65 R14 82T</td>
                                    <td style="text-align: center;" valign="middle" width="25 %">
                                        Michelin
                                    </td>
                                    <td style="text-align: center;" class="CusTab-light-pric"
                                        valign="middle" width="25 %"><span style="font-size: medium;">298 lei*</span>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                    ...
                    <div class="BTIOneItem">
                        ...
                        <div class='BTIarticleBody'>
                            <div class='BTIarticleText'>
                                <div><em>
                                        Alegerea anvelopelor, a marcii si a pretului <br>

                                        Pentru a-ti facilita alegerea, am inclus in oferta produse care se incadreaza in trei categorii de pret: anvelope premium, marca Michelin; anvelope de calitate, marca BF Goodrich, precum si anvelope de buget, marca Motorcraft (Tigar).
                                        <br>
                                        ● Toate preturile recomandate de vanzare includ TVA.<br>
                                        ...
                                        Toate prețurile afișate în această ofertă sunt prețuri recomandate și conțin TVA conform legislației în vigoare. Oferta nu include montajul, echilibrarea și sistemul de monitorizare a presiunii în anvelope. De asemenea, oferta se poate modifica în funcție de seria de sasiu. Alte detalii aferente ofertei sunt disponibile în paginile de promoție detaliate pe ford.ro și în rețeaua de reparatori autorizați Ford. Campania este valabilă în perioada 01 Ianuarie - 29 Februarie 2020. Anvelopele Motorcraft sunt marca Tigar.
        ...
        <div id="tab001-contentpane-1" class="tab001-pane-unselected">
            <div class="tab001_TabTop_IntroText">
                <div class="btoArticleTitle">Alegerea anvelopelor, a m?rcii ?i a pre?ului</div>
                <div class="btoArticleText">
                    <div class="btoArticleAbstract">
                        <div>Pentru a-ti facilita alegerea, am inclus in oferta produse care se incadreaza
                            ...
                            (Tigar).<br>
                            <ul>
                                <li>Toate pre?urile recomandate de v&acirc;nzare includ TVA.</li>
                                <li>&Icirc;n plus, toate anvelopele sosesc &icirc;nso?ite de un control de
                                    siguran?? al tuturor elementelor (standard).
                                </li>
                                <li>Toate opera?iunile sunt executate de tehnicieni instrui?i de Ford.</li>
                            </ul>
                        </div>
                    </div>
                </div>
