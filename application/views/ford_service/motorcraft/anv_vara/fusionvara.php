...
<div class="center_item">
    <div class="btoArticleTitle"><h1><font size="5">Anvelope vara Ford Fusion</font></h1></div>
                        ...
                        <div class="btoArticleAbstract">
                            <div>
                                ...
                                <table class="floatedTable" width="100%">
                                    ...
                                    <tr>
                                        <td class="CusTab-light" valign="middle" width="25 %">175/65 R14 82T TL
                                            SIGURA TG
                                        </td>
                                        ...
                                        <td style="text-align: center;" class="CusTab-light-pric"
                                            valign="middle" width="25 %"><span style="font-size: medium;">151 lei</span>
                                        </td>
                                    </tr>
                                    <tr class="CusTab-dark" tr="">
                                        <td valign="middle" width="25 %">175/65 R14 82T TL ENERGY SAVER+ GRNX
                                            MI
                                        </td>
                                        <td style="text-align: center;" valign="middle" width="25 %">Michelin
                                        </td>
                                        <td style="text-align: center;" class="CusTab-light-pric"
                                            valign="middle" width="25 %"><span style="font-size: medium;">286 lei</span>
                                        </td>
                                    </tr>
                        ...
                        <div class="BTIOneItem">
                            ...
                            <div class='BTIarticleBody'>
                                <div class='BTIarticleText'>
                                    <div><em>
                                            Toate preturile afisate in aceasta oferta sunt preturi recomandate si contin
                                            TVA conform legislatiei in vigoare. Oferta nu include montajul, echilibrarea
                                            si sistemul de monitorizare a presiunii in anvelope. De asemenea, oferta se
                                            poate modifica in functie de seria de sasiu. Alte detalii aferente ofertei
                                            sunt disponibile in paginile de promotie detaliate pe ford.ro si in reteaua
                                            de reparatori autorizati Ford.<br>
