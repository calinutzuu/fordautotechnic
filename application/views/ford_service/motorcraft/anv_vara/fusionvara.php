...
<script type="text/javascript">var sford = new Object;
    sford.tabName = '';
    sford.pageName = 'brand:owner:service:motorcraft service:tyres:ford fusion';
    ...
    sford.tagHighlights = '';
    sford.tagDownload = '';
    s.pageName = 'brand:owner:service:motorcraft service:tyres:ford fusion';
    ...
    s.eVar15 = 'ford-owner';
    s.prop15 = 'ford-owner';
    s.eVar16 = 'ford fusion';
    s.prop16 = 'ford fusion';
    sford.np = 'ford fusion';
    sford.vc = 'car';</script>
<script type="text/javascript">
    // <![CDATA[ 
    var __dOC = false;
        ...
        <div class="navmenu">
            ...
            <ul id="currentContext" class="currentContext">
                ...
                <li id='menu1205094748158' class=''>
                    <a href='http://www.ford.ro/FordService/Motorcraft'/>Ford Motorcraft</a>
                    <div id="navsubmenu" class="navsubmenu">
                        <div class="navsubmenutop">
                        </div>
                        <ul class="navsubmenu">
                            ...
                            <li class=''>
                                <a href='../AnvelopeIarna'>Anvelope vara</a></li>
                        </ul>
                        <div class="navsubmenubottom">
                        </div>
                    </div>
            ...
            <ul id="nextSteps" class="nextSteps">
                ...
                <li class="selected"><p>Fusion</p></li>
...
<div class="center_item">
    <div class="btoArticleTitle"><h1><font size="5">Anvelope de vara Ford Fusion</font></h1></div>
    <div class="btoArticleText">
        <div class="btoArticleAbstract">
            <div>E usor sa găseşti anvelopele potrivite modelui tau Ford Fusion. <br> <br> <img
    ...
    <div class="tab001_header">
        ...
        <div
            ...
            <table cellpadding="0" cellspacing="0" border="0" title="Modele şi preţuri">
                <thead>
                <tr>
                    <td class="tab001_header_arrow"><a href="Fusion/tabid%3dtab0" class="tab_anchor"></a>
                    </td>
        ...
        <div class="tab001_content">
            <div id="tab001-contentpane-0" class="tab001-pane-selected">
                <div class="tab001_TabTop_IntroText">
                    <div class="btoArticleTitle"><h2><font size="5">Ghid pentru anvelope Ford Fusion</font></h2>
                    </div>
                    <div class="btoArticleText">
                        <div class="btoArticleAbstract">
                            <div>
