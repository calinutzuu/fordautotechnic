...
<script type="text/javascript">var sford = new Object;
    sford.tabName = '';
    sford.pageName = 'brand:owner:service:motorcraft service:tyres:ford focus';
    ...
    sford.tagHighlights = '';
    sford.tagDownload = '';
    s.pageName = 'brand:owner:service:motorcraft service:tyres:ford focus';
    ...
    <div class="left_item">
        ...
        <div class="navmenu">
            ...
            <ul id="nextSteps" class="nextSteps">
                ...
                <li class="selected"><p>Focus</p></li>
...
<div class="center_item">
    <div class="btoArticleTitle"><h1><font size="5">Anvelope de vara Ford Focus</font></h1></div>
    <div class="btoArticleText">
        <div class="btoArticleAbstract">
            <div>E usor sa găseşti anvelopele potrivite modelui tau Ford Focus. <br><br> <br> <img
                ...
                sus. Apoi, foloseşte-te de tabelele de mai jos pentru a identifica cauciucurile potrivite maşinii
                tale Focus.
            </div>
        </div>
    </div>
...
<div class="tab001_header">
    ...
    <div
        ...
        <table cellpadding="0" cellspacing="0" border="0" title="Modele şi preţuri">
            <thead>
            <tr>
                <td class="tab001_header_arrow"><a href="Focus/tabid%3dtab0" class="tab_anchor"></a>
                </td>
    ...
    <div class="tab001_content">
        <div id="tab001-contentpane-0" class="tab001-pane-selected">
            <div class="tab001_TabTop_IntroText">
                <div class="btoArticleTitle"><h2><font size="5">Ghid pentru anvelope Ford Focus</font></h2>
                </div>
                <div class="btoArticleText">
                    <div class="btoArticleAbstract">
                        <div>
                            ...
                            <table class="floatedTable" width="100%">
                                ...
                                <tr>
                                    <td class="CusTab-light" valign="middle" width="25 %">195/65 R15 91T
                                    </td>
                                    <td class="CusTab-light" style="text-align: center;" valign="middle"
                                        width="25 %">Motorcraft*
                                    </td>
                                    <td class="CusTab-light-pric" style="text-align: center;"
                                        valign="middle" width="25 %"><span style="font-size: medium;">195 lei*  </span>
                                    </td>
                                </tr>
                                <tr tr="" class="CusTab-dark">
                                    <td valign="middle" width="25 %">195/65 R15 91T
                                    </td>
                                    <td style="text-align: center;" valign="middle" width="25 %">
                                        BFGoodrich
                                    </td>
                                    <td class="CusTab-light-pric" style="text-align: center;"
                                        valign="middle" width="25 %"><span style="font-size: medium;">247 lei*  </span>
                                    </td>
                                </tr>
                                <tr tr="" class="CusTab-light">
                                    <td valign="middle" width="25 %">195/65 R15 91T</td>
                                    <td style="text-align: center;" valign="middle" width="25 %">
                                        Michelin
                                    </td>
                                    <td class="CusTab-light-pric" style="text-align: center;"
                                        valign="middle" width="25 %"><span style="font-size: medium;">314 lei*  </span>
                                    </td>
                                </tr>
                                <tr tr="" class="CusTab-dark">
                                    <td valign="middle" width="25 %">205/55 R16 91H
                                    </td>
                                    <td style="text-align: center;" valign="middle" width="25 %">
                                        Motorcraft*
                                    </td>
                                    <td class="CusTab-light-pric" style="text-align: center;"
                                        valign="middle" width="25 %"><span style="font-size: medium;">199 lei*  </span>
                                    </td>
                                </tr>
                                <tr tr="" class="CusTab-light">
                                    <td valign="middle" width="25 %">205/55 R16 91H
                                    ...
                                    <td class="CusTab-light-pric" style="text-align: center;"
                                        valign="middle" width="25 %"><span style="font-size: medium;">263 lei*  </span>
                                    </td>
                                </tr>
                                <tr tr="" class="CusTab-dark">
                                    <td valign="middle" width="25 %">205/55 R16 91H</td>
                                    <td style="text-align: center;" valign="middle" width="25 %">
                                        Michelin
                                    </td>
                                    <td class="CusTab-light-pric" style="text-align: center;"
                                        valign="middle" width="25 %"><span style="font-size: medium;">369 lei*  </span>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                    ...
                    <div class="BTIOneItem">
                        ...
                        <div class='BTIarticleBody'>
                            <div class='BTIarticleText'>
                                <div><em>Alegerea anvelopelor, a marcii si a pretului <br>
                                        ...
                                        Toate prețurile afișate în această ofertă sunt prețuri recomandate și conțin TVA conform legislației în vigoare Oferta nu include montajul, echilibrarea și sistemul de monitorizare a presiunii în anvelope. De asemenea, oferta se poate modifica în funcție de seria de sasiu. Alte detalii aferente ofertei sunt disponibile în paginile de promoție detaliate pe ford.ro și în rețeaua de reparatori autorizați Ford. Campanie valabila pana la data de 30 Septembrie 2019.
                                    </em></div>
                            </div>
                        </div>
                    </div>
