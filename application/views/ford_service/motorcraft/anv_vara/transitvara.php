...
<div id="cookieAlertBoxID" class="cookieAlertBox">
    <div class="midContent">
        ...
        <p align="left">Fişierele de tip cookie sunt esenţiale pentru ca dumneavoastră să utilizaţi la maximum site-ul
            ...
            ajutorul setărilor dumneavoastră de navigare din Ghidul Ford privind fişierele de tip cookie.</p><a
            id="linkID" class="link"
            href="/Footer/GhidulFordPrivindFisiereleDeTipCookie?intcmp=other-nwp-cookies-cookie-alert-link">
            Aflați mai multe </a>                                </p></div>
</div>
...
<script type="text/javascript">var sford = new Object;
    sford.tabName = '';
    sford.pageName = 'brand:owner:service:motorcraft service:tyres:ford transit';
    sford.dlwasSent = false;
    sford.eVar11 = 'brand:owner:service:motorcraft service:tyres';
    sford.hier1 = 'owners:service:motorcraft service:tyres';
    sford.tagViewPhoto = '';
    sford.tagHighlights = '';
    sford.tagDownload = '';
    s.pageName = 'brand:owner:service:motorcraft service:tyres:ford transit';
    s.hier1 = 'owners:service:motorcraft service:tyres';
    s.channel = 'owners';
    s.eVar4 = 'rum';
    s.prop4 = 'rum';
    s.eVar11 = 'brand:owner:service:motorcraft service:tyres';
    s.prop11 = 'brand:owner:service:motorcraft service:tyres';
    s.eVar14 = 'ford-ro';
    s.prop14 = 'ford-ro';
    s.eVar15 = 'ford-owner';
    s.prop15 = 'ford-owner';
    s.eVar16 = 'ford transit';
    s.prop16 = 'ford transit';
    sford.np = 'ford transit';
    sford.vc = 'commercial-trucks';</script>
<script type="text/javascript">
    // <![CDATA[ 
    var __dOC = false;
        ...
        <div class="navmenu">
            ...
            <ul id="currentContext" class="currentContext">
                <li id='menu1205019843457' class=''>
                    ...
                    <div id="navsubmenu" class="navsubmenu">
                        ...
                        <ul class="navsubmenu">
                            ...
                            <li class=''>
                                <a href='/FordService/GarantiiSiRevizii'>Garan&#355;ii &#351;i revizii
                                    Ford</a></li>
                            <li class=''>
                            ...
                            <li class=''>
                                <a href='/FordService/Ford-Lifestyle-Collection'>Ford Lifestyle
                                    Collection</a></li>
                            <li class=''>
                                <a href='/FordService/FordSYNC'>Ford SYNC</a></li>
                            <li class=''>
                                <a href='/FordService/Euro_NCAP_Advanced'>Euro NCAP Advanced</a></li>
                            <li class=''>
                                <a href='/FordService/E10'>Combustibil E10</a></li>
                            <li class=''>
                                <a href='/FordService/Informatii'>Informa&#355;ii</a></li>
                            <li class=''>
                                <a href='/FordService/IntrebariFrecvente'>&Icirc;ntreb&#259;ri
                                    frecvente</a></li>
                            <li class=''>
                                <a href='/FordService/Refrigerant_R134a'>Refrigerant R134a</a></li>
                        </ul>
                ...
                <li id='menu1205094748158' class=''>
                    <a href='/FordService/Motorcraft'/>Ford Motorcraft</a>
                    <div id="navsubmenu" class="navsubmenu">
                        <div class="navsubmenutop">
                        </div>
                        <ul class="navsubmenu">
                            ...
                            <li class=''>
                                <a href='../Reparatii'>Repara&#355;ii uzuale</a></li>
                            <li class=''>
                                <a href='../AnvelopeIarna'>Anvelope iarna</a></li>
                        </ul>
                        <div class="navsubmenubottom">
                        </div>
                    </div>
            ...
            <ul id="nextSteps" class="nextSteps">
                <li id='menu1205094745463' class=''>
                    <a href='Ka'/>Ka</a>
                    <script type="text/javascript">
                        document.id('menu1205094745463').addClass("navnextSteps");
                    </script>
                </li>
                <li id='menu1205094744368' class=''>
                    <a href='Fiesta'/>Fiesta</a>
                    <script type="text/javascript">
                        document.id('menu1205094744368').addClass("navnextSteps");
                    </script>
                </li>
                <li id='menu1205094742662' class=''>
                    <a href='Fusion'/>Fusion</a>
                    <script type="text/javascript">
                        document.id('menu1205094742662').addClass("navnextSteps");
                    </script>
                </li>
                <li id='menu1205094745036' class=''>
                    <a href='Focus'/>Focus</a>
                    <script type="text/javascript">
                        document.id('menu1205094745036').addClass("navnextSteps");
                    </script>
                </li>
                <li id='menu1205094746134' class=''>
                    <a href='C-MAX'/>C-MAX</a>
                    <script type="text/javascript">
                        document.id('menu1205094746134').addClass("navnextSteps");
                    </script>
                </li>
                <li id='menu1205094742317' class=''>
                    <a href='Mondeo'/>Mondeo</a>
                    <script type="text/javascript">
                        document.id('menu1205094742317').addClass("navnextSteps");
                    </script>
                </li>
                <li id='menu1205094745059' class=''>
                    <a href='Kuga'/>Kuga</a>
                    <script type="text/javascript">
                        document.id('menu1205094745059').addClass("navnextSteps");
                    </script>
                </li>
                <li class="selected"><p>Transit</p></li>
            </ul>
...
<div id="container_center">
    <div class="center_item">
        <div class="btoArticleTitle"><h1><font size="5">Anvelope vara Ford Transit</font></h1></div>
        <div class="btoArticleText">
            <div class="btoArticleAbstract">
                <div>E usor sa găseşti anvelopele potrivite modelui tau Ford Transit. <br> <br> <img
                        src="/assets/img/tyres_masthead.jpg"
                        alt="Ford Tyre Sizing Guide" width="100%"/><br> <br> &Icirc;ncepe prin a arunca o
                    privire &icirc;n ghidul nostru practic despre diferitele dimensiuni ale anvelopelor, menţionate mai
                    sus. Apoi, foloseşte-te de tabelele de mai jos pentru a identifica cauciucurile potrivite
                    vehiculului tău Transit.
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="tab001_header">
                ...
                <div
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" title="Modele şi preţuri">
                        <thead>
                        <tr>
                            <td class="tab001_header_arrow"><a href="Transit/tabid%3dtab0" class="tab_anchor"></a>
                            </td>
...
return false;"
                ...
                <div
                    ...
                    style="text-align:center;">
                    <table cellpadding="0" cellspacing="0" border="0" title="Mărci şi avantaje ">
                        <thead>
                        <tr>
                            <td class="tab001_header_arrow"><a href="Transit/tabid%3dtab1" class="tab_anchor"></a>
                            </td>
                            <td class="tab001_header_label" valign="middle" style="height:41px;vertical-align:middle;">
                                <!-- 	TD 8174 jhe method has been called from here to escape special characters -->
                                <a
                                    href="Transit/tabid%3dtab1"
                                    onclick="tab001SelectTab('1');
if(typeof(sford)=='object')setOmnitureTabName('M&#259;rci &#351;i avantaje ');
return false;"
                                    onmouseover="tab001HoverTab('1', true);"
                                    onmouseout="tab001HoverTab('1', false);"
                                    class="tab_anchor">Mărci şi avantaje </a></td>
                        </tr>
                        </thead>
                    </table>
                </div>
                ...
                <div class="tab001_content">
                                    ...
                                    <div>
                                        ...
                                        <table class="floatedTable" width="100%">
                                            ...
                                            <tr class="CusTab-header">
                                                ...
                                                <td style="text-align: center;" valign="middle" width="25 %">MARCĂ</td>
                                                <td style="text-align: center;" valign="middle" width="25 %">PRET</td>
                                            </tr>
                                            <tr>
                                                <td class="CusTab-light" valign="middle" width="25 %">185/75 R 16C
                                                    104/102R TL CARGO SPEED TG
                                                </td>
                                                <td class="CusTab-light" style="text-align: center;" valign="middle"
                                                    width="25 %">Motorcraft
                                                </td>
                                                <td style="text-align: center;" class="CusTab-light-pric"
                                                    valign="middle" width="25 %"><span style="font-size: medium;">273 lei</span>
                                                </td>
                                            </tr>
                                            <tr class="CusTab-dark" tr="">
                                                <td valign="middle" width="25 %">185/75 R 16C 104/102R TL AGILIS+ GRNX
                                                    MI
                                                </td>
                                                <td style="text-align: center;" valign="middle" width="25 %">Michelin
                                                </td>
                                                <td style="text-align: center;" class="CusTab-light-pric"
                                                    valign="middle" width="25 %"><span style="font-size: medium;">540 lei</span>
                                                </td>
                                            </tr>
                                            <tr class="CusTab-light" tr="">
                                                <td valign="middle" width="25 %">185/75 R 16C 104/102R TL ACTIVAN GO
                                                </td>
                                                <td style="text-align: center;" valign="middle" width="25 %">
                                                    BFGoodrich
                                                </td>
                                                <td style="text-align: center;" class="CusTab-light-pric"
                                                    valign="middle" width="25 %"><span style="font-size: medium;">365 lei</span>
                                                </td>
                                            </tr>
                                            <tr class="CusTab-dark" tr="">
                                                <td valign="middle" width="25 %">195/75 R 16C 107/105R TL CARGO SPEED
                                                    TG
                                                </td>
                                                <td style="text-align: center;" valign="middle" width="25 %">
                                                    Motorcraft
                                                ...
                                                <td style="text-align: center;" class="CusTab-light-pric"
                                                    valign="middle" width="25 %"><span style="font-size: medium;">301 lei</span>
                                                </td>
                                            </tr>
                                            <tr class="CusTab-light" tr="">
                                                <td valign="middle" width="25 %">195/75 R 16C 107/105R TL AGILIS+ GRNX
                                                    MI
                                                </td>
                                                <td style="text-align: center;" valign="middle" width="25 %">Michelin
                                                </td>
                                                <td style="text-align: center;" class="CusTab-light-pric"
                                                    valign="middle" width="25 %"><span style="font-size: medium;">488 lei</span>
                                                </td>
                                            </tr>
                                            <tr class="CusTab-dark" tr="">
                                                <td valign="middle" width="25 %">195/75 R 16C 107/105R TL ACTIVAN GO
                                                </td>
                                                <td style="text-align: center;" valign="middle" width="25 %">
                                                    BFGoodrich
                                                </td>
                                                <td style="text-align: center;" class="CusTab-light-pric"
                                                    valign="middle" width="25 %"><span style="font-size: medium;">347 lei</span>
                                                </td>
                                            </tr>
                                            <tr class="CusTab-light" tr="">
                                                <td valign="middle" width="25 %">215/75 R 16C 113/111R TL CARGO SPEED
                                                    TG
                                                </td>
                                                <td style="text-align: center;" valign="middle" width="25 %">
                                                    Motorcraft
                                                ...
                                                <td style="text-align: center;" class="CusTab-light-pric"
                                                    valign="middle" width="25 %"><span style="font-size: medium;">328 lei</span>
                                                </td>
                                            </tr>
                                            <tr class="CusTab-dark" tr="">
                                                <td valign="middle" width="25 %">215/75 R 16C 113/111R TL AGILIS+ GRNX
                                                    MI
                                                </td>
                                                <td style="text-align: center;" valign="middle" width="25 %">Michelin
                                                </td>
                                                <td style="text-align: center;" class="CusTab-light-pric"
                                                    valign="middle" width="25 %"><span style="font-size: medium;">683 lei</span>
                                                </td>
                                            </tr>
                                            <tr class="CusTab-light" tr="">
                                                <td valign="middle" width="25 %">215/75 R 16C 113/111R TL ACTIVAN GO
                                                </td>
                                                <td style="text-align: center;" valign="middle" width="25 %">
                                                    BFGoodrich
                                                </td>
                                                <td style="text-align: center;" class="CusTab-light-pric"
                                                    valign="middle" width="25 %"><span style="font-size: medium;">491 lei</span>
                                                </td>
                                            </tr>
                                            <tr class="CusTab-dark" tr="">
                                                <td valign="middle" width="25 %">235/65 R 16C 115/113R TL CARGO SPEED
                                                    TG
                                                </td>
                                                <td style="text-align: center;" valign="middle" width="25 %">
                                                    Motorcraft
                                                ...
                                                <td style="text-align: center;" class="CusTab-light-pric"
                                                    valign="middle" width="25 %"><span style="font-size: medium;">354 lei</span>
                                                </td>
                                            </tr>
                                            <tr class="CusTab-light" tr="">
                                                <td valign="middle" width="25 %">235/65 R 16C 115/113R TL AGILIS+S1 GRNX
                                                    MI
                                                </td>
                                                <td style="text-align: center;" valign="middle" width="25 %">Michelin
                                                </td>
                                                <td style="text-align: center;" class="CusTab-light-pric"
                                                    valign="middle" width="25 %"><span style="font-size: medium;">735 lei</span>
                                                </td>
                                            </tr>
                                            <tr class="CusTab-dark" tr="">
                                                <td valign="middle" width="25 %">235/65 R 16C 115/113R TL ACTIVAN GO
                                                </td>
                                                <td style="text-align: center;" valign="middle" width="25 %">
                                                    BFGoodrich
                                                </td>
                                                <td style="text-align: center;" class="CusTab-light-pric"
                                                    valign="middle" width="25 %"><span style="font-size: medium;">509 lei</span>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                    ...
                    <div id="tab001-contentpane-1" class="tab001-pane-unselected">
                        <div class="tab001_TabTop_IntroText">
                            ...
                            <div class="btoArticleText">
                                <div class="btoArticleAbstract">
                                    <div>Pentru a-ti facilita alegerea, am inclus in oferta produse care se incadreaza
                                        in trei categorii de pret: anvelope premium, marca Michelin; anvelope de
                                        calitate, marca BF Goodrich, precum si anvelope de buget, marca motorcraft
                                        (Tigar).<br>
                                        <ul>
    ...
    <div class="right_item">
        ...
        <div class="skyscraper_promo">
            <a href='/FordService/FordAsistenta12' target="_self">
                <img
                    src="/assets/img/1214637791009.jpg"
