                        ...
                        <div class="btoArticleAbstract">
                            <div>
                                ...
                                <table class="floatedTable" width="100%">
                                    ...
                                    <tr>
                                        <td class="CusTab-light" valign="middle" width="25 %">235/55 R17 103V XLTL
                                            WINTER 1
                                            TG
                                        </td>
                                        ...
                                        <td style="text-align: center;" class="CusTab-light-pric" valign="middle"
                                            width="25 %"><span
                                                style="font-size: medium;">304 lei  <br>             </span>
                                        </td>
                                    </tr>
                                    <tr class="CusTab-dark" tr="">
                                        <td class="CusTab-light" valign="middle" width="25 %">235/55 R17 103VXL TL PILOT
                                            ALPIN PA4
                                        </td>
                                        <td class="CusTab-light" style="text-align: center;" valign="middle"
                                            width="25 %">
                                        ...
                                        <td style="text-align: center;" class="CusTab-light-pric" valign="middle"
                                            width="25 %"><span
                                                style="font-size: medium;">746 lei  <br>             </span>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
