...
<div id="container_center">
    <div class="center_item">
        <div class="btoArticleTitle"><h1><font size="5">Anvelope de iarnă Ford Kuga</font></h1></div>
                                ...
                                <div class="btoArticleAbstract">
                                    <div>
                                        ...
                                        <table width="100%" class="floatedTable">
                                            ...
                                            <tr>
                                                <td width="25 %" valign="middle" class="CusTab-light">235/55 R17 103V WINTER 1 XL
                                                </td>
                                                <td width="25 %" valign="middle" class="CusTab-light">Motorcraft*</td>
                                                <td width="25 %" valign="middle" style="text-align: center;"
                                                    class="CusTab-light-pric"><span style="font-size: medium;">260* lei<br></span>
                                                </td>
                                            </tr>
                                            <tr class="CusTab-dark" tr="">
                                                <td width="25 %" valign="middle">235/55 R17 103H EXTRA LOAD TL PILOT ALPIN PA4 GRNX
                                                    XL
                                                </td>
                                                <td width="25 %" valign="middle">Michelin</td>
                                                <td width="25 %" valign="middle" style="text-align: center;"
                                                    class="CusTab-light-pric"><span style="font-size: medium;">770* lei<br>             </span>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
