...
//alert(str);
    ...
    if (isDoubleclickTriggered === 'false') {
        if (typeof TagIT != 'object' || (typeof TagIT.handlesDoubleClick == 'function' || !TagIT.handlesDoubleClick)) {
            ...
            dataLayer.push({"pageTitle": 'Anvelope Ford Mondeo | Ford RO'});
    ...
    <div class="btoArticleText">
        <div class="btoArticleAbstract">
            <div>E usor sa găseşti anvelopele potrivite modelui tau Ford Mondeo. <br> <br> <img width="100%"
                ...
                identifica cauciucurile potrivite maşinii tale Mondeo.
            </div>
        </div>
    </div>
</div>
    ...
    <div class="tab001_header">
        ...
        <div
            ...
            <table cellpadding="0" cellspacing="0" border="0" title="Modele şi preţuri">
                <thead>
                <tr>
                    <td class="tab001_header_arrow"><a href="Mondeo/tabid%3dtab0" class="tab_anchor"></a></td>
                        ...
                        <div class="btoArticleAbstract">
                            <div>
                                ...
                                <table class="floatedTable" width="100%">
                                    ...
                                    <tr>
                                        <td class="CusTab-light" valign="middle" width="25 %">215/55 R16 97HXL TL WINTER
                                            1
                                            TG
                                        </td>
                                        ...
                                        <td style="text-align: center;" class="CusTab-light-pric" valign="middle"
                                            width="25 %"><span style="font-size: medium;">242 lei  </span></td>
                                    </tr>
                                    <tr class="CusTab-dark" tr="">
                                        ...
                                        <td style="text-align: center;" class="CusTab-light-pric" valign="middle"
                                            width="25 %"><span style="font-size: medium;">381 lei  </span></td>
                                    </tr>
                                    <tr class="CusTab-light" tr="">
                                        <td valign="middle" width="25 %">215/55 R16 97HXL TL ALPIN 5 MI</td>
                                        <td style="text-align: center;" valign="middle" width="25 %">Michelin</td>
                                        <td style="text-align: center;" class="CusTab-light-pric" valign="middle"
                                            width="25 %"><span style="font-size: medium;">572 lei  </span></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class='BTIarticleBody'>
                                <div class='BTIarticleText'>
                                    <div><em>*Toate preturile afisate in aceasta oferta sunt preturi recomandate si
                                            ...
                                            Perioada derularii acestei campanii: 1 Ianuarie 2018 – 28 Februarie
                                            2018. </em></div>
                                </div>
                            </div>
                        </div>
