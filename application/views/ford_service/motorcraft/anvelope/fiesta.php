                    ...
                    <div class="btoArticleText">
                        <div class="btoArticleAbstract">
                            <div>
                                ...
                                Toate preţurile afişate sunt preţuri recomandate de v&acirc;nzare cu TVA inclus. Nu
                                ...
                                <table class="floatedTable" width="100%">
                                    ...
                                    <tr>
                                        <td class="CusTab-light" valign="middle" width="25 %">175/65 R14 82T TL WINTER 1
                                            TG
                                        </td>
                                        ...
                                        <td class="CusTab-light-pric" style="text-align: center;" valign="middle"
                                            width="25 %"><span style="font-size: medium;">170 lei </span></td>
                                    </tr>
                                    <tr tr="" class="CusTab-dark">
                                        ...
                                        <td class="CusTab-light-pric" style="text-align: center;" valign="middle"
                                            width="25 %"><span style="font-size: medium;">184 lei </span></td>
                                    </tr>
                                    <tr tr="" class="CusTab-light">
                                        <td valign="middle" width="25 %">175/65 R14 82T TL ALPIN A4 GRNX MI</td>
                                        <td style="text-align: center;" valign="middle" width="25 %">Michelin</td>
                                        <td class="CusTab-light-pric" style="text-align: center;" valign="middle"
                                            width="25 %"><span style="font-size: medium;">277 lei  </span></td>
                                    </tr>
                                    <tr tr="" class="CusTab-dark">
                                        <td valign="middle" width="25 %">195/50 R15 82H TL WINTER 1 TG</td>
                                        <td style="text-align: center;" valign="middle" width="25 %">Motorcraft*</td>
                                        <td class="CusTab-light-pric" style="text-align: center;" valign="middle"
                                            width="25 %"><span style="font-size: medium;">196 lei  </span></td>
                                    </tr>
                                    <tr tr="" class="CusTab-light">
                                        <td valign="middle" width="25 %">195/50R15 82HTL GFORCE WIN2</td>
                                        <td style="text-align: center;" valign="middle" width="25 %">BFGoodrich</td>
                                        <td class="CusTab-light-pric" style="text-align: center;" valign="middle"
                                            width="25 %"><span style="font-size: medium;">249 lei  </span></td>
                                    </tr>
                                    <tr tr="" class="CusTab-dark">
                                        <td valign="middle" width="25 %">195/50 R15 82T TL ALPIN A4 GRNX MI</td>
                                        <td style="text-align: center;" valign="middle" width="25 %">Michelin</td>
                                        <td class="CusTab-light-pric" style="text-align: center;" valign="middle"
                                            width="25 %"><span style="font-size: medium;">349 lei  </span></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <div class="BTIOneItem">
                            ...
                            <div class='BTIarticleBody'>
                                <div class='BTIarticleText'>
                                    <div><em>
                                            *Toate preturile afisate in aceasta oferta sunt preturi recomandate si
                                            contin TVA conform legislatiei în vigoare. Oferta nu include componentele
                                            tehnologice, este supusa termenilor si conditiilor afisate si este valabila
                                            in limita stocului disponibil. De asemenea, oferta se poate modifica in
                                            functie de seria de sasiu. Schimbul de ulei este inclus in preturile
                                            mentionate in limita a 5l pentru autoturisme si 7l pentru autoutilitare.
                                            Alte detalii aferente ofertei sunt disponibile in paginile de promotie
                                            detaliate pe ford.ro si in reteaua de reparatori autorizati Ford.
                                            Perioada derularii acestei campanii: 1 Ianuarie 2018 – 30 Martie 2018.
                    ...
                    <div class="btoArticleText">
                        <div class="btoArticleAbstract">
                            <div>Pentru a-ţi facilita alegerea, am reunit diferite produse şi preţuri şi
                                ...
                                Michelin<br> <strong>Calitate</strong>: BF Goodrich, , Kebler <br>
                                <strong>Buget</strong>:
                                Tigar<br>
                                <ul>
