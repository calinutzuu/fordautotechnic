...
<div id="container_center">
    <div class="center_item">
        <div class="btoArticleTitle"><h1><font size="5">Anvelope de iarnă Ford Fusion</font></h1></div>
                                    ...
                                    <div>
                                        ...
                                        <table width="100%" class="floatedTable">
                                            ...
                                            <tr>
                                                ...
                                                <td width="25 %" valign="middle" style="text-align: center;"
                                                    class="CusTab-light-pric"><span style="font-size: medium;">150 lei</span></td>
                                            </tr>
                                            <tr class="CusTab-dark" tr="">
                                                <td width="25 %" valign="middle">175/65 R14 82T G-FORCE WINTER</td>
                                                <td width="25 %" valign="middle">BFGoodrich</td>
                                                <td width="25 %" valign="middle" style="text-align: center;"
                                                    class="CusTab-light-pric"><span style="font-size: medium;">190 lei</span></td>
                                            </tr>
                                            <tr class="CusTab-light" tr="">
                                                ...
                                                <td width="25 %" valign="middle" style="text-align: center;"
                                                    class="CusTab-light-pric"><span style="font-size: medium;">266 lei</span></td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
