...
<div class="center_item">
    <div class="btoArticleTitle">Promotii anvelope</div>
    <div class="btoArticleText">
        <div class="btoArticleAbstract">
            <div><strong><span style="font-size: medium;">Anvelopele potrivite pentru autoturismul tau Ford, pretul corect pentru tine.</span></strong>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="BTIOneItem">
        ...
        <div class='BTIarticleBody'>
            <div class='BTIarticleText'>
                <div>
                    Cauciucurile sunt singurul element al maşinii aflat în contact direct cu partea carosabilă.
