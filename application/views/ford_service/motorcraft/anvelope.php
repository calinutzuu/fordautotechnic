...
//alert(str);
    ...
    if (isDoubleclickTriggered === 'false') {
        ...
        dataLayer.push({"pageTitle": 'Anvelope | Ford RO'});
...
<div class="CATWrapper">
    <div class="CATRow">
        <div class="CATItem">
            ...
            <div class="CATarticleBody">
                <div class="CATarticleText">
                    <div><a HREF="Anvelope/Ka">➣Anvelope Ford KA</a></div>
                </div>
            </div>
        </div>
        <div class="CATItem_2and3">
            ...
            <div class="CATarticleBody">
                <div class="CATarticleText">
                    <div><a HREF="Anvelope/Fiesta">➣Anvelope Ford Fiesta</a></div>
                </div>
            </div>
        </div>
        <div class="CATItem_2and3">
            ...
            <div class="CATarticleBody">
                <div class="CATarticleText">
                    <div><a HREF="Anvelope/Fusion">➣Anvelope Ford Fusion</a></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="CATRow">
        <div class="CATItem">
            ...
            <div class="CATarticleBody">
                <div class="CATarticleText">
                    <div><a HREF="Anvelope/Focus">➣Anvelope Ford Focus</a></div>
                </div>
            </div>
        </div>
        <div class="CATItem_2and3">
            ...
            <div class="CATarticleBody">
                <div class="CATarticleText">
                    <div><a HREF="Anvelope/C-MAX">➣Anvelope Ford C-MAX</a></div>
                </div>
            </div>
        </div>
        <div class="CATItem_2and3">
            ...
            <div class="CATarticleBody">
                <div class="CATarticleText">
                    <div><a HREF="Anvelope/Mondeo">➣Anvelope Ford Mondeo</a></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="CATRow">
        <div class="CATItem">
            ...
            <div class="CATarticleBody">
                <div class="CATarticleText">
                    <div><a HREF="Anvelope/Kuga">➣Anvelope Ford Kuga</a></div>
                </div>
            </div>
        </div>
        <div class="CATItem_2and3">
            ...
            <div class="CATarticleBody">
                <div class="CATarticleText">
                    <div><a HREF="Anvelope/Transit">➣Anvelope Ford Transit</a></div>
                </div>
            </div>
        </div>
    </div>
