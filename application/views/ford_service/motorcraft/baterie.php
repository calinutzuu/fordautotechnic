...
<noscript>
    <iframe
        src="//www.googletagmanager.com/ns.html?id=GTM-WL5HW9" height="0"
...
<script type="text/javascript">var sford = new Object;
    sford.tabName = '';
    sford.pageName = 'brand:owner:service:motorcraft service:repairs:batteries';
    sford.dlwasSent = false;
    sford.eVar11 = 'brand:owner:service:motorcraft service:repairs:batteries';
    sford.hier1 = 'owners:service:motorcraft service:repairs:batteries';
    sford.tagViewPhoto = '';
    sford.tagHighlights = '';
    sford.tagDownload = '';
    s.pageName = 'brand:owner:service:motorcraft service:repairs:batteries';
    s.hier1 = 'owners:service:motorcraft service:repairs:batteries';
    s.channel = 'owners';
    s.eVar4 = 'rum';
    s.prop4 = 'rum';
    s.eVar11 = 'brand:owner:service:motorcraft service:repairs:batteries';
    s.prop11 = 'brand:owner:service:motorcraft service:repairs:batteries';
    s.eVar14 = 'ford-ro';
    s.prop14 = 'ford-ro';
    s.eVar15 = 'ford-owner';
...
//alert(str);
    ...
    if (isDoubleclickTriggered === 'false') {
        if (typeof TagIT != 'object' || (typeof TagIT.handlesDoubleClick == 'function' || !TagIT.handlesDoubleClick)) {
            ...
            dataLayer.push({"pageTitle": 'Baterie | Ford RO'});
...
<!--<START_MHB001 >-->
<div id="masthead">
    <img src="/cs/BlobServer?blobtable=MungoBlobs&#38;blobcol=urldata&#38;blobwhere=1214565085190&#38;blobkey=id"
    ...
    <div class="left_item">
        ...
        <div class="navmenu">
                ...
                <li id='menu1205019843457' class=''>
                    ...
                    <div id="navsubmenu" class="navsubmenu">
                        ...
                        <ul class="navsubmenu">
                            ...
                            <li class=''>
                                <a href='/FordService/IntrebariFrecvente'>&Icirc;ntreb&#259;ri frecvente</a></li>
                            <li class=''>
                ...
                <li id='menu1205094748158' class=''>
                    ...
                    <div id="navsubmenu" class="navsubmenu">
                        ...
                        <ul class="navsubmenu">
                            ...
                            <li class=''>
                                <a href='/FordService/Motorcraft/Reparatii'>Repara&#355;ii uzuale</a></li>
                        </ul>
                        <div class="navsubmenubottom">
                        </div>
                    </div>
            ...
            <ul id="nextSteps" class="nextSteps">
                ...
                <li class="selected"><p>Baterie</p></li>
            </ul>
...
<div id="container_main">
    ...
    <div id="container_center">
        <div class="center_item">
            <div class="btoArticleTitle"><h1><font size="5">FORD <strong>MOTORCRAFT</strong> Baterii</font></h1></div>
            <div class="btoArticleText">
               <!-- <div class="btoArticleAbstract">
                    <div><span style="color: rgb(51, 51, 51);"><strong>In perioada 15 octombrie-30 noiembrie 2016,
                                pentru toate interventiile din categoria &ldquo;Reparatii uzuale Motorcraft&rdquo; cu o
                                valoare mai mare de 150 de lei (inclusiv TVA), clientii vor beneficia, fara costuri
                                suplimentare, de un bidon cu lichid de parbriz Motorcraft (5 L). <br>
                                <br>
                                Click </strong></span><span style="color: rgb(0, 0, 128);"><strong><a
                                    HREF="/SBE/Motorcraft/OSBOV"><span
                                        style="color: rgb(51, 51, 51);">aici</span></a><span
                                    style="color: rgb(51, 51, 51);"> pentru a face o programare! </span><a
                                    TITLE="Dealeri Ford participanti la promotie (208 KB)"
                                    HREF="/cs/BlobServer?blobtable=MungoBlobs&amp;blobcol=urldata&amp;blobheadervalue1=attachment%3Bfilename%3D%22Dealeri_Ford_participanti_la_promotie.pdf%22&amp;blobheadervalue2=abinary%3Bcharset%3DUTF-8&amp;blobheadername1=Content-Disposition&amp;blobheadername2=MDT-Type&amp;blobheader=application%2Fpdf&amp;blobwhere=1214571504253&amp;blobkey=id"
                                    CLASS="download"
                                    onClick="if (typeof sford == 'object') omnitureLinkDownloadClick('brand:pdf download:service promotion:participating dealers','','','event:find dealer','download dealer list','pdf download','',false,'blank value','blank','blank value');"><span
                                        style="color: rgb(51, 51, 51);">Aici</span></a></strong><span
                                style="color: rgb(51, 51, 51);"><strong> poti vedea lista dealerilor
                                    participanti. </strong></span></span></div>
                </div> -->
            </div>
        </div>
        <div class="center_item">
                    ...
                    <div class='BTIarticleBody'>
                        <div class='BTIarticleText'>
                            <div><em>Toate preturile afisate in aceasta oferta sunt preturi recomandate, in lei, contin
                                    ...
                                    pana la data de 31 martie 2017. <br>
                                </em></div>
                        </div>
                    </div>
                </div>
...
<!-- enableiPerceptions is - 'null' -->
<script src="/cs/ContentServer?pagename=EP2%2fENGInE%2fscript%2fGroupedJS" type="text/javascript"></script>
