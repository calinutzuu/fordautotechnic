...
<script type="text/javascript">var sford = new Object;
    sford.tabName = '';
    sford.pageName = 'brand:owner:lifestyle collection:<tab name>';
    sford.dlwasSent = false;
    sford.eVar11 = 'brand:owner:lifestyle collection:<tab name>';
    sford.hier1 = 'owners:lifestyle collection';
    sford.tagViewPhoto = '';
    sford.tagHighlights = '';
    sford.tagDownload = '';
    s.pageName = 'brand:owner:lifestyle collection:<tab name>';
    s.hier1 = 'owners:lifestyle collection';
    s.channel = 'owners';
    s.eVar4 = 'rum';
    s.prop4 = 'rum';
    s.eVar11 = 'brand:owner:lifestyle collection:<tab name>';
    s.prop11 = 'brand:owner:lifestyle collection:<tab name>';
    s.eVar14 = 'ford-ro';
    s.prop14 = 'ford-ro';
    s.eVar15 = 'ford-owner';
...
//alert(str);
    ...
    if (isDoubleclickTriggered === 'false') {
        if (typeof TagIT != 'object' || (typeof TagIT.handlesDoubleClick == 'function' || !TagIT.handlesDoubleClick)) {
            ...
            dataLayer.push({"pageTitle": 'Ford Service | Ford Lifestyle Collection |  Ford RO'});
            ...
            if (typeof osb_pageId != 'undefined') {
                ...
                if (typeof mobile_bnp_pageId != 'undefined') {
                    ...
                    dataLayer.push({"pageID": 'brand:owner:lifestyle collection'});
                }
            }
    ...
    <div class="left_item">
        ...
        <div class="navmenu">
            ...
            <ul id="nextSteps" class="nextSteps">
                ...
                <li class="selected"><p>Ford Lifestyle Collection</p></li>
...
<div id="mediaplayer1">
    ...
    <div class="mdp2Box">
        ...
        <div id="mdp">
            <a href="https://ford7.cwshops.com/">
                <img src="/assets/img/service/1214554362394.jpg">
            </a>
            ...
            <table>
                <tr>
                    <td id="mdp2Fullscreen">
                        <a href="#" onclick="engine.media.mdp.onFullScreen('', 'Life+style+collection');
if(typeof(sford)=='object') omnitureMDPFullScreen('1205065087129'); return false;">
                            Fullscreen
                        </a>
                    </td>
...
<div id="container_center">
    <div class="center_item">
        <div class="btoArticleTitle">Ford Lifestyle Collection</div>
        <div class="btoArticleText">
            <div class="btoArticleAbstract">
                <a href="http://ford.cwshops.com/" target="_blank">Cumpără online</a>
            </div>
        </div>
    </div>
    <div class="center_item">
