...
//alert(str);
    ...
    if (isDoubleclickTriggered === 'false') {
        if (typeof TagIT != 'object' || (typeof TagIT.handlesDoubleClick == 'function' || !TagIT.handlesDoubleClick)) {
            ...
            dataLayer.push({"pageTitle": 'FORD MOTORCRAFT | Ford RO'});
            ...
            if (typeof osb_pageId != 'undefined') {
                ...
                if (typeof mobile_bnp_pageId != 'undefined') {
                    ...
                    dataLayer.push({"pageID": 'brand:owner:service:motorcraft service'});
                }
            }
        ...
        <div class="navmenu">
            ...
            <ul id="nextSteps" class="nextSteps">
                <li id='menu1205094744296' class=''>
                    <a href='Motorcraft/Service'/>Service</a>
                    <script type="text/javascript">
                ...
                <li id='menu1205094744286' class=''>
                    ...
                    <div id="navsubmenu" class="navsubmenu">
                        ...
                        <ul class="navsubmenu">
                            <li class=''>
                                <a href='Motorcraft/Anvelope/Ka'>Ka</a></li>
                            <li class=''>
                                <a href='Motorcraft/Anvelope/Fiesta'>Fiesta</a></li>
                            <li class=''>
                                <a href='Motorcraft/Anvelope/Fusion'>Fusion</a></li>
                            <li class=''>
                                <a href='Motorcraft/Anvelope/Focus'>Focus</a></li>
                            <li class=''>
                                <a href='Motorcraft/Anvelope/C-MAX'>C-MAX</a></li>
                            <li class=''>
                                <a href='Motorcraft/Anvelope/Mondeo'>Mondeo</a></li>
                            <li class=''>
                                <a href='Motorcraft/Anvelope/Kuga'>Kuga</a></li>
                            <li class=''>
                                <a href='Motorcraft/Anvelope/Transit'>Transit</a></li>
                        </ul>
                        <div class="navsubmenubottom">
                        </div>
                    </div>
                ...
                <li id='menu1205094744818' class=''>
                    <a href='Motorcraft/Reparatii'/>Repara&#355;ii uzuale</a>
                    <div id="navsubmenu" class="navsubmenu">
                        <div class="navsubmenutop">
                        </div>
                        <ul class="navsubmenu">
                            <li class=''>
                                <a href='Motorcraft/Reparatii/Frane'>Sisteme de fr&acirc;nare</a></li>
                            <li class=''>
                                <a href='Motorcraft/Reparatii/Ambreiaje'>Kit ambreiaj</a></li>
                            <li class=''>
                                <a href='Motorcraft/Reparatii/Stergatoare'>&#350;terg&#259;toare de parbriz</a>
                            </li>
                            <li class=''>
                                <a href='Motorcraft/Reparatii/CureaDeDistributie'>Kit distribu&#355;ie</a></li>
                            <li class=''>
                                <a href='Motorcraft/Reparatii/Antigel'>Lichid de r&#259;cire (antigel)</a></li>
                            <li class=''>
                                <a href='Motorcraft/Reparatii/Suspensii'>Suspensii</a></li>
                            <li class=''>
                                <a href='Motorcraft/Reparatii/AerConditionat'>Verificare vizuala AC</a></li>
                        </ul>
                        <div class="navsubmenubottom">
                        </div>
                    </div>
...
<div class="center_item">
            ...
            <div class="BTIItem">
                ...
                <div class='BTIarticleBody'>
                    <div class='BTIarticleText'>
                        <div><h2><font size="2">Ford Service</font></h2> <br>&nbsp; <strong><span
                                    style="color: rgb(255, 0, 0);"><span style="font-size: x-large;"><span
                                            style="color:#425968">319 lei</span></span></span></strong><span
                                style="color: red"><span style="color:#425968"><br> <br> <br> <a
                                        HREF="/FordService/Motorcraft/Service">&gt; Ford Service</a></span></span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="BTIRow">
        <div class="BTIOneItem">
            ...
            <div class='BTIarticleBody'>
                <div class='BTIarticleText'>
                    <div><em>Toate preturile afisate in aceasta oferta sunt preturi recomandate, in lei, contin TVA
                            conform legislatiei in vigoare si includ pretul manoperei. Aceasta oferta: este supusa
                            unor termene si conditii; este valabila in limita stocului disponibil, poate varia in
                            functie de seria de sasiu si nu se aplica autovehiculelor utilitare echipate cu jante
                            din aliaj si/sau a celor cu roti duble spate. Campanie valabila pana la data de 31
                            martie 2017. <br> </em></div>
                </div>
            </div>
        </div>
    </div>
