...
dataLayer.push({"pageTitle":'9.000 \u20AC* pentru Ford Fiesta prin programul rabla! | Ford RO'});
...
<div id="mdp">
<img src='/assets/img/promotii/1214553887232.jpg' alt='FordFleet' onclick="omnitureViewPhoto()">
</div>
<div class="mdp2" id="mdpImageControl" >
<table>
<tr>
<td id="mdp2Fullscreen">
<a href="/assets/img/promotii/1214553887233.jpg" onclick="engine.media.mdp.onFullScreen('/cs/BlobServer?blobtable=MungoBlobs&amp;blobcol=urldata&amp;blobwhere=1214553887233&amp;blobkey=id', 'FordFleet');
...
<div class="btoArticleTitle">FORD FIESTA LA 9.000 €*, PRET SPECIAL PRIN PROGRAMUL RABLA!</div> 		
<div class="btoArticleText">
<div class="btoArticleAbstract">
<div>A venit momentul sa iti schimbi masina cu una noua, potrivita stilului tau de viata. Iar daca ceea ce cauti este un design modern si tehnologii inteligente, prietenoase cu mediul inconjurator, Ford Fiesta este modelul perfect pentru tine.  <br> <br> Creat pentru a te ajuta sa profiti la maximum de orice zi, contemporan si plin de stil, Ford Fiesta va deveni partenerul tau preferat de drum.<br> <br> Iar acum te poti bucura de modelul tau preferat la un <strong>pret special, de 9.000 &euro;*</strong>, prin  programul rabla, cu toate dotarile de care ai nevoie pentru a te bucura de experienta de la volan:</div> <ul style="list-style-type: disc;">     <li>Airbag-uri frontale, laterale, cortina si pentru genunchi, sofer si pasager;</li>     <li>Sisteme inteligente de siguranta si stabilitate &ndash; ESP (Program Electronic de Stabilitate), HLA (Asistenta la Pornirea in Rampa), ABS (Sistem Anti-Blocare la Franare), EBD (Distributie Electronica a Fortei de Franare), EBA (Asistenta la Franarea de Urgenta);</li>     <li>Sistem Ford MyKey;</li>     <li>Incarcare regenerativa a bateriei;</li>     <li>Oglinzi exterioare electrice si incalzite;</li>     <li>Volan si schimbator de viteze imbracat in piele;</li>     <li>Sistem avansat de monitorizare a presiunii in pneuri.</li> </ul> <div>In plus, cu pretul special pentru Pachetul Trend - numai 150 &euro;* - beneficiezi de :</div> <ul style="list-style-type: disc;">     <li>aer conditionat manual;</li>     <li>radio CD cu MP3, display monocrom 3.5&rdquo;, 6 difuzoare, USB, comenzi audio pe volan;</li>     <li>Bluetooth<sup>&reg;</sup> Voice Control (limba engleza);</li>     <li>SYNC cu Applink si sistem de asistenta in caz de urgenta (112);</li>     <li>faruri de ceata;</li>     <li>covorase velur fata/ spate.</li> </ul> <div> <br><br> Ai nevoie de mai multe informatii? Toate detaliile despre Ford Fiesta si oferta speciala iti stau la dispozitie. Ia legatura cu unul din consultantii nostrii. </strong><br> <em><br> *9.000 euro (pret lei 40.500 la un curs cu titlu de exemplu de [4.5] RON/1 EUR )TVA inclus. Oferta supusa unor termeni si conditii; este valabila in limita stocului disponibil, la dealerii participanti in program, pentru modelul Fiesta Trend 5 usi 1.0 80 CP, consum mixt masurat in conformitate cu dispozitiile legale in vigoare: 4.6 l/100 km, emisii CO<sub>2</sub> (g/km):105, valoare masurata in conformitate cu dispozitiile legale in vigoare. Pretul prezentat este obtinut dupa includerea atat a contravalorii subventiei in cadrul Programului de innoire a Parcului Auto National 2016 dar si contravalorii suportului acordat de Ford Romania prin programul Ford ECOBONUS si contributia dealerilor participanti la program si nu include echipamente, accesorii sau dotari optionale.  Oferta realizata sub conditia aprobarii Programului de stimulare a innoirii Parcului auto national, derulat de Administratia Fondului pentru Mediu si finantat din Fondul pentru mediu, valabila incepand cu data intrării in vigoare a Ghidului de finantare PSIPAN 2016, pana la data de 30 septembrie 2016, sub rezerva acceptarii Ford Romania sau a dealerilor sai autorizati in Program si indeplinirii de catre client a tuturor conditiilor impuse de Ghidul PSIPAN 2016.<br> <br> Pentru un autoturism in valoare de 40.500 lei (cu TVA), avans 2.025 lei (minim 5%), valoarea totala a creditului va fi de 38.475 lei pe 60 luni: rata anuala a dobanzii variabile 4.57% (ROBOR la 3 luni + 3.81%), comision de analiza dosar 0 lei, comision lunar de administrare credit 0 lei, valoarea ratei lunare (pentru rate egale) 718.5 lei, valoarea totala platibila 43.111 lei, DAE 4,67%. In calculul ratei lunare nu s-a inclus asigurarea optionala de viata si asigurarea CASCO. In cazul in care se opteaza pentru asigurarea (facultativa) de viata, rata lunara devine 774.6 lei. Oferta este supusa unor termene si conditii. Oferta se adreseaza exclusiv persoanelor fizice. Campanie realizata exclusiv prin UniCredit Consumer Financing IFN SA, valabila pana la 30 septembrie 2016.</em></div>
</div>
</div>
</div>                       
<div class="center_item">
