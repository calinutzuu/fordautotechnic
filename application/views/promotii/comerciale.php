...
<div class="mainContent">
    ...
    <section id="fv-wrapper">
        ...
        <script type="text/javascript">var sford = new Object;
            ...
            sford.eVar11 = 'brand:promotions:commercial:overview';
            sford.hier1 = 'shopping tools:promotions';
            sford.tagViewPhoto = '';
            sford.tagHighlights = '';
            sford.tagDownload = '';
            s.pageName = 'brand:promotions:commercial:overview';
            s.hier1 = 'shopping tools:promotions';
            s.channel = 'promotions';
            s.eVar4 = 'rum';
            s.prop4 = 'rum';
            s.eVar11 = 'brand:promotions:commercial:overview';
            s.prop11 = 'brand:promotions:commercial:overview';
            s.eVar14 = 'ford-ro';
            s.prop14 = 'ford-ro';
            s.eVar15 = 'ford-brand';
...
//alert(str);
    ...
    if (isDoubleclickTriggered === 'false') {
        if (typeof TagIT != 'object' || (typeof TagIT.handlesDoubleClick == 'function' || !TagIT.handlesDoubleClick)) {
            ...
            dataLayer.push({"pageTitle": 'Oferte speciale pentru gama de vehicule comerciale Ford | Ford RO'});
            ...
            if (typeof osb_pageId != 'undefined') {
                ...
                if (typeof mobile_bnp_pageId != 'undefined') {
                    ...
                    dataLayer.push({"pageID": 'EU_ENGInE_CV-promotions'});
                }
            }
