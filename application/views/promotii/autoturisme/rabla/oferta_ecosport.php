...
dataLayer.push({"pageTitle":'12.500 \u20AC* pentru Ford Ecosport prin programul rabla! | Ford RO'});
...
<div>A venit momentul sa iti schimbi masina cu una noua, potrivita stilului tau de viata. Iar modelul Ford Ecosport, noua reinterpretare Ford a unui SUV (Smart Utility Vehicle) poate fi alegerea perfecta atunci cand iti doresti o masina in care fiecare drum poate deveni o aventura urbana.<br> <br> Compact, spatios, robust si echipat cu tehnologii de ultima generatie, Ecosport te tine mereu in miscare, oriunde ai fi, oferindu-ti toata increderea de care ai nevoie atunci cand esti la volan.   <br> <br> Iar acum te poti bucura de modelul tau preferat la un <strong>pret special, de 12.500 &euro;*</strong>, prin  programul rabla, cu toate dotarile de care ai nevoie pentru a savura fiecare drum:</div> <ul class="ListM">     <li>Sisteme inteligente de siguranta si stabilitate &ndash; ESP (Program Electronic de Stabilitate), HLA (Asistenta la Pornirea in Rampa), ABS (Sistem Anti-Blocare la Franare), sistem de avertizare la franarea de urgenta, sistem de monitorizare a presiunii in pneuri;</li>     <li>Airbag-uri frontale, laterale si cortna, sofer si pasager; airbag pentru genunchi pentru sofer;</li>     <li>sistem Ford EasyFuel</li>     <li>geamuri electrice fata cu functia &quot;One Shot Up &amp; Down&quot;;</li>     <li>Sistem Ford ECOmode, cu indicator de schimbare a vitezelor.</li> </ul> <div>In plus, cu pretul special de numai 250 &euro;* pentru Pachetul Trend, beneficiezi de:</div> <ul class="ListM">     <li>bare pavilion cu aspect cromat;</li>     <li>jante aliaj 16&quot;;</li>     <li>radio CD cu 6 difuzoare, ecran color 4.2&quot;;</li>     <li>SYNC 1 cu Blue Tooth si Voice Control;</li>     <li>Sistem de Asistenta in caz de urgenta (112).</li> </ul> <div>  <em>*12.500&euro;, pret lei, 56.250 (pret lei 56.250 la un curs cu titlu de exemplu de [4.5] RON/1 EUR )TVA inclus. Oferta supusa unor termeni si conditii; este valabila in limita stocului disponibil, la dealerii participanti in program, pentru modelul EcoSport Trend 1.5 Ti- VCT 110 CP, consum mixt masurat in conformitate cu dispozitiile legale in vigoare: 6.3 l/100 km, emisii CO<sub>2</sub> (g/km):149, valoare masurata in conformitate cu dispozitiile legale in vigoare. Pretul prezentat este obtinut dupa includerea atat a contravalorii subventiei in cadrul Programului de innoire a Parcului Auto National 2016 dar si contravalorii suportului acordat de Ford Romania prin programul Ford ECOBONUS si contributia dealerilor participanti la program si nu include echipamente, accesorii sau dotari optionale.  Oferta realizata sub conditia aprobarii Programului de stimulare a innoirii Parcului auto national, derulat de Administratia Fondului pentru Mediu si finantat din Fondul pentru mediu, valabila incepand cu data intrării in vigoare a Ghidului de finantare PSIPAN 2016, pana la data de 30 septembrie 2016, sub rezerva acceptarii Ford Romania sau a dealerilor sai autorizati in Program si indeplinirii de catre client a tuturor conditiilor impuse de Ghidul PSIPAN 2016. <br> <br> Pentru un autoturism in valoare de 56.250 lei (cu TVA), avans 2.813 lei (minim 5%), valoarea totala a creditului va fi de 53.437 lei pe 60 luni: rata anuala a dobanzii variabile 4.57% (ROBOR la 3 luni + 3.81%), comision de analiza dosar 0 lei, comision lunar de administrare credit 0 lei, valoarea ratei lunare (pentru rate egale) 997.9 lei, valoarea totala platibila 59.876 lei, DAE 4,67%. In calculul ratei lunare nu s-a inclus asigurarea optionala de viata si asigurarea CASCO. In cazul in care se opteaza pentru asigurarea (facultativa) de viata, rata lunara devine 1.075,8 lei. Oferta este supusa unor termene si conditii. Oferta se adreseaza exclusiv persoanelor fizice. Campanie realizata exclusiv prin UniCredit Consumer Financing IFN SA, valabila pana la 30 septembrie 2016. </em><style type="text/css">
.ListM li {
