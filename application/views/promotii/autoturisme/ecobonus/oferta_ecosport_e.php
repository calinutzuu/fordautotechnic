<div class="mainContent">
    <img
        src="/assets/img/1214608522126.jpg"
        alt="Ecobonus Fiesta"/>
        ...
        <section class="center_item_Layout2">
            <div class="tab-content">
                <header class="intro-header">
                    <h1 class="bigHeading">
                        <b>Ford Ecobonus – de la 750 de lei / luna* pentru Ford EcoSport</b>
                    </h1>
                    <br>
                            ...
                            <div><span style="font-size: medium;"><span color="#005f97"> <div style="text-align: left;"
                                                ...
                                                onclick="document.getElementById('replie2').style.display = 'block'; document.getElementById('deplie2').style.display = 'none';"><font
                                                    ...
                                                    onmouseout="this.style.color='#000000'" color="#000000"><br> <br>
                                                        ...
                                                        color="#000000"><span><em> *Pentru un autovehicul EcoSport Trend
                                                                1.5 Ti- VCT 110 CP, in valoare de 13.610 Euro (pret lei
                                                                61.245 lei la un curs cu titlu de exemplu de [4,5] RON/1
                                                                EUR) TVA inclus, avans 22.245 lei (36,32 %), valoarea
                                                                totala a creditului va fi de 39.000 lei pe 60 luni: rata
                                                                anuala a dobanzii 4,95% (ROBOR la 3 luni + 4,13%),
                                                                comision de analiza dosar 790 lei, comision lunar de
                                                                administrare credit 0 lei, valoarea ratei lunare 750
                                                                lei, valoarea totala platibila 44.988,82 lei, DAE 5,93%.
                                                                In calculul ratei lunare nu s-a inclus asigurarea
                                                                optionala de viata si asigurarea CASCO. <br> <br> Oferta
