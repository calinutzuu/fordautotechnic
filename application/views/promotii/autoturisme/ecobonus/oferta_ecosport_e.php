...
//alert(str);
    ...
    if (isDoubleclickTriggered === 'false') {
        if (typeof TagIT != 'object' || (typeof TagIT.handlesDoubleClick == 'function' || !TagIT.handlesDoubleClick)) {
            ...
            dataLayer.push({"pageTitle": 'Ford EcoSport cu avantaj client 2.600 \u20AC cu Ecobonus | Ford RO'});
...
<div id="container_main">
    <div id="mediaplayer1">
        ...
        <div class="mdp2Box">
            ...
            <div id="mdp">
                <img
                    src='/assets/img/promotii/1214564411194.jpg'
                ...
                <table>
                    <tr>
                        <td id="mdp2Fullscreen">
                            <a href="/assets/img/promotii/1214564411195.jpg"
                               onclick="engine.media.mdp.onFullScreen('/cs/BlobServer?blobtable=MungoBlobs&amp;blobcol=urldata&amp;blobwhere=1214564411195&amp;blobkey=id', 'FordFleet');
if(typeof(sford)=='object') omnitureMDPFullScreen('1205111010986'); return false;">
    ...
    <div id="container_center">
        <div class="center_item">
            <div class="btoArticleTitle">Ford Ecobonus - avantaj total client 2.600 € pentru Ford EcoSport</div>
            <div class="btoArticleText">
                <div class="btoArticleAbstract">
                    <div>Iesi din tipare! EcoSport, noua reinterpretare Ford a unui SUV (Smart Utility Vehicle) este
                        alegerea perfecta atunci cand iti doresti o masina in care fiecare drum poate deveni o aventura
                        urbana. Compact, spatios, robust si echipat cu tehnologii de ultima generatie, EcoSport te tine
                        mereu in miscare, oriunde ai fi, oferindu-ti toata increderea de care ai nevoie atunci cand esti
                        la volan. <br> <strong><br> La casarea masinii vechi, prin programul Ecobonus, beneficiezi de
                            1.500 &euro; bonus si ajungi in final sa ai un avantaj client de 2.600 &euro;, la
                            achizitionarea unui Ford EcoSport. </strong><br> <br> Un autoturism Ford EcoSport 1.5 Ti-
                        VCT 110 CP iti ofera dotari cum ar fi:
                    </div>
                    <ul class="ListM">
                        <li>Sisteme de siguranta si stabilitate: ESP (Program Electronic de Stabilitate), ABS (Sistem
                            Anti-Blocare la Franare), IVD (Sistem electronic de control dinamic),
                        </li>
                        <li>Airbag-uri frontale, laterale, cortina, sofer si pasager; airbag genunchi pentru sofer;</li>
                        <li>Oglinzi actionate electric si incalzite, in culoarea caroseriei;</li>
                        <li>Aer conditionat automat cu reglare separata stanga/ dreapta;</li>
                        <li>Faruri cu functie &bdquo;Follow me home&rdquo;; faruri de ceata;</li>
                        <li>Sistem MyKey;</li>
                        <li>Volan si schimbator de viteze imbracate in piele;</li>
                        <li>Tehnologie Start&amp;Stop;.</li>
                    </ul>
                    <div>Iar pachetul Trend, care este inclus in pret, iti aduce suplimentar:</div>
                    <ul class="ListM">
                        <li>bare pavilion cu aspect cromat;</li>
                        <li>jante aliaj 16&quot;;</li>
                        <li>radio CD cu 6 difuzoare, ecran color 4.2&quot;;</li>
                        <li>SYNC 1 cu Blue Tooth si Voice Control;</li>
                        <li>Sistem de Asistenta in caz de urgenta (112).</li>
                    </ul>
                    <div><strong>Rezerva acum oferta speciala pentru Ford EcoSport &ndash; click <a
                                HREF="Rezervare">aici</a>! <br> <br> Pentru detalii despre procedura de casare si
                            cum poti beneficia de Ecobonus, click <a HREF="Procedura-2">aici</a>.<br> <br> Ai
                            nevoie de mai multe informatii? Toate detaliile despre Ford EcoSport si oferta speciala iti
                            stau la dispozitie in cel mai apropiat <a HREF="http://www.ford.ro/SBE/dealeri-ford">showroom
                                Ford</a>! </strong><br> <br> <em>* Oferta este supusa unor termeni si conditii, este
                            adresata exclusiv persoanelor fizice si este valabila in limita stocului disponibil la
                            dealerii participanti la program. Oferta prezentata include TVA si este obtinuta dupa
                            includerea cumulativa a: 1. contravalorii suportului acordat de Ford Romania prin programul
                            Ford ECOBONUS, 2. contributiei dealerilor participanti la acest program. Oferta nu include
                            echipamente, accesorii sau dotari optionale, cu exceptia Pachetului Trend aferent fiecarui
                            model.<br> Consumul mixt masurat in conformitate cu dispozitiile legale in vigoare (e.g
                            Directiva Europeana nr. 715/2007) pentru EcoSport Trend 1.5 Ti- VCT 110 CP: 6.3 l/100 km,
                            emisii CO<sub>2</sub> (g/km):149, valoare masurata in conformitate cu dispozitiile legale in
                            vigoare. </em>
                        <style type="text/css">
                            .ListM li {
