<div class="mainContent">
    <img
        src="/assets/img/ecobonus/1214657253953.jpg"
        alt="Ecobonus Fiesta"/>
        ...
        <section class="center_item_Layout2">
            <div class="tab-content centered">
                <header class="intro-header">
                    <h1 class="bigHeading">
                        Ford EcoBonus – Avantaj client pana la 4500 de euro* pentru Ford Kuga!
                    </h1><br>
                    <span class="highlighter"></span>

                    <p class="intro-text">

                    <p>E practic, dar rafinat. Puternic dar cu un design modern. Inteligent si cat se poate de impunator. Ce-ți poți
                        dori mai mult de la un SUV? <br>
                        Intampina viitorul dintr-o pozitie avantajata, la volanul unui SUV ultra-contemporan si practic, o culme a
                        eficientei si flexibilitatii.<br>
                        <br>
                        <strong>Prin programul Ecobonus beneficiezi de un bonus de 1.500 &euro;, la casarea masinii vechi si ai un
                            avantaj client de pana la 4500 de euro*.</strong><br>
                        <br>
                        Redescopera placerea condusului cu Kuga Trend 2WD 1,5 EcoBoost, 120 CP si cutie manuala in 6 trepte.<br>
                        Experimenteaza dotari unice, de confort si siguranta precum:<br>
                        <br>
                        &bull; Pilotul automat cu Sistem de Ajustare a Limitei de Viteza<br>
                        &bull; Scaunele fata sport<br>
                        &bull; Sistemul Ford MyKey cu buton de pornire Ford Power<br>
                        &bull; Sistemul de Protectie la Rasturnare<br>
                        &bull; 7 airbaguri<br>
                        &bull; Geamuri fata si spate actionate electric cu functia &ldquo;shut up/down&rdquo;<br>
                        <br>
                        Iar Pachetul Trend iti aduce in plus, dotari suplimentare cum ar fi:<br>
                        <br>
                        &bull; SYNC Gen 3 cu Sistem de asistenta in caz de urgenta (112)<br>
                        &bull; Radio CD cu MP3, 8&quot; touchscreen, display central, 6 difuzoare, comenzi audio pe volan
                        BlueTooth/Voice control (limba engleza), USB<br>
                        &bull; Aer conditionat automat cu reglare separata stanga/dreapta <br>
                        &bull; Jante aliaj 17''<br>
                        <br>
                        <strong>Rezerva acum oferta speciala pentru Ford Kuga&ndash; click <a
                                HREF="/Promotii/Autoturisme/Ecobonus/Rezervare"><u>aici</u></a>! <br>
                            <br>
                            Pentru detalii despre procedura de casare si cum poti beneficia de Ecobonus, click <a
                                HREF="/Promotii/Autoturisme/Ecobonus/Procedura"><u>aici</u></a>.<br>
                            <br>
                            Ai nevoie de mai multe informatii? Toate detaliile despre Ford Kuga si oferta speciala iti stau la
                            dispozitie in cel mai apropiat <a HREF="/SBE/dealeri-ford"><u>showroom Ford</u></a>! </strong></p> <br>
...
<div style="text-align: left;" id="replie2"><font onmouseout="this.style.color='#000000'" color="#000000"><span
            onclick="document.getElementById('deplie2').style.display = 'block'; document.getElementById('replie2').style.display = 'none';"><a><span
                    style="color: rgb(0, 0, 0);"><u><span><font onmouseover="this.style.color='#000000'"
                                                                onmouseout="this.style.color='#000000'"> <em>
                                    <p style="text-align: center;">Termeni si conditii</p>
                                </em> </font></span></u></span><span><font onmouseover="this.style.color='#000000'"
...
<div style="text-align: justify;"><font onmouseout="this.style.color='#000000'" color="#000000"><span>
<p><em>Imaginea este cu titlu de prezentare si nu creeaza obligatii contractuale. Oferta: 1) este supusa unor termeni si
        conditii si se va concretiza in reducerea pretului de lista al autoturismului cu valoarea afisata in termenii si
        conditiile campaniei; 2) este adresata exclusiv persoanelor fizice; 3) este valabila in limita stocului
        disponibil la dealerii participanti la program, cu valabilitate pana la 31.05.2018; 3) include TVA si este
        rezultatul includerii cumulative a: i) contravalorii suportului acordat de Ford Romania; ii) contravalorii
        suportului acordat de Ford Romania prin programul Ford ECOBONUS; iii) contravalorii suportului acordat de
        dealerii participanti in campanie. <br>
        Oferta nu include echipamente, accesorii sau dotari optionale suplimentare componentelor din pachetului Trend.
        <br>
        Consumul mixt masurat in conformitate cu dispozitiile legale in vigoare (e.g Directiva Europeana nr. 715/2007):
        7,1 l/100 km, emisii CO<sub>2</sub> (g/km): 160, valoare masurata in conformitate cu dispozitiile legale in
        vigoare. </em></p>
</span></font></div>
<em> </em></span></div>
<em> </em></span></span></div>
