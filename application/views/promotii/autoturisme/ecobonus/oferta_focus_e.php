...
//alert(str);
    ...
    if (isDoubleclickTriggered === 'false') {
        if (typeof TagIT != 'object' || (typeof TagIT.handlesDoubleClick == 'function' || !TagIT.handlesDoubleClick)) {
            ...
            dataLayer.push({"pageTitle": 'Ford Focus avantaj client 4.300 \u20AC cu Ecobonus |Ford RO'});
...
<div id="container_main">
    <div id="mediaplayer1">
        ...
        <div class="mdp2Box">
            ...
            <div id="mdp">
                <img
                    src='/assets/img/promotii/1214564411996.jpg'
                ...
                <table>
                    <tr>
                        <td id="mdp2Fullscreen">
                            <a href="http://www.ford.ro/cs/BlobServer?blobtable=MungoBlobs&amp;blobcol=urldata&amp;blobwhere=1214564411997&amp;blobkey=id"
                               onclick="engine.media.mdp.onFullScreen('/cs/BlobServer?blobtable=MungoBlobs&amp;blobcol=urldata&amp;blobwhere=1214564411997&amp;blobkey=id', 'FordFleet');
if(typeof(sford)=='object') omnitureMDPFullScreen('1205110699727'); return false;">
    ...
    <div id="container_center">
        <div class="center_item">
            <div class="btoArticleTitle">Ford Ecobonus - Avantaj client 4.300 € pentru Ford Focus!</div>
            <div class="btoArticleText">
                <div class="btoArticleAbstract">
                    <div>Vrei sa schimbi masina veche? Ford Focus poate fi modelul perfect pentru tine, daca iti doresti
                        o masina care iti va redefini experienta la volan si care in plus are un design scluptural si
                        este echipat cu tehnologii de varf. <br> <br> <strong> Prin programul Ecobonus beneficiezi de un
                            bonus de 1.500 &euro;, la casarea masinii vechi, si ajungi in final sa ai un avantaj total
                            client de 4.300 &euro;, la achizitionarea unui Ford Focus. </strong><br> <br> Modelul din
                        promotie, Ford Focus 5 usi 1.0 EcoBoost 100 CP, are printre dotarile standard:
                    </div>
                    <ul class="listM">
                        ...
                        <li>Sisteme de siguranta si stabilitate: sistem de control avansat al cuplului motor (Torque
                            ...
                            Urgenta), ESP (Program Electronic de Stabilitate), HLA (Sistem de asistenta la urcarea in
                            rampa), sistem avansat de monitorizare a presiunii in pneuri;
                        </li>
                    ...
                    <div>Pachetul Trend, cu un pret special in cadrul promotiei, iti aduce dotari cum ar fi:</div>
                    <ul class="listM">
                    ...
                    <div><strong>Rezerva acum oferta speciala pentru Ford Focus &ndash; click <a HREF="Rezervare">aici</a>!
                            ...
                            detaliile despre Ford Focus si oferta speciala iti stau la dispozitie in cel mai apropiat <a
                                HREF="http://www.ford.ro/SBE/dealeri-ford">showroom Ford</a>! </strong><br> <br> <em>*
                            ...
                            optionale, cu exceptia Pachetului Trend aferent fiecarui model. Consumul mixt masurat in
                            conformitate cu dispozitiile legale in vigoare (e.g Directiva Europeana nr. 715/2007) pentru
                            Focus Trend 5 usi 1.0 EcoBoost 100 CP: 4.6 l/100 km, emisii CO<sub>2</sub> (g/km):105,
                            valoare masurata in conformitate cu dispozitiile legale in vigoare. </em>
                        <style type="text/css">
                            .ListM li {
