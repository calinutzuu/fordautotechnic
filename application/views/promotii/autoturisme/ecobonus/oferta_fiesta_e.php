...
//alert(str);
    ...
    if (isDoubleclickTriggered === 'false') {
        if (typeof TagIT != 'object' || (typeof TagIT.handlesDoubleClick == 'function' || !TagIT.handlesDoubleClick)) {
            ...
            dataLayer.push({"pageTitle": 'Ford Fiesta avantaj client 4.250 \u20AC cu Ecobonus | Ford RO'});
...
<div id="container_main">
    <div id="mediaplayer1">
        ...
        <div class="mdp2Box">
            ...
            <div id="mdp">
                <img
                    src='/assets/img/promotii/1214564411278.jpg'
                ...
                <table>
                    <tr>
                        <td id="mdp2Fullscreen">
                            <a href="http://www.ford.ro/cs/BlobServer?blobtable=MungoBlobs&amp;blobcol=urldata&amp;blobwhere=1214564411279&amp;blobkey=id"
                               onclick="engine.media.mdp.onFullScreen('/cs/BlobServer?blobtable=MungoBlobs&amp;blobcol=urldata&amp;blobwhere=1214564411279&amp;blobkey=id', 'FordFleet');
if(typeof(sford)=='object') omnitureMDPFullScreen('1205111247816'); return false;">
    ...
    <div id="container_center">
        <div class="center_item">
            <div class="btoArticleTitle">Ford Ecobonus - Avantaj total client 4.250 € pentru Ford Fiesta!</div>
                ...
                <div class="btoArticleAbstract">
                    <div>Daca iti doresti un autoturism cu stil contemporan, dinamic, modern, dotat cu tehnologii
                        ...
                        modelul perfect pentru tine. <br> <strong><br> Prin programul Ecobonus beneficiezi de un bonus
                            ...
                            insumeaza un avantaj total client de 4.250 &euro;. </strong><br> <br> Promotia include si un
                        pret special pentru dotarile din pachetul Trend. Astfel, poti beneficia de un avantaj total
                        client de 4.250 &euro;, pentru Ford Fiesta 5 usi, cu motor 1.0l 80CP cutie manuala 5 trepte, cu
                    ...
                    <div><strong>Rezerva acum oferta speciala pentru Ford Fiesta &ndash; click <a HREF="Rezervare.">aici</a>!
                            ...
                            <a HREF="http://www.ford.ro/SBE/dealeri-ford">showroom Ford</a>! </strong><br> <em><br> *
