...
<script type="text/javascript">var sford = new Object;
    sford.tabName = '';
    sford.pageName = 'brand:promotions:car:results:technologies';
    sford.dlwasSent = false;
    sford.eVar11 = 'brand:promotions:car:results:technologies';
    sford.hier1 = 'shopping tools:promotions:cars';
    sford.tagViewPhoto = '';
    sford.tagHighlights = '';
    sford.tagDownload = '';
    s.pageName = 'brand:promotions:car:results:technologies';
    s.hier1 = 'shopping tools:promotions:cars';
    s.channel = 'promotions';
    s.eVar4 = 'rum';
    s.prop4 = 'rum';
    s.eVar11 = 'brand:promotions:car:results:technologies';
    s.prop11 = 'brand:promotions:car:results:technologies';
    s.eVar14 = 'ford-ro';
    s.prop14 = 'ford-ro';
    s.eVar15 = 'ford-brand';
...
//alert(str);
    ...
    if (isDoubleclickTriggered === 'false') {
        if (typeof TagIT != 'object' || (typeof TagIT.handlesDoubleClick == 'function' || !TagIT.handlesDoubleClick)) {
            ...
            dataLayer.push({"pageTitle": 'ECOBONUS FORD \u2013 1500 \u20AC GARANTAT la Weekendul Inovatiei Ford | Ford RO'});
            ...
            if (typeof osb_pageId != 'undefined') {
                ...
                if (typeof mobile_bnp_pageId != 'undefined') {
                    ...
                    dataLayer.push({"pageID": 'brand:promotions:car:results:technologies'});
                }
            }
        ...
        <div class="navmenu">
            ...
            <ul id="currentContext" class="currentContext">
                ...
                <li id='menu1205073068739' class=''>
                    <a href='http://www.ford.ro/Promotii/Autoturisme'/>Promo&#355;ii autoturisme</a>
                    <div id="navsubmenu" class="navsubmenu">
                        <div class="navsubmenutop">
                        </div>
                        <ul class="navsubmenu">
                            <li class=''>
                                <a href='http://www.ford.ro/Promotii/Autoturisme/Ecobonus'>Ecobonus</a></li>
                            <li class=''>
                                <a href='http://www.ford.ro/Promotii/Autoturisme/NoulKAPlus'>Noul KA Plus</a></li>
                            <li class=''>
                                <a href='http://www.ford.ro/Promotii/Autoturisme/NoulFordEdge'>Noul Ford Edge</a></li>
                            <li class=''>
                                <a href='http://www.ford.ro/Promotii/Autoturisme/KugaSummerEdition'>Kuga Summer
                                    Edition</a></li>
                            <li class=''>
                                <a href='http://www.ford.ro/Promotii/Autoturisme/BusinessWeeks'>BusinessWeeks</a></li>
                            <li class=''>
                                <a href='http://www.ford.ro/Promotii/Autoturisme/PromotieFlote'>Promotie Flote</a></li>
                        </ul>
                        <div class="navsubmenubottom">
                        </div>
                    </div>
            ...
            <ul id="nextSteps" class="nextSteps">
                ...
                <li class="selected"><p>Weekendul Inovatiei</p></li>
            </ul>
...
<div id="container_main">
    <div id="mediaplayer1">
        ...
        <div class="mdp2Box">
            ...
            <div id="mdp">
                <img
                    src='http://www.ford.ro/cs/BlobServer?blobtable=MungoBlobs&amp;blobcol=urldata&amp;blobwhere=1214565934873&amp;blobkey=id'
                    alt='Ecobonus' onclick="omnitureViewPhoto()">
            </div>
            <div class="mdp2" id="mdpImageControl">
                <table>
                    <tr>
                        <td id="mdp2Fullscreen">
                            <a href="http://www.ford.ro/cs/BlobServer?blobtable=MungoBlobs&amp;blobcol=urldata&amp;blobwhere=1214565934874&amp;blobkey=id"
                               onclick="engine.media.mdp.onFullScreen('/cs/BlobServer?blobtable=MungoBlobs&amp;blobcol=urldata&amp;blobwhere=1214565934874&amp;blobkey=id', 'Ecobonus');
if(typeof(sford)=='object') omnitureMDPFullScreen('1205124414174'); return false;">
                                Fullscreen
                            </a>
                        </td>
    ...
    <div id="container_center">
        <div class="center_item">
            <div class="btoArticleTitle">Weekendul Inovatiei Ford – 1-2 octombrie!</div>
            <div class="btoArticleText">
                <div class="btoArticleAbstract">
                    <div>Vino in showroomurile Ford, la Weekendul Inovatiei, pe 1 si 2 octombrie!<br> <br> Poti afla mai
                        multe detalii despre programul Ford Ecobonus, prin care beneficiezi de un<strong> bonus garantat
                            de 1.500 &euro;*</strong>, suplimentar oricaror alte beneficii associate cu modelul
                        preferat! <br> <br> Intre timp poti rezerva oferta speciala completand formularul de <a
                            HREF="Rezervare"><strong><u>aici</u></strong></a>.<br> <br> Informatii complete despre
                        modelele participante la oferta sunt disponibile la linkurile de mai jos. <br> <br> Ford Fiesta
                        - agil, contemporan, urban - detalii <a HREF="OfertaFiesta"><u>aici</u></a>.<br> <br> Ford
                        Focus &ndash; sofisticat, modern, spatios - detalii <a
                            HREF="OfertaFocus"><u>aici</u></a>.<br> <br> Ford B-Max &ndash; contemporan, premium,
                        modern - detalii <a HREF="OfertaBMAX"><u>aici</u></a>.<br> <br> Ford Mondeo &ndash;
                        elegant, performant, spatios - detalii <a HREF="OfertaMondeo"><u>aici</u></a>.<br> <br>
                        Ford Ecosport &ndash; compact, confortabil, performant - detalii <a
                            HREF="OfertaEcoSport"><u>aici</u></a>.<br> <br> <br> Te asteptam la Weekendul
                        Inovatiei, in <strong>cel mai apropiat </strong><a
                            HREF="http://www.ford.ro/SBE/dealeri-ford"><strong><u>showroom Ford</u></strong></a><strong>!</strong><br>
                        <br> <br> <br> <em>* Oferta este supusa unor termeni si conditii, este adresata exclusiv
                            persoanelor fizice si este valabila in limita stocului disponibil la dealerii participanti
                            la program.</em></div>
                </div>
            </div>
        </div>
