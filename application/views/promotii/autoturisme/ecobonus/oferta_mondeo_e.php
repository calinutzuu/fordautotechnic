<div class="mainContent">
    <img
        src="/assets/img/ecobonus/1214657253965.jpg"
        alt="Ecobonus Fiesta"/>
        ...
        <section class="center_item_Layout2">
            <div class="tab-content centered">
                <header class="intro-header">
                    <h1 class="bigHeading">
                        Ford EcoBonus – Avantaj client pana la 4850 de euro* pentru Ford Mondeo!
                    </h1> <br>
                    <span class="highlighter"></span>

                    <p class="intro-text">

                    <p>Conceput sa te inspire, Mondeo te va surprinde prin amestecul unic de performanta, eleganta, inovatie si
                        eficienta. Ofera-ti o experienta remarcabila la fiecare kilometru parcurs, explorand pe indelete tehnologii si
                        dotari remarcabile, fara de care nu vei mai putea concepe urmatorul drum. <br> <strong><br> Prin programul
                            Ecobonus beneficiezi de un bonus de 1.500 &euro;, la casarea masinii vechi si ai un avantaj client de pana
                            la 4850 de euro*.</strong><br> <br> Redefineste-ti experienta la volan cu Mondeo Trend 2.0 TDCi, 150 CP si
                        cutie manuala in 6 trepte.<br> <br> Experimenteaza dotari unice, de inalta tehnologie si confort maximizat
                        precum:<br> <br> &bull; Sistemul Start&amp;Stop<br> &bull; Sistemul Easy Fuel<br> &bull; Sistemul My
                        Key<br> &bull; Aer condiționat automat cu reglare separata stanga-dreapta<br> &bull; Faruri autoadaptive cu
                        tehnologie LED<br> <br> Iar Pachetul Trend iti aduce ca bonus, dotari suplimentare precum:<br> <br> &bull; SYNC
                        Gen III,display 8&quot; cu touch screen, 8 difuzoare (non-branded radio), comenzi audio pe volan, Bluetooth /
                        Voice Control (limba engleza)<br> &bull; Conexiune USB, Sistem de asistenta in caz de urgenta<br> &bull; Senzor
                        de ploaie si lumina<br> &bull; Scaune fata incalzite<br> &bull; Parbriz incalzit<br> &bull; Jante aliaj 6.5JX16
                        cu anvelope 215/60 R16.<br> <strong><br> Rezerva acum oferta speciala pentru Ford Mondeo&ndash; click <a
                            ...
                            informatii? Toate detaliile despre Ford Mondeo si oferta speciala iti stau la dispozitie in cel mai apropiat
                                    ...
                                    style="display: none; text-align: left;" id="deplie2"><span
                                        onclick="document.getElementById('replie2').style.display = 'block'; document.getElementById('deplie2').style.display = 'none';"><font
                                            onmouseout="this.style.color='#000000'" color="#000000"><u><em><p>Termeni si conditii</p>
                                                            ...
                                                            valabilitate pana la 30.06.2018; 3) include TVA si este rezultatul
                                                            ...
                                                            Directiva Europeana nr. 715/2007): 4,6 l/100 km, emisii CO<sub>2</sub>
                                                            (g/km): 120, valoare masurata in conformitate cu dispozitiile legale in
