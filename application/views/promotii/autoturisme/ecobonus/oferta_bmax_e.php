...
//alert(str);
    ...
    if (isDoubleclickTriggered === 'false') {
        if (typeof TagIT != 'object' || (typeof TagIT.handlesDoubleClick == 'function' || !TagIT.handlesDoubleClick)) {
            ...
            dataLayer.push({"pageTitle": 'Ford B-MAX avantaj client 4.350 \u20AC cu Ecobonus | Ford RO'});
...
<div id="container_main">
    <div id="mediaplayer1">
        ...
        <div class="mdp2Box">
            ...
            <div id="mdp">
                <img
                    src='/assets/img/promotii/1214564411110.jpg'
                ...
                <table>
                    <tr>
                        <td id="mdp2Fullscreen">
                            <a href="http://www.ford.ro/cs/BlobServer?blobtable=MungoBlobs&amp;blobcol=urldata&amp;blobwhere=1214564411111&amp;blobkey=id"
                               onclick="engine.media.mdp.onFullScreen('/cs/BlobServer?blobtable=MungoBlobs&amp;blobcol=urldata&amp;blobwhere=1214564411111&amp;blobkey=id', 'FordFleet');
if(typeof(sford)=='object') omnitureMDPFullScreen('1205111010574'); return false;">
    ...
    <div id="container_center">
        <div class="center_item">
            <div class="btoArticleTitle">Ford Ecobonus - avantaj total client 4.350 € pentru Ford B-MAX!</div>
            <div class="btoArticleText">
                <div class="btoArticleAbstract">
                    <div>Viata este o usa deschisa, iar monovolumul nostru dovedeste acest lucru. Datorita sistemului de
                        culisare al usilor spate, accesul in B-Max este facil in orice conditii, iar lipsa montantului
                        lateral face ca spatiul din habitaclu sa fie mult mai deschis. In plus, ai parte de o serie de
                        tehnologii care iti vor imbunatati experienta la volan. <br> <br> <strong>Prin programul
                            Ecobonus beneficiezi de un bonus de 1.500 &euro;, la casarea masinii vechi, iar avantajul
                            total client ajunge la 4.350 &euro; pentru Ford B-MAX. </strong><br> <br> Ford B-MAX 1.0
                        EcoBoost 100 CP are in echiparea standard dotari cum ar fi:
                    </div>
                    <ul class="ListM">
                    ...
                    <div>In plus, pachetul Trend, disponibil la un pret special, iti aduce:</div>
                    <ul class="ListM">
                    ...
                    <div><strong>Rezerva acum oferta speciala pentru Ford B-MAX &ndash; click <a HREF="Rezervare">aici</a>!
                            <br> <br> Pentru detalii despre procedura de casare si cum poti beneficia de Ecobonus, click
                            <a HREF="Procedura-2">aici</a>.<br> <br> Ai nevoie de mai multe informatii? Toate
                            detaliile despre Ford B-MAX si oferta speciala iti stau la dispozitie in cel mai apropiat <a
                            ...
                            B-MAX Trend 1.0 EcoBoost 100 CP: 5,1 l/100 km, emisii CO<sub>2</sub> (g/km): 119, valoare
                            masurata in conformitate cu dispozitiile legale in vigoare. </em>
                        <style type="text/css">
                            .ListM li {
