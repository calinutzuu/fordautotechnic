...
<script type="text/javascript">var sford = new Object;
    sford.tabName = '';
    sford.pageName = 'brand:promotions:car:results:<tab name>:ford kuga';
    sford.dlwasSent = false;
    sford.eVar11 = 'brand:promotions:car:results:<tab name>';
    sford.hier1 = 'shopping tools:promotions:ford kuga';
    sford.tagViewPhoto = '';
    sford.tagHighlights = '';
    sford.tagDownload = '';
    s.pageName = 'brand:promotions:car:results:<tab name>:ford kuga';
    s.hier1 = 'shopping tools:promotions:ford kuga';
...
//alert(str);
    ...
    if (isDoubleclickTriggered === 'false') {
        if (typeof TagIT != 'object' || (typeof TagIT.handlesDoubleClick == 'function' || !TagIT.handlesDoubleClick)) {
            ...
            dataLayer.push({"pageTitle": '5.500\u20AC* avantaj client, pentru Ford Kuga Summer Edition 4x4! | Ford RO'});
    ...
    <div class="left_item">
        ...
        <div class="navmenu">
            ...
            <ul id="nextSteps" class="nextSteps">
                ...
                <li class="selected"><p>Kuga Summer Edition</p></li>
...
<div id="container_main">
    <div id="mediaplayer1">
        ...
        <div class="mdp2Box">
            ...
            <div id="mdp">
                <img src='/assets/img/promotii/1214560851894.jpg' alt='Kuga Summer Edition'
                ...
                <table>
                    <tr>
                        <td id="mdp2Fullscreen">
                            <a href="/assets/img/promotii/1214560851895.jpg" onclick="engine.media.mdp.onFullScreen('/cs/BlobServer?blobtable=MungoBlobs&amp;blobcol=urldata&amp;blobwhere=1214560851895&amp;blobkey=id', 'Kuga+Summer+Edition');
if(typeof(sford)=='object') omnitureMDPFullScreen('1205119562630'); return false;">
                                Fullscreen
                            </a>
                        </td>
    ...
    <div id="container_center">
        <div class="center_item">
            <div class="btoArticleTitle">AVANTAJ CLIENT DE EXCEPTIE, CU FORD KUGA SUMMER EDITION 4x4: 5.500 €* TVA
                inclus!
            </div>
            <div class="btoArticleText">
                <div class="btoArticleAbstract">
                    <div>Iti doresti un model Ford pregatit oricand de aventura off-road? Kuga este alegerea perfecta.
                        <br> <br> Puternic, rafinat, spatios, dotat din plin cu tehnologii inteligente si extrem de
                        utile pentru orice sofer, Kuga, cel mai inteligent SUV al nostru, te va face sa te simti de
                        milioane atunci cand esti la volanul lui. Desigur, dotarile sale sunt completate de elementele
                        de design atent create, pentru a completa imaginea masinii si pe a soferului. <br> <br> Iar acum
                        te poti bucura de SUV-ul tau preferat intr-o editie speciala:<strong> Ford Kuga Summer Edition
                            4x4 </strong>iti ofera un <strong>avantaj client de 5.500&euro;*, TVA inclus! </strong>Cu
                        toate dotarile de care ai nevoie pentru fiecare aventura la volan, de acum anotimpul tau
                        preferat va fi tot anul:<br> <br> &bull; Sisteme inteligente de siguranta si stabilitate &ndash;
                        ...
                        Franarea de Urgenta); sistem de protectie anti-rasturnare; <br> &bull; Geamuri fata si spate
                        actionate electric cu functia &bdquo;shot up/down&rdquo;; <br> &bull; Aer conditionat automat cu
                        reglare separata stanga/dreapta; <br> &bull; Sistem de pornire buton FordPower; <br> &bull;
                        Pilot automat cu sistem de ajustare a limitei de viteza; <br> &bull; Senzori de lumina si
                        ploaie; <br> &bull; Airbag-uri frontale, laterale si cortina, sofer si pasager; airbag genunchi
                        pentru sofer; <br> &bull; Functionalitati prietenoase cu mediul: Ford ECOmode cu indicator de
                        schimbare optima a treptei de viteza; sistem de incarcare regenerativa a bateriei; <br> &bull;
                        Detalii caroserie cu insertii cromate si jante din aliaj de 17&rdquo;.<br> <br> In plus, cu
                        pretul special de <strong>numai 250 &euro;* pentru Pachetul Titanium</strong>, beneficiezi de:
                    </div>
                    <div><br> &bull; Sistem ''Keyless entry'' si sistem ''hands-free'' de deschidere automata a
                        hayon-ului; <br> &bull; Camera video spate; <br> &bull; Sine plafon argintii, geamuri spate
                        fumurii, oglinzi rabatabile electric; <br> &bull; Radio CD SONY cu MP3, USB, 9 difuzoare,
                        comenzi audio pe volan si display central TFT; <br> &bull; SYNC Gen II cu touchscreen color de 8&quot;,
                        Blue Tooth, Voice Control si Sistem de asistenta in caz de urgenta (112); <br> &bull; Sistem de
                        navigatie cu harta Europei de Est si Vest.<br> <br> <br><br> <span style="font-size: x-small;">* Oferta adresata exclusiv persoanelor fizice, supusa unor termeni si conditii &ndash;
                    ...
                    <div></div>
                    <div><span style="font-size: x-small;"><br></span><span style="font-size: x-small;"><br><br></span>
                    </div>
                </div>
            </div>
        </div>
