    ...
    <div class="left_item">
        ...
        <div class="navmenu">
            ...
            <ul id="nextSteps" class="nextSteps">
                ...
                <li class="selected"><p>Ford Kuga</p></li>
...
<div id="container_main">
    <div id="mediaplayer1">
        ...
        <div class="mdp2Box">
            ...
            <div id="mdp">
                <img src='/assets/img/1214573743802.jpg' alt='Ford Kuga'
                ...
                <table>
                    <tr>
                        <td id="mdp2Fullscreen">
                            <a href="/assets/img/1214573743802.jpg" onclick="engine.media.mdp.onFullScreen('/cs/BlobServer?blobtable=MungoBlobs&amp;blobcol=urldata&amp;blobwhere=1214560851895&amp;blobkey=id', 'Kuga+Summer+Edition');
        ...
        <div class="center_item">
            ...
            <div class="btoArticleText">
                <div class="btoArticleAbstract">
                    ...
                    <div><strong>Afla mai multe despre Ford Kuga si despre oferta speciala, la noi in showroom. </strong> <br> <br> <span
