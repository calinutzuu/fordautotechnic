...
<div class="mainContent">
    ...
    <section id="fv-wrapper">
        ...
        <script type="text/javascript">var sford = new Object;
            sford.tabName = '';
            sford.pageName = 'brand:promotions:commercial:results:<tab name>:ford ranger';
            sford.dlwasSent = false;
            sford.eVar11 = 'brand:promotions:commercial:results:<tab name>';
            sford.hier1 = 'shopping tools:promotions:ford ranger';
            sford.tagViewPhoto = '';
            sford.tagHighlights = '';
            sford.tagDownload = '';
            s.pageName = 'brand:promotions:commercial:results:<tab name>:ford ranger';
            s.hier1 = 'shopping tools:promotions:ford ranger';
            s.channel = 'promotions';
            s.eVar4 = 'rum';
            s.prop4 = 'rum';
            s.eVar11 = 'brand:promotions:commercial:results:<tab name>';
            s.prop11 = 'brand:promotions:commercial:results:<tab name>';
            s.eVar12 = '2016';
            s.prop12 = '2016';
            sford.my = '2016';
            s.eVar14 = 'ford-ro';
            ...
            s.eVar15 = 'ford-brand';
            s.prop15 = 'ford-brand';
            s.eVar16 = 'ford ranger';
            s.prop16 = 'ford ranger';
            sford.np = 'ford ranger';
            sford.vc = 'truck';</script>
        <script type="text/javascript">
            // <![CDATA[
            var __dOC = false;
