...
<script type="text/javascript">var sford = new Object;
    sford.tabName = '';
    sford.pageName = 'brand:passenger:vehicle:design:<tab name>:ford focus rs';
    sford.dlwasSent = false;
    sford.eVar11 = 'brand:passenger:vehicle:design:<tab name>';
    sford.hier1 = 'vehicle:design:car:ford focus rs:2015';
    sford.tagViewPhoto = '';
    sford.tagHighlights = '';
    sford.tagDownload = '';
    s.pageName = 'brand:passenger:vehicle:design:<tab name>:ford focus rs';
    s.hier1 = 'vehicle:design:car:ford focus rs:2015';
    s.channel = 'vehicle';
    s.eVar4 = 'rum';
    s.prop4 = 'rum';
