            ...
            <ul>
                ...
                <li class="selected"><a href="PreturiSiPromotii#primaryTabs"
                    ...
                    <div class="secondary-tabs tab-content">
                        <nav class="sub-nav">
                            <ul>
                                <li><a href='#tab1' class='omt_tabName'>PRETURI SI PROMOTII</a></li>
                            </ul>
                        </nav>
                        <!-- isBtfTab : from MidPageTabs true -->
                        <div class="innertab-wrapper">
                            <!--  tabTitle : PRETURI SI PROMOTII :: btfTabContent : 1205107337333 :: tabContent :  -->
                            <div id='tab1' class="secondary-tab-content">
                                <header class="intro-header">
                                    ...
                                    <p class="intro-text">
                                        Află detalii despre promotiile aflate &icirc;n derulare sau descarcă listele de
                                        preturi pentru FORD FOCUS RS.
                                    </p>
                                </header>
                                <header class="intro-header">
                                    <h1 class="bigHeading">
                                    ...
                                    <p>Dacă te interesează un anumit model, consultă ofertele noastre actuale. Sau
                                        vizitează cel mai apropiat dealer pentru cele mai bune oferte disponibile.</p>

                                    <p><a TITLE="Listă de prețuri Ford Focus RS (401 KB)"
                                    ...
                                    <p>Fişierul &icirc;n format PDF a fost creat pentru a-ti permite să vizualizezi şi
                                        ...
                                        create initial. Adobe&trade; &icirc;ti pune la dispozitie o aplicatie software
                                        gratuită (Acrobat Reader) care &icirc;ti permite să lucrezi cu aceste fişiere.
                                        Dacă ai instalat deja această aplicatie pe computerul tău, &icirc;n mod normal o
                                        poti găsi la &quot;Programe&quot;, &icirc;n &quot;Meniul Start&quot;. &Icirc;n
                                        caz contrar, acceseză link-ul de mai jos pentru a o descărca.</p>

                                    <p><a target="_blank" href="http://get.adobe.com/reader">Descarcă Acrobat Reader de
                                            pe situl adobe.com</a></p>
                                    </p>
                                </header>
                            </div>
                            ...
                            <h2><a href='#tab1' class="mp-tab omt_xd_mt_ti">PRETURI SI PROMOTII</a></h2> -->
                            <!--</div>-->
                            <!-- END [MidPageTabs] -->
                            <!--  tabTitle :  :: btfTabContent :  :: tabContent :  -->
                            <!-- BEGIN [MidPageTabs] -->
...
//alert(str);
    ...
    if (isDoubleclickTriggered === 'false') {
        if (typeof TagIT != 'object' || (typeof TagIT.handlesDoubleClick == 'function' || !TagIT.handlesDoubleClick)) {
            ...
            dataLayer.push({"pageTitle": 'Pre\u021Buri \u0219i promo\u021Bii | Ford RO'});
...
<script type="text/javascript">var sford = new Object;
    sford.tabName = '';
    sford.pageName = 'brand:passenger:vehicle:promotions:<tab name>:ford focus rs';
    sford.dlwasSent = false;
    sford.eVar11 = 'brand:passenger:vehicle:promotions:<tab name>';
    sford.hier1 = 'vehicle:promotions:car:ford focus rs:2015';
    sford.tagViewPhoto = '';
    sford.tagHighlights = '';
    sford.tagDownload = '';
    s.pageName = 'brand:passenger:vehicle:promotions:<tab name>:ford focus rs';
    s.hier1 = 'vehicle:promotions:car:ford focus rs:2015';
    s.channel = 'vehicle';
    s.eVar4 = 'rum';
    s.prop4 = 'rum';
