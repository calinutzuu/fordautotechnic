...
<script type="text/javascript">
    ...
    MobileHomePageRedirectURL = 'Vignale\/\/m.ford.ro';
</script>
    ...
    <div class="tab-wrapper">
        <nav class="tabs" id="primaryTabs">
            <ul>
                ...
                <li class="selected"><a href="Vignale#primaryTabs"
                    ...
                    <div class="secondary-tabs tab-content">
                        <nav class="sub-nav">
                            <ul>
                                <li><a href='#tab1' class='omt_tabName'>Mondeo Vignale</a></li>
                            </ul>
                        </nav>
                        <!-- isBtfTab : from MidPageTabs true -->
                        <div class="innertab-wrapper">
                            <!--  tabTitle : Mondeo Vignale :: btfTabContent : 1205097597246 :: tabContent :  -->
                            <div id='tab1' class="secondary-tab-content">
                                <header class="intro-header">
                                    <h1 class="bigHeading">
                                        Exploreaza Ford Vignale
                                    </h1>
                                    <span class="highlighter"></span>

                                    <p class="intro-text">

                                    <p>Putem avea cele mai bune lucruri din lume. <br> Cea mai luxoasa masina, facuta
                                        din cele mai rafinate materiale. <br> Dar daca nu avem cateva clipe in care sa
                                        ne bucuram de toate acestea, <br> pe care sa le petrecem asa cum dorim, <br>
                                        atunci suntem saraci. <br> <br> De aceea, nu am construit doar o masina, <br> ci
                                        am elaborat cu atentie o experienta personala, pentru a-ti oferi timp. <br> <br>
                                        <a target="_blank" href="https://vignale.ford.ro/ro-RO/">Exploreaza Ford
                                            Vignale</a><br><br> <a TITLE="Lista de preturi Mondeo Vignale (431 KB)"
                                                                   HREF="http://www.ford.ro/cs/BlobServer?blobtable=MungoBlobs&amp;blobcol=urldata&amp;blobheadervalue1=attachment%3Bfilename%3D%22Lista_de_preturi_Mondeo_Vignale.pdf%22&amp;blobheadervalue2=abinary%3Bcharset%3DUTF-8&amp;blobheadername1=Content-Disposition&amp;blobheadername2=MDT-Type&amp;blobheader=application%2Fpdf&amp;blobwhere=1214552949464&amp;blobkey=id"
                                                                   CLASS="download"
                                                                   onClick="if (typeof sford == 'object') omnitureLinkDownloadClick('brand:pricelist download:vehicle:confirm:<nameplate>','event15,event43','','event: pricelist:pdf','download pricelist:vehicle','pdf download','',false,'ford mondeo vignale','2015','car');">Descarca
                                ...
                                <article class='two-column'>
                                    <div class="content-block">
                                        <img
                                                src="/assets/img/mondeo/1214515415237.jpg"
                                                alt="Fara niciun efort, oriunde."/><span class="fv-overlay-icon"></span>

                                        <h3 class="bigHeading02">
                                            Fara niciun efort, oriunde.
                                        </h3>

                                        <p>

                                        <p>Este posibil sa nu observi atentia pe care am acordat-o detaliilor din
                                            fiecare cusatura, fiecare bucatica de piele si fiecare dispozitiv de control
                                            atent conceput - si ne bucura acest lucru. <br><br> Experienta la volan
                                            trebuie sa fie lipsita de efort si captivanta, nu enervanta si
                                            plictisitoare.</p>
                                        </p>
                                    </div>
                                    <div class="content-block last">
                                        <img
                                                src="/assets/img/mondeo/1214515415410.jpg"
                                                alt="Detalii, detalii."/><span class="fv-overlay-icon"></span>
                                        ...
                                        <p>Inginerii si personalul nostru de productie s-a gandit la toate. Fiecare
                                            centimetru din grila simbol a masinii si fiecare pigment de vopsea joaca un
                                            rol crucial in experienta Ford Vignale. Speram sa te bucuri de toate aceste
                                            detalii.</p>
                                        </p>
                                    </div>
                                </article>
...
<h2><a href='#tab1' class="mp-tab omt_xd_mt_ti">Mondeo Vignale</a></h2> -->
                            <!--</div>-->
                            <!-- END [MidPageTabs] -->
                            <!--  tabTitle :  :: btfTabContent :  :: tabContent :  -->
                            <!-- BEGIN [MidPageTabs] -->
