...
<script type="text/javascript">
    ...
    MobileRedirectURL = MobileHomePageRedirectURL + '/autoturisme/noul-mondeo';
</script>
        ...
        <div itemscope itemtype="http://schema.org/ImageObject">
            <ul class="nameplate x-axis" id="vvmRoot">
                <li class="default-nameplate-vehicle"
                    style="background-image:url(/assets/img/mondeo/1214489050958.jpg)">
...
<span class="link-icon"></span>
                ...
                <p class="promo-carousel-text"><span class="promo-carousel-bold">Vezi detaliile ofertei</span></p>
        </article>
    </div>
</section>
...
<li class="selected"><a href="PreturiSiPromotii#primaryTabs"
    ...
    <div class="secondary-tabs tab-content">
        ...
        <div class="innertab-wrapper">
            <!--  tabTitle : PROMOTII :: btfTabContent :  :: tabContent : 1205103777374 -->
            <!-- BEGIN [MidPageTabs] -->
            ...
            <div id='tab1' class="secondary-tab-content">
                <section class="bti-wrapper">
                    <article class="bti-item">
                        <header class="bti-title">Oferta speciala prin programul Ecobonus</header>
                        <div class="bti-body">
                            <div class="abstract">
                                <p>Beneficiezi de un bonus de 1.500 &euro;, la casarea masinii vechi, si ajungi sa ai un
                                    avantaj client de 5.500 &euro;.<br> <br> Afla mai multe <u><a
                                            HREF="/Promotii/Autoturisme/Ecobonus/OfertaMondeo">aici</a></u>
                                </p>
                            </div>
                        </div>
                    </article>
...
<h2><a href='#tab2' class="mp-tab omt_xd_mt_ti">PREŢURI</a></h2> -->
            <div id='tab2' class="secondary-tab-content">
                <section class="bti-wrapper">
                    <article class="bti-item">
                        <header class="bti-title">Lista de preţuri</header>
                        <div class="bti-body">
                            <div class="abstract">
                                <p>Daca te intereseaza un anumit model, consulta ofertele noastre actuale. Sau vizitează
                                    cel mai apropiat dealer pentru cele mai bune oferte disponibile.<br> <br> <a
                                        TITLE="Listă de prețuri Ford Mondeo (380 KB)"
                                        HREF="http://www.ford.ro/cs/BlobServer?blobtable=MungoBlobs&amp;blobcol=urldata&amp;blobheadervalue1=attachment%3Bfilename%3D%22lista-de-preturi-ford-mondeo.pdf%22&amp;blobheadervalue2=abinary%3Bcharset%3DUTF-8&amp;blobheadername1=Content-Disposition&amp;blobheadername2=MDT-Type&amp;blobheader=application%2Fpdf&amp;blobwhere=1214561275178&amp;blobkey=id"
                                        CLASS="download"
                                        onClick="if (typeof sford == 'object') omnitureLinkDownloadClick('brand:pricelist download:vehicle:confirm:<nameplate>','event15,event43','','event: pricelist:pdf','download pricelist:vehicle','pdf download','',false,'ford mondeo','2015','car');"><u>Descarca
                                            lista de preturi pentru Ford Mondeo.</u></a><br> <br> <br> Fisierul in
                                    format PDF a fost creat pentru a-ti permite sa vizualizezi si sa tiparesti fisiere
                                    fara a avea nevoie de programul in care au fost create initial. Adobe&trade; iti
                                    pune la dispozitie o aplicaţie software gratuita (Acrobat Reader) care iti permite
                                    sa lucrezi cu aceste fisiere. Daca ai instalat deja aceasta aplicatie pe computerul
                                    tau, in mod normal o poti gasi la &bdquo;Programe&quot;, in &bdquo;Meniul Start&quot;.
                                    In caz contrar, acceseza link-ul de mai jos pentru a o descarca.<br> <br> <a
                                        target="_blank" href="https://get.adobe.com/cz/reader/"><u>Descarcă Acrobat
            ...
            <!--</div>-->
            <!-- END [MidPageTabs] -->
            <!--  tabTitle : PREŢURI :: btfTabContent :  :: tabContent : 1205112224792 -->
            <!-- BEGIN [MidPageTabs] -->
            <!--<div id='tab1' class="mp-tab-wrapper">
<h2><a href='#tab1' class="mp-tab omt_xd_mt_ti">PROMOTII</a></h2> -->
            <div id='tab1' class="secondary-tab-content">
