                ...
                <li class="selected"><a href="PreturisiPromotii#primaryTabs"
                    ...
                    <div class="secondary-tabs tab-content">
                        ...
                        <div class="innertab-wrapper">
                            <!--  tabTitle : tab  :: btfTabContent : 1205104310477 :: tabContent :  -->
                            <div id='tab1' class="secondary-tab-content">
                                <header class="intro-header">
                                    ...
                                    <p>Daca te intereseaza un anumit model, consulta ofertele noastre actuale. Sau
                                        ...
                                        <br> <a TITLE="Lista de preturi Public Mustang (277 KB)"
                                                HREF="../../cs/Lista_de_preturi_Public_Mustang8968.pdf?blobtable=MungoBlobs&amp;blobcol=urldata&amp;blobheadervalue1=attachment%3Bfilename%3D%22Lista_de_preturi_Public_Mustang.pdf%22&amp;blobheadervalue2=abinary%3Bcharset%3DUTF-8&amp;blobheadername1=Content-Disposition&amp;blobheadername2=MDT-Type&amp;blobheader=application%2Fpdf&amp;blobwhere=1214558814266&amp;blobkey=id"
                                                CLASS="download"
                                                onClick="if (typeof sford == 'object') omnitureLinkDownloadClick('brand:pricelist download:vehicle:confirm:<nameplate>','event15,event43','','event: pricelist:pdf','download pricelist:vehicle','pdf download','',false,'ford mustang','2015','car');"><u>Descarca
                                                lista de preturi a noului Ford Mustang.</u></a><br> <br> Fisierul in
                                        format PDF a fost creat pentru a-ti permite sa vizualizezi si sa tiparesti
                                        fisiere fara a avea nevoie de programul in care au fost create initial. Adobe&trade;
                                        iti pune la dispozitie o aplicatie software gratuita (Acrobat Reader) care iti
                                        permite sa lucrezi cu aceste fisiere. Daca ai instalat deja aceasta aplicatie pe
                                        computerul tau, in mod normal o poti gasi la &quot;Programe&quot;, in &quot;Meniul
                                        Start&quot;. In caz contrar, acceseza link-ul de mai jos pentru a o
                                        descarca.<br> <br> <a href="http://get.adobe.com/reader/" target="_blank"><u>Descarca
                                                Acrobat Reader de pe situl adobe.com </u></a></p>
                                    </p>
                                </header>
                            </div>
...
<script type="text/javascript">var sford = new Object;
    sford.tabName = '';
    sford.pageName = 'brand:passenger:vehicle:promotions:<tab name>:ford mustang';
    sford.dlwasSent = false;
    sford.eVar11 = 'brand:passenger:vehicle:promotions:<tab name>';
    sford.hier1 = 'vehicle:promotions:car:ford mustang:2015';
    sford.tagViewPhoto = '';
    sford.tagHighlights = '';
    sford.tagDownload = '';
    s.pageName = 'brand:passenger:vehicle:promotions:<tab name>:ford mustang';
    s.hier1 = 'vehicle:promotions:car:ford mustang:2015';
    s.channel = 'vehicle';
    s.eVar4 = 'rum';
    s.prop4 = 'rum';
