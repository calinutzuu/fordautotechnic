    ...
    <div class="tab-wrapper">
        <nav class="tabs" id="primaryTabs">
            <ul>
                ...
                <li><a href="/Autoturisme/NoulMustang/PrezentareGenerala#primaryTabs" class=" "
                ...
                <li><a href="/Autoturisme/NoulMustang/Design#primaryTabs" class=" "
                ...
                <li class="selected"><a href="/Autoturisme/NoulMustang/Performanta#primaryTabs"
                    ...
                    <div class="secondary-tabs tab-content">
                        <nav class="sub-nav">
                            <ul>
                                <li><a href='#tab1' class='omt_'>Performanţă</a></li>
                            </ul>
                        </nav>
                        <!-- isBtfTab : from MidPageTabs true -->
                        <div class="innertab-wrapper">
                            <!--  tabTitle : Performanţă :: btfTabContent : 1205078755909 :: tabContent :  -->
                            <div id='tab1' class="secondary-tab-content">
                                <header class="intro-header">
                                    <h1 class="bigHeading">
                                        Putere V8 sau EcoBoost: alegerea iti apartine.
                                    </h1>
                                    <span class="highlighter"></span>

                                    <p class="intro-text">

                                    <p>Noul Ford Mustang este construit sa iti ofere performanta fara compromisuri si
                                        eficienta sporita. V8 de 5,0 litri sau EcoBoost de 2,3 litri? Alegerea e numai a
                                        ta.</p>
                                    </p>
                                </header>
                                <article class="content-column left">
                                    ...
                                    <div class="content">
                                        <h3 class="bigHeading02">
                                            Motorul EcoBoost de 2,3 litri
                                        </h3>

                                        <p>

                                        <p><strong>Tehnologia avansata a motoarelor Ford EcoBoost</strong><br> <br>
                                            Parte a familiei EcoBoost - care include propulsorul ce beneficiaza de
                                            distinctia Motorul International al Anului - motorul de 2.3 litri are la
                                            baza o tehnologie revolutionara care incorporeaza injectia directa de
                                            combustibil, sistemul independent dual de distributie (arbore cu came) si
                                            turbocompresor. Rezultatul: 310 CP, cuplu de 434 Nm, eficienta a
                                            combustibilului surprinzatoare si emisii de numai 190 g/km CO<sub>2</sub>.
                                        </p>
                                        </p>
                                    </div>
                                </article>
                                <article class="content-column right">
                                    <div class="content">
                                        <h3 class="bigHeading02">
                                            Motorul V8 de 5.0 litri
                                        </h3>

                                        <p>

                                        <p><strong>Sunetul unui V8 de cinci litri</strong><br> <br> Puternicul motor V8
                                            de 5,0 litri dezvolta si mai multa putere: 418 CP si un cuplu de 524 Nm.
                                            Distributia puterii este uniforma si, aparent, neintrerupta, asa cum vei
                                            descoperi in timpul accelerarii. De asemenea, te poti bucura de sunetul
                                            inconfundabil, specific acestui motor.</p>
                                        </p>
                                    </div>
                                    <div class="img-column">
                            ...
                            <h2><a href='#tab1' class="mp-tab omt_xd_mt_ti">Performanţă</a></h2> -->
                            <!--</div>-->
                            <!-- END [MidPageTabs] -->
                            <!--  tabTitle :  :: btfTabContent :  :: tabContent :  -->
                            <!-- BEGIN [MidPageTabs] -->
...
<script id="TagIT.load"
        src='/cs/ContentServer?pagename=RORO4_ENGINE/script/packager&c=Page&cid=1205078751605&location=load&isMobile=false&require=main'
        defer></script>
</div>