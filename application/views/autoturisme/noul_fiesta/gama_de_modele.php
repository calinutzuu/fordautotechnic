...
<script type="text/javascript">
    ...
    MobileHomePageRedirectURL = 'gama-de-modele\/\/m.ford.ro';
    ...
    <div class="tab-wrapper">
        <nav class="tabs" id="primaryTabs">
            <ul>
                ...
                <li class="selected"><a href="gama-de-modele#primaryTabs"
                    ...
                    <div class="secondary-tabs tab-content">
                        <nav class="sub-nav">
                            <ul>
                                <li><a href='#tab1' class='omt_tabName'>Modele</a></li>
                            </ul>
                        </nav>
                        <!-- isBtfTab : from MidPageTabs true -->
                        <div class="innertab-wrapper">
                            <!--  tabTitle : Modele :: btfTabContent : 1205135247660 :: tabContent :  -->
                            <div id='tab1' class="secondary-tab-content">
                                <header class="intro-header">
                                    <h1 class="bigHeading">
                                        O singura masina, mai multe infatisari.<br><br>Fa cunostinta cu gama Fiesta
                                    </h1>
                                    <span class="highlighter"></span>

                                    <p class="intro-text">

                                    <p>Indiferent de nevoile tale practice si de gusturile personale. Si indiferent de
                                        nivelul de sportivitate, de stil si de lux pe care il cauti. Vei gasi exact ceea
                                        ce cauti cu noul Ford Fiesta. Trend, Titanium, Vignale, ST-Line, Active...<br>
                                        Fiecare model ofera ceva unic. Insa toate au un lucru in comun: reprezinta
                                        masina mica cea mai avansata din punct de vedere tehnologic de la Ford de pana
                                        in prezent.</p>
                                    </p>
                                </header>
                                <article class="content-column left">
                                    <div class="img-column"> <img
                                                src="/assets/img/1214606267242.jpg"
                                                alt="Fiesta Vignale. Imaginea rafinamentului"/><span
                                                class="fv-overlay-icon"></span></a></div>
                                    <div class="content">
                                        <h3 class="bigHeading02">
                                            Fiesta Vignale. Imaginea rafinamentului
                                        </h3>

                                        <p>

                                        <p>Urca in Fiesta Vignale si te vei inconjura de o&nbsp;lume a&nbsp;luxului
                                            contemporan. Un ecran elegant de afisaj Ford Vignale te intampina, in timp
                                            ce scaunele somptuoase, tapitate cu piele si cu modele hexagonale unice –
                                            impreuna cu pielea moale, exclusiva, care se intinde de-a lungul bordului si
                                            al consolei centrale – creeaza un interior complet din piele premium, in cel
                                            mai adevarat sens. Stil unic, grila frontala deosebita, jante din aliaj de
                                            17’’, sistem de sunet B&O&nbsp;PLAY disponibil... Descopera cele mai inalte
                                            niveluri de design, calitate si maiestrie a&nbsp;executiei, intruchipate in
                                            Fiesta Vignale.</p>
                                        </p>
                                    </div>
                                </article>
                                <article class="content-column right">
                                    <div class="content">
                                        <h3 class="bigHeading02">
                                            Fiesta ST-Line. O prezenta puternica
                                        </h3>

                                        <p>

                                        <p>Pregateste-te sa cresti nivelul de energie si incitare cu modelul
                                        <nobr>ST-Line</nobr>
                                        ce isi trage inspiratia din Ford Performance si din mașinile sport. De la
                                        jantele deosebite din aliaj, la kiturile superbe de personalizare a caroseriei
                                        si emblemele unice, modelul
                                        <nobr>ST-Line</nobr>
                                        te recompenseaza oriunde ai privi, ori de cate ori pornesti la drum. Iar cu
                                        scaunele sport tapitate cu rosu, te vei putea bucura de o&nbsp;pozitie de condus
                                        confortabila, din care aveti control absolut. </p>
                                        </p>
                                    </div>
                                    <div class="img-column"> <img
                                                src="/assets/img/1214606261880.jpg"
                                                alt="Fiesta ST-Line. O prezenta puternica"/><span
                                                class="fv-overlay-icon"></span></a></div>
                                </article>
                                <article class="content-column left">
                                    <div class="img-column"><img
                                                src="/assets/img/1214606260662.jpg"
                                                alt="Nivelul urmator, Fiesta Titanium"/><span
                                                class="fv-overlay-icon"></span></a></div>
                                    <div class="content">
                                        <h3 class="bigHeading02">
                                            Nivelul urmator, Fiesta Titanium
                                        </h3>

                                        <p>

                                        <p>SYNC 3 cu comanda vocala si ecran tactil color, jante din aliaj de 16’’,
                                            linie centrala cromata, volan, frana de mana si maneta a&nbsp;schimbatorului
                                            de viteze imbracate in piele, iluminat ambiental... Titanium incorporeaza o&nbsp;lista
                                            de invidiat de caracteristici inteligente si tehnologii istete, precum si un
                                            nivel de eleganta conceput pentru a&nbsp;impresiona. Dotari numeroase,
                                            calitate inalta, standarde ridicate: nu te astepta la nimic mai putin.</p>
                                        </p>
                                    </div>
                                </article>
                                <article class="content-column right">
                                    <div class="content">
                                        <h3 class="bigHeading02">
                                            Fiesta Trend. Surprinzator de sofisticata
                                        </h3>

                                        <p>

                                        <p>Dupa prima experienta cu noul Ford Fiesta, iti vei schimba pentru totdeauna
                                            asteptarile pe care le ai de la o mica masina. Atat la interior, cat si la
                                            exterior, Trend iti ofera mai multe tehnologii decat
                                        <nobr>te-ai</nobr>
                                        fi asteptat. Si, in combinatie cu un design inteligent si ultracontemporan,
                                        aceasta este o&nbsp;masina de care te vei bucura la maximum, de fiecare data
                                        cand te afli la volan.</p>
                                        </p>
                                    </div>
                                    <div class="img-column"> <img
                                                src="/assets/img/1214606260845.jpg"
                                                alt="Fiesta Trend. Surprinzator de sofisticata"/><span
                                                class="fv-overlay-icon"></span></a></div>
                                </article>
                                <article class="content-column left">
                                    <div class="img-column"> <img
                                                src="/assets/img/1214606265681.jpg"
                                                alt="Fiesta Active. Disponibil din 2018."/><span
                                                class="fv-overlay-icon"></span></a></div>
                                    <div class="content">
                                        <h3 class="bigHeading02">
                                            Fiesta Active. Disponibil din 2018.
                                        </h3>

                                        <p>

                                        <p>Caracter practic, flexibilitate, utilitate, plus un simt ridicat de aventura
                                            si exaltare maxima: Fiesta Active iti ofera totul. Acesta este primul model
                                            de Fiesta crossover de pana acum. Iar Active, in foarte multe feluri, este o
                                            masina care prezinta un stil inspirat de SUV-urile solide, incluzand o&nbsp;garda
                                            la sol ridicata, bare de acoperis si protectii suplimentare. Adauga
                                            adevarata dinamica a&nbsp;condusului Fiesta si vei avea parte de o&nbsp;experienta
                                            hatchback unica.</p>
                                        </p>
                                    </div>
                                </article>
                            ...
                            <h2><a href='#tab1' class="mp-tab omt_xd_mt_ti">Modele</a></h2> -->
                            <!--</div>-->
                            <!-- END [MidPageTabs] -->
                            <!--  tabTitle :  :: btfTabContent :  :: tabContent :  -->
                            <!-- BEGIN [MidPageTabs] -->
