    ...
    <script type="text/javascript">
        ...
        var bootstrapVehicleData = {"vehicles": [
            {"strIntroToFord": " ", "selector": {"bodystyles": {"options": [
                ...
                {"linkTitle": "VREAU S? FIU INFORMAT(?) ", "linkURL": "/SBE/VreauSaFiuInformata", "linkType": "tertiary", "linkTarget": "", "omid": "tr"}
                ...
                <li class="selected"><a href="Prezentare#primaryTabs"
                    ...
                    <div class="secondary-tabs tab-content">
                        ...
                        <div class="innertab-wrapper">
                            <!--  tabTitle : Overview :: btfTabContent : 1205116172332 :: tabContent :  -->
                            <div id='tab1' class="secondary-tab-content">
                                <header class="intro-header">
                                    <h1 class="bigHeading">
                                        NOUL FORD <b>FOCUS ST</b>
                                    </h1>
                                ...
                                <article class="content-column left">
                                    <div class="img-column"><a
                                            href="../../cs/ContentServer3fac?cid=1205116170936&amp;pagename=RORO4_ENGINE%2FEP2%2Fcommon%2Fmedia%2FMediaOverlay&amp;c=Image_C&amp;site=RORO4_ENGINE"
                                            class="js-overlay" data-media-overlay='{"height":439, "width":780}'> <img
                                                src="../../cs/BlobServer1667.jpg?blobtable=MungoBlobs&amp;blobcol=urldata&amp;blobheader=image%2Fjpeg&amp;blobwhere=1214556045300&amp;blobkey=id"
                                ...
                                <article class="content-column right">
                                    ...
                                    <div class="img-column"><a
                                            href="../../cs/ContentServer8b4f?cid=1205116175337&amp;pagename=RORO4_ENGINE%2FEP2%2Fcommon%2Fmedia%2FMediaOverlay&amp;c=Image_C&amp;site=RORO4_ENGINE"
                                            class="js-overlay" data-media-overlay='{"height":439, "width":780}'> <img
                                                src="../../cs/BlobServer1f2e.jpg?blobtable=MungoBlobs&amp;blobcol=urldata&amp;blobheader=image%2Fjpeg&amp;blobwhere=1214556045402&amp;blobkey=id"
                                                alt=" "/><span class="fv-overlay-icon"></span></a></div>
                                </article>
                            </div>
...
//alert(str);
    ...
    if (isDoubleclickTriggered === 'false') {
        if (typeof TagIT != 'object' || (typeof TagIT.handlesDoubleClick == 'function' || !TagIT.handlesDoubleClick)) {
            ...
            dataLayer.push({"pageTitle": 'Noul Focus ST 2015 | Ford RO'});
...
<script type="text/javascript">var sford = new Object;
    sford.tabName = '';
    sford.pageName = 'brand:passenger:vehicle:overview:<tab name>:ford focus st';
    sford.dlwasSent = false;
    sford.eVar11 = 'brand:passenger:vehicle:overview:<tab name>';
    sford.hier1 = 'vehicle:overview:car:ford focus st:2015';
    sford.tagViewPhoto = '';
    sford.tagHighlights = '';
    sford.tagDownload = '';
    s.pageName = 'brand:passenger:vehicle:overview:<tab name>:ford focus st';
    s.hier1 = 'vehicle:overview:car:ford focus st:2015';
    s.channel = 'vehicle';
    s.eVar4 = 'rum';
    s.prop4 = 'rum';
