                ...
                <li class="selected"><a href="PrezentareGenerala#primaryTabs"
                    ...
                    <div class="secondary-tabs tab-content">
                        ...
                        <div class="innertab-wrapper">
                            <!--  tabTitle : Prezentare :: btfTabContent : 1205118950452 :: tabContent :  -->
...
//alert(str);
    ...
    if (isDoubleclickTriggered === 'false') {
        if (typeof TagIT != 'object' || (typeof TagIT.handlesDoubleClick == 'function' || !TagIT.handlesDoubleClick)) {
            ...
            dataLayer.push({"pageTitle": 'Ford Focus | Prezentare Generala | Ford RO'});
...
<script type="text/javascript">var sford = new Object;
    sford.tabName = '';
    sford.pageName = 'brand:passenger:vehicle:overview:<tab name>:ford focus';
    sford.dlwasSent = false;
    sford.eVar11 = 'brand:passenger:vehicle:overview:<tab name>';
    sford.hier1 = 'vehicle:overview:car:ford focus:2015';
    sford.tagViewPhoto = '';
    sford.tagHighlights = '';
    sford.tagDownload = '';
    s.pageName = 'brand:passenger:vehicle:overview:<tab name>:ford focus';
    s.hier1 = 'vehicle:overview:car:ford focus:2015';
    s.channel = 'vehicle';
    s.eVar4 = 'rum';
    s.prop4 = 'rum';
