<script type="text/javascript">
    ...
    MobileHomePageRedirectURL = 'Noul-FordEdge\/\/m.ford.ro';
        ...
        <div itemscope itemtype="http://schema.org/ImageObject">
            <ul class="nameplate x-axis" id="vvmRoot">
                <li class="default-nameplate-vehicle"
                    style="background-image:url(http://www.ford.ro/cs/BlobServer?blobtable=MungoBlobs&amp;blobcol=urldata&amp;blobheader=image%2Fjpg&amp;blobwhere=1214553550026&amp;blobkey=id)">
    ...
    <div class="tab-wrapper">
        <nav class="tabs" id="primaryTabs">
            <ul>
                ...
                <li class="selected"><a href="Noul-FordEdge/Prezentare#primaryTabs"
                            ...
                            <div id='tab1' class="secondary-tab-content">
                                ...
                                <article class="content-column left">
                                    <div class="img-column"><img
                                                src="/assets/img/noul_edge/1214553549201.jpg"
                                ...
                                <article class="content-column right">
                                    ...
                                    <div class="img-column"><img
                                                src="/assets/img/noul_edge/1214553556282.jpg"
                ...
                <li><a href="Noul-FordEdge/Caracteristici#primaryTabs" class=" "
                ...
                <li><a href="Noul-FordEdge/Edge-Vignale#primaryTabs" class=" "
                ...
                <li><a href="Noul-FordEdge/Models#primaryTabs" class=" "
