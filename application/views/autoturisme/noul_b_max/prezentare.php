...
<div id="xAxis-detailed">
    <nav class="breadCrumb visuallyhidden" role="navigation">
        <ul itemprop="breadcrumb">
            ...
            Autoturisme
        </a><span></span></li><li data-selenium="breadcrumb_nameplate">B-MAX</li></ul>
    </nav>
    <script>
...
<section id="promoCarousel" class="promo-carousel box-shadow">
    ...
    <div class="slide-wrapper">
        <article class="slate slide">
            <a href='/Autoturisme/NoulB-MAX/PreturisiPromotii'>
<span class="active-promo-rover">
<span class="bg-opacity"></span>
<span class="link-icon"></span>
</span>
                <img src="/cs/BlobServer?blobtable=MungoBlobs&amp;blobcol=urldata&amp;blobheader=image%2Fjpg&amp;blobwhere=1214492080599&amp;blobkey=id" alt="Ford B-MAX">
...
<section id="non-js-promoCarousel" class="non-js-promo-carousel box-shadow">
    <div class="slide-wrapper">
        <p class="promo-carousel-text"><a href="/cs/ContentServer?pagename=RORO4_ENGINE/EP2/common/promo/M48_PromoBlock&amp;c=Promo_C&amp;cid=Prima Maşină de la Ford" target="_blank">Ford B-MAX</a></p>
    </div>
</section>
...
<section id="primary-tab-content" class="nameplate-tab-content" data-dynamic-tabcontent="false">
    <div class="tab-wrapper">
        <nav class="tabs" id="primaryTabs">
            <ul>
                <li class="selected"><a href="/Autoturisme/NoulB-MAX/Prezentare#primaryTabs" data-ajaxlink="/Autoturisme/NoulB-MAX/Prezentare">Prezentare general&#259;</a>
                </li>
                ...
                <li><a href="/Autoturisme/NoulB-MAX/PreturisiPromotii#primaryTabs" class="om_mt_ti"  data-ajaxlink="/Autoturisme/NoulB-MAX/PreturisiPromotii">PRE&#354;URI &#350;I PROMO&#354;II</a>
                </li>
    ...
    <nav class="sub-nav ">
        <ul>
            <li><a href="/Autoturisme/NoulB-MAX/Siguranta"
                    >Siguran&#539;&#259;</a></li>
        </ul>
                ...
                <div class="bto-body">
                    <div class="abstract">
                        ...
                        <div>Ford B-MAX a fost special conceput pentru șoferul contemporan, care profită din plin de toate posibilitățile unei vieți moderne. Cu toate că este o mașină compactă, ingeniosul sistem de acces &icirc;n habitaclu &icirc;ți oferă o deschidere de 1,5 metri către un interior spațios, rafinat și de calitate premium. <br>
                            <br>
                            Alături de designul unic, B-MAX are o multitudine de tehnologii care fac din condus o adevărată plăcere, un lucru simplu și eficient. De exemplu, sistemul Active City Stop reduce riscul sau consecințele unei coliziuni cu vehiculul aflat &icirc;n față, &icirc;n condiții de trafic lent, activ&acirc;nd automat fr&acirc;nele &icirc;n locul tău, la nevoie. Cu Ford SYNC<sup>&reg;</sup> &icirc;ți controlezi muzica și telefonul prin simple comenzi vocale &ndash; SYNC<sup>&reg;</sup> poate chiar să-ți citească mesajele prin boxele mașinii &ndash; totul pentru ca tu să poți conduce atent la drum și cu m&acirc;inile pe volan. Iar revoluționarul motor EcoBoost de 1,0 litru, pe benzină, produce puterea unui motor convenţional de 1,6, &icirc;nsă oferă cel mai bun consum din clasa lui. <br>
                            <br>
                            Află mai multe despre ingeniosul Ford B-MAX &icirc;n paginile de <a HREF="/Autoturisme/NoulB-MAX/Design" CONTENTEDITABLE="false" >design</a>, <a HREF="/Autoturisme/NoulB-MAX/ExperientaLaVolan" CONTENTEDITABLE="false" >experiență la volan</a>, <a HREF="/Autoturisme/NoulB-MAX/PerformantaSiEficienta" CONTENTEDITABLE="false" >performanță și eficiență</a> și <a HREF="/Autoturisme/NoulB-MAX/Siguranta" CONTENTEDITABLE="false" >siguranță</a>.</div>
                        <div><br>
                            <span style="font-size: x-small;">*Preţul exprimat include TVA și este valabil pentru Ford B-MAX, Trend, 5 uşi, 1.0 EcoBoost100 CP (Euro VI, consum mixt 5.1 l/100 km, emisii CO<sub>2</sub> (g/km): 119),  şi cuprinde contravaloarea tichetului Remat. Ofertă supusă unor termene și condiţii, valabilă &icirc;n limita stocului disponibil, la dealerii Ford participanţi la promoţie.</span></div>
                    </div>
                    <div class="body">
                    </div>
                </div>
...
<script id="TagIT.load" src='/cs/ContentServer?pagename=RORO4_ENGINE/script/packager&c=Page&cid=1205005696525&location=load&isMobile=false&require=main' defer></script>
</div>