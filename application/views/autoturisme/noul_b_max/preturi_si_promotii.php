...
<div id="xAxis-detailed">
    <nav class="breadCrumb visuallyhidden" role="navigation">
        <ul itemprop="breadcrumb">
            ...
            <li data-selenium="breadcrumb_nameplate">B-MAX</li>
        </ul>
    </nav>
    <script>
    ...
    <script type="text/javascript">
        ...
        var bootstrapVehicleData = {"vehicles":[
            ...
            ], "social":{"facebook":"https://facebook.com", "facebookPage":"fordromania"}, "disclaimer":"Modelul prezentat este un B-MAX Titanium. Imagine cu titlul de prezentare.", "seriesCode":"J6J", "uscCode":"004", "supportSelector":"true", "supportSeries":"true", "presId":"1205035169292", "promos":[
                {"imagePath":"/cs/BlobServer?blobtable=MungoBlobs&blobcol=urldata&blobwhere=1214492080599&blobkey=id", "overlay":false, "link":"/cs/ContentServer?pagename=RORO4_ENGINE/EP2/common/promo/M48_PromoBlock&c=Promo_C&cid=1205086714763", "text":"Prima Maşină de la Ford"}
            ], "idf":{"options":[
...
<span class="link-icon"></span>
                ...
                <img src="/cs/BlobServer?blobtable=MungoBlobs&amp;blobcol=urldata&amp;blobheader=image%2Fjpg&amp;blobwhere=1214492080599&amp;blobkey=id"
                     alt="Ford B-MAX">
    ...
    <div class="tab-wrapper">
        <nav class="tabs" id="primaryTabs">
            <ul>
                ...
                <li class="selected"><a href="/Autoturisme/NoulB-MAX/PreturisiPromotii#primaryTabs"
                                        data-ajaxlink="/Autoturisme/NoulB-MAX/PreturisiPromotii">PRE&#354;URI &#350;I
                    PROMO&#354;II</a>
                </li>
                <li><a href="/Autoturisme/NoulB-MAX/PerformantaSiEficienta#primaryTabs" class="om_mt_ti"
                       data-ajaxlink="/Autoturisme/NoulB-MAX/PerformantaSiEficienta">Performan&#355;&#259; &#351;i
                    eficien&#355;&#259;</a>
                </li>
            ...
            <div id='tab2' class="tab-content" style="display:none;">
                <section class="bto-wrapper">
                    <article class="bto-item">
                        ...
                        <div class="bto-body">
                            <div class="abstract">
                                <div>Dacă te interesează un anumit model, consultă ofertele noastre actuale. <br> <br>
                                    <a TITLE="Listă de prețuri Ford B-MAX (647 KB)"
                                       HREF="/assets/img/b_max/Lista de preturi Ford B-MAX.pdf"
                                       CLASS="download"
                                       onClick="if (typeof sford == 'object') omnitureLinkDownloadClick('brand:pricelist download:confirm:<nameplate>','event15,event43','','event:pricelist:pdf','download pricelist','pdf download','',false,'ford b-max','2012','car');">Descarcă
                                        lista de preţuri pentru Ford B-MAX</a>.
                                </div>
                                <div></div>
                                <div><a TITLE="Listă de prețuri Ford B-MAX - Trade In (65,3 KB)"
                                        HREF="/assets/img/b_max/Lista de preturi Ford B-MAX - Trade In.pdf"
                                        CLASS="download"
                                        onClick="if (typeof sford == 'object') omnitureLinkDownloadClick('brand:pdf download:retail price list','','','','','pdf download','',false,'ford b-max','2012','car');">Descarcă
                                    oferta specială Trade In - Ford B-MAX</a>.<br> <br> Fişierul &icirc;n format PDF a
                                    fost creat pentru a-ţi permite să vizualizezi şi să tipăreşti fişiere fără a avea
                                    nevoie de programul &icirc;n care au fost create iniţial. Adobe&trade; &icirc;ţi
                                    ...
                                    o descărca. <br> <a href="http://get.adobe.com/reader/%20">Descarcă Acrobat Reader
...
<script id="TagIT.load"
        src='/cs/ContentServer?pagename=RORO4_ENGINE/script/packager&c=Page&cid=1205006519281&location=load&isMobile=false&require=main'
        defer></script>
</div>