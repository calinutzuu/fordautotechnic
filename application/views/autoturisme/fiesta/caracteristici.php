...
<span class="link-icon"></span>
                ...
                <img
                    src="/assets/img/fiesta/1214553887403.jpg"
                    alt="Ford Fiesta">
...
<li class="selected"><a href="Caracteristici#primaryTabs">Caracteristici</a>
...
<div id='tab2' class="secondary-tab-content">
    ...
    <article class="content-column left">
        <div class="img-column"><img
                src="/assets/img/fiesta/1214560588637.jpg"
    ...
    <article class="content-column right">
        ...
        <div class="img-column"><img
                src="/assets/img/fiesta/1214560588804.jpg"
                alt="Indicator schimbare treaptade viteza"/></div>
    </article>
    <article class="content-column left">
        <div class="img-column"><img
                src="/assets/img/fiesta/1214560589056.jpg"
    ...
    <article class="content-column left">
        <div class="img-column"><img
                src="/assets/img/fiesta/1214560588307.jpg"
    ...
    <article class="content-column right">
        ...
        <div class="img-column"><img
                src="/assets/img/fiesta/1214560588473.jpg"
                alt="Ford Fiesta - EcoBoost"/></div>
    </article>
</div>
...
//alert(str);
    ...
    if (isDoubleclickTriggered === 'false') {
        if (typeof TagIT != 'object' || (typeof TagIT.handlesDoubleClick == 'function' || !TagIT.handlesDoubleClick)) {
            ...
            dataLayer.push({"pageTitle": 'Noul Ford Fiesta | Caracteristici | Ford RO'});
...
<script type="text/javascript">var sford = new Object;
    sford.tabName = '';
    sford.pageName = 'brand:passenger:vehicle:features:<tab name>:ford fiesta';
    sford.dlwasSent = false;
    sford.eVar11 = 'brand:passenger:vehicle:features:<tab name>';
    sford.hier1 = 'vehicle:features:car:ford fiesta:2013';
    sford.tagViewPhoto = '';
    sford.tagHighlights = '';
    sford.tagDownload = '';
    s.pageName = 'brand:passenger:vehicle:features:<tab name>:ford fiesta';
    s.hier1 = 'vehicle:features:car:ford fiesta:2013';
    s.channel = 'vehicle';
    s.eVar4 = 'rum';
    s.prop4 = 'rum';
