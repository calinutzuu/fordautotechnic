...
<script type="text/javascript">
    ...
    MobileHomePageRedirectURL = 'Prezentare-Generala\/\/m.ford.ro';
    MobileRedirectURL = MobileHomePageRedirectURL + '/autoturisme/fiesta';
</script>
                ...
                <li class="selected"><a href="/Autoturisme/Fiesta"
                    ...
                    <div class="secondary-tabs tab-content">
                        ...
                        <div class="innertab-wrapper">
                            <!--  tabTitle : Overview :: btfTabContent : 1205119305825 :: tabContent :  -->
                                ...
                                <header class="intro-header">
                                    ...
                                    <p>Asemenea unui smartphone performant si actual, Ford Fiesta imbina stilul
                                        ...
                                        <br><br> Datorita tehnologiilor inovatoare, fiecare clipa de condus va fi <a
                                            HREF="Caracteristici"><u>sigura</u></a>, <a HREF="Caracteristici"><u>confortabila</u></a>,
                                        <a HREF="Caracteristici"><u>interactiva</u></a> si distractiva. Iar masina
                                        este disponibila in 12 <a HREF="Accesorii"><u>culori </u></a>atractive.</p>
                                    </p>
                                </header>
                            </div>
...
//alert(str);
    ...
    if (isDoubleclickTriggered === 'false') {
        if (typeof TagIT != 'object' || (typeof TagIT.handlesDoubleClick == 'function' || !TagIT.handlesDoubleClick)) {
            ...
            dataLayer.push({"pageTitle": 'Ford Fiesta | Prezentare Generala| Autoturisme | Ford RO'});
...
<script type="text/javascript">var sford = new Object;
    sford.tabName = '';
    sford.pageName = 'brand:passenger:vehicle:overview:<tab name>:ford fiesta';
    sford.dlwasSent = false;
    sford.eVar11 = 'brand:passenger:vehicle:overview:<tab name>';
    sford.hier1 = 'vehicle:overview:car:ford fiesta:2013';
    sford.tagViewPhoto = '';
    sford.tagHighlights = '';
    sford.tagDownload = '';
    s.pageName = 'brand:passenger:vehicle:overview:<tab name>:ford fiesta';
    s.hier1 = 'vehicle:overview:car:ford fiesta:2013';
    s.channel = 'vehicle';
    s.eVar4 = 'rum';
    s.prop4 = 'rum';
