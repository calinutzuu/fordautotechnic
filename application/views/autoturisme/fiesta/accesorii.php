...
<script type="text/javascript">
    ...
    MobileHomePageRedirectURL = 'Accesorii\/\/m.ford.ro';
                ...
                <li class="selected"><a href="Accesorii#primaryTabs"
                    ...
                    <div class="secondary-tabs tab-content">
                        ...
                        <div class="innertab-wrapper">
                            ...
                            <div id='tab1' class="secondary-tab-content">
                                <article class='three-column'>
                                    <div class="content-block">
                                       <img
                                                src="/assets/img/fiesta/1214560589901.jpg"
                            ...
                            <h2><a href='#tab1' class="mp-tab omt_xd_mt_ti"> ACCESORII</a></h2> -->
                            <!--</div>-->
                            <!-- END [MidPageTabs] -->
                            <!--  tabTitle :  :: btfTabContent :  :: tabContent :  -->
                            <!-- BEGIN [MidPageTabs] -->
...
//alert(str);
    ...
    if (isDoubleclickTriggered === 'false') {
        if (typeof TagIT != 'object' || (typeof TagIT.handlesDoubleClick == 'function' || !TagIT.handlesDoubleClick)) {
            ...
            dataLayer.push({"pageTitle": 'Accesorii | Ford RO'});
...
<script type="text/javascript">var sford = new Object;
    sford.tabName = '';
    sford.pageName = 'brand:passenger:vehicle:design:<tab name>:ford fiesta';
    sford.dlwasSent = false;
    sford.eVar11 = 'brand:passenger:vehicle:design:<tab name>';
    sford.hier1 = 'vehicle:design:car:ford fiesta:2013';
    sford.tagViewPhoto = '';
    sford.tagHighlights = '';
    sford.tagDownload = '';
    s.pageName = 'brand:passenger:vehicle:design:<tab name>:ford fiesta';
    s.hier1 = 'vehicle:design:car:ford fiesta:2013';
    s.channel = 'vehicle';
    s.eVar4 = 'rum';
    s.prop4 = 'rum';
