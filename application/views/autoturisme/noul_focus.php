...
<section id="primary-tab-content" class="nameplate-tab-content" data-dynamic-tabcontent="false">
    <div class="tab-wrapper">
        <nav class="tabs" id="primaryTabs">
            <ul>
                <li class="selected"><a href="/Autoturisme/NoulFocus/PrezentareGenerala#primaryTabs"
                ...
                <li><a href="/Autoturisme/NoulFocus/PreturisiPromotii#primaryTabs" class="om_mt_ti"
                       data-ajaxlink="/Autoturisme/NoulFocus/PreturisiPromotii">PRE&#354;URI &#350;I PROMO&#354;II</a>
                </li>
            ...
            <article class="bto-item">
                ...
                <div class="bto-body">
                    <div class="abstract">
                        ...
                        <div>Cu un exterior complet restilizat, mai sculptural, şi cu un spaţiu &icirc;n cabină mai
                            avansat şi mai sofisticat ca niciodată, acesta este cel mai rafinat Focus de p&acirc;nă
                            acum. <br>
                            <br>
                            Acest model din generația următoare integrează, de asemenea, o gamă largă de noi tehnologii
                            remarcabile. De exemplu, Ford SYNC 2 cu comandă vocală şi ecran tactil de 8&rdquo; &icirc;ţi
                            permite să controlezi &icirc;n mod intuitiv sistemele de navigaţie, divertisment şi
                            climatizare ale maşinii, doar cu ajutorul vocii. Sistemul de asistenţă activă la parcare a
                            fost &icirc;mbunătăţit pentru a-ţi uşura parcările paralele, c&acirc;t şi pe cele
                            perpendiculare. <br>
                            <br>
                            O gamă largă de motoare pe benzină şi diesel de ultimă generaţie &icirc;ţi oferă echilibrul
                            perfect dintre putere şi economie de combustibil, iar transmisia PowerShift avansată şi
                            schimbările treptelor de viteză cu un schimbător cu padele maximizează performanţa şi
                            eficienţa. <br>
                            <br>
                            Află mai multe despre <a HREF="/Autoturisme/NoulFocus/ExperientaLaVolan"><u>experienţa
                                condusului</u></a>, nivelurile de <a
                                    HREF="/Autoturisme/NoulFocus/PerformantaSiEficienta"><u>performanţă şi eficienţă</u></a>,
                            dotările de siguranţă şi<u> </u><a HREF="/Autoturisme/NoulFocus/Design"><u>designul</u></a>
                            noului Focus.
                        </div>
                        <div><br>
                            *Preţul exprimat include TVA și este valabil pentru Ford Focus, Trend, 5 uşi, 1.0
                            EcoBoost100 CP (Euro VI, consum mixt 4.6 l/100 km, emisii CO<sub>2</sub> (g/km): 105), şi
                            cuprinde contravaloarea tichetului Remat. Ofertă supusă unor termene și condiţii,
                            valabilă &icirc;n limita stocului disponibil, la dealerii Ford participanţi la promoţie.
                        </div>
                    </div>
                    <div class="body">
                    </div>
