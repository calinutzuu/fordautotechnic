...
<script type="text/javascript">
    ...
    MobileHomePageRedirectURL = 'NoulGalaxy\/\/m.ford.ro';
</script>
    ...
    <div class="tab-wrapper">
        <nav class="tabs" id="primaryTabs">
            <ul>
                ...
                <li class="selected"><a href="NoulGalaxy/PrezentareGenerala#primaryTabs"
            ...
            <!--    <li><a href="NoulGalaxy/Preturi-si-promotii#primaryTabs" class=" "
                ...
                <li><a href="NoulGalaxy/Design#primaryTabs" class=" "
                ...
                <li><a href="NoulGalaxy/Caracteristici#primaryTabs" class=" "
