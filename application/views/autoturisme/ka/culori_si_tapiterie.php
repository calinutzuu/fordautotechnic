...
<nav class="sub-nav open">
    <ul>
        <li class="selected"><a href="/Autoturisme/Ka/Culorisitapiterie" class="om_mt_ti"
...
<section class="bto-wrapper">
    <article class="bto-item">
        <header class="bto-title">
            <h1>Culori noi pe străzi</h1>
        </header>
        <div class="bto-body">
            <div class="abstract">
                <p>Cu Ford Ka redescoperi bucuria şi entuziasmul de a conduce. Pe l&acirc;ngă culorile atrăgătoare,
                    expresia &icirc;ndrăzneaţă şi aspectul haios pe stradă, Ka este o maşină al cărei interior te va
                    atrage la fel de mult ca exteriorul. Interioarele special proiectate, cu materiale contrastante şi
                    finisaje moderne, adaugă la atracţia plină de viaţă şi lipsită de griji a modelului Ka.</p>
            </div>
            <div class="body">
            </div>
        </div>
...
<div class="tab-wrapper">
    <nav class="tabs" id="inner-tabs">
        <ul>
            <li><a href='#tab1' class='omt_'>Culori exterior</a></li>
            <li><a href='#tab2' class='omt_'>Culori interior</a></li>
        </ul>
    </nav>
</div>
<!-- BEGIN [MidPageTabs] -->
<div class="innertab-wrapper">
    ...
    <h2><a href='#tab1' class="mp-tab omt_xd_mt_ti">Culori exterior</a></h2> -->
    <div id='tab1' class="tab-content" style="display:none;">
        <section class="bti-wrapper">
            <article class="bti-item">
                <header class="bti-title">Gama de culori</header>
                <div class="bti-body">
                    <div class="abstract">
                        Aceasta este o maşină care niciodată nu va fi ignorată. Ca şi cum forma nu ar fi fost destul de
                        atrăgătoare, am creat o paletă de culori care accentuează stilul haios al noului Ka. Poţi
                        alege &icirc;ntre culori uni, culori metalizate şi culori speciale perlate.
                    </div>
                </div>
            </article>
        </section>
    ...
    <h2><a href='#tab2' class="mp-tab omt_xd_mt_ti">Culori interior</a></h2> -->
    <div id='tab2' class="tab-content" style="display:none;">
        <section class="bti-wrapper">
            <article class="bti-item">
                ...
                <div class="bti-body">
                    <div class="abstract">
                        Am acordat aceeaşi atenţie deopotrivă detaliilor legate de interiorul stilat şi designului
                        materialelor si culorilor care vin &icirc;n completarea acestuia. Mai jos, poţi vedea gama largă
                        de scheme de culori moderne şi imaginative din care poţi alege pentru a-ţi personaliza noul Ka.
                    </div>
                </div>
            </article>
        </section>
        <section class="igg-wrapper">
            ...
            <div class="igg-row">
                <article class="igg-item">
                    <div class="igg-image">
                        <a class="#">
                            <img alt="Tapi&#355;erie Ka Studio &icirc;n Syracuse"
                                 title="Tapi&#355;erie Ka Studio &icirc;n Syracuse"
                                 src="/assets/img/ka/1214376115964.jpg">
                        </a>

                    </div>
                    <div class="igg-body">Tapi&#355;erie Ka Studio &icirc;n Syracuse</div>
                </article>
                <article class="igg-item">
                    <div class="igg-image">
                        <a class="#">
                            <img alt="Tapi&#355;erie Ka Studio" title="Tapi&#355;erie Ka Studio"
                                 src="/assets/img/ka/1214375824319.jpg">
                        </a>
                    ...
                    <div class="igg-body">Tapi&#355;erie Ka Studio</div>
                </article>
                <article class="igg-item">
                    <div class="igg-image">
                        <a class="#">
                            <img alt="Tapi&#355;erie Ka" title="Tapi&#355;erie Ka"
                                 src="/assets/img/ka/1214484915697.jpg">
                        </a>
                    ...
                    <div class="igg-body">Tapi&#355;erie Ka</div>
                </article>
            </div>
        </section>
    </div>
...
<script id="TagIT.load"
        src='/cs/ContentServer?pagename=RORO4_ENGINE/script/packager&c=Page&cid=1204968940899&location=load&isMobile=false&require=main'
        defer></script>
</div>