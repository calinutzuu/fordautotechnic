<script type="text/javascript">
    ...
    MobileRedirectURL = MobileHomePageRedirectURL + '_Old/ListedePreturi';
</script>
...
<span class="link-icon"></span>
                ...
                <img src="/cs/BlobServer?blobtable=MungoBlobs&amp;blobcol=urldata&amp;blobheader=image%2Fjpg&amp;blobwhere=1214492080516&amp;blobkey=id"
                     alt="Ford KA">
...
<section id="primary-tab-content" class="nameplate-tab-content" data-dynamic-tabcontent="false">
    <div class="tab-wrapper">
        <nav class="tabs" id="primaryTabs">
            <ul>
                <li><a href="/Autoturisme/Ka/Prezentare#primaryTabs" class="om_mt_ti"
                ...
                <li class="selected"><a href="/Autoturisme/Ka/PreturisiPromotii#primaryTabs"
        ...
        <div class="innertab-wrapper">
            ...
            <div id='tab1' class="tab-content" style="display:none;">
                <section class="bto-wrapper">
                    <article class="bto-item">
                        <header class="bto-title">
                            <h1>FORD KA – Maşină mică, avantaje mari.</h1>
                        </header>
                        <div class="bto-body">
                            <div class="abstract">
                                <div>Original şi fantastic de condus, Ka impune noi standarde. Pe c&acirc;t de &icirc;ndrăzneaţă
                                    este la exterior, pe at&acirc;t de fermecătoare este şi la interior. Noul Ka este
                                    prevăzut cu toate dotările necesare pentru a &icirc;ţi oferi o experienţă urbană,
                                    sigură şi confortabilă: <br> <br>
                                    <ul>
                                        <li>airbaguri frontale şi laterale;</li>
                                        <li>sisteme ABS, ESP şi HLA;</li>
                                        <li>geamuri electrice faţă;</li>
                                        <li>faruri cu funcţie &ldquo;Follow me home&rdquo;;</li>
                                    </ul>
                                    <div>Iar acum, cea mai prietenoasă şi &icirc;ndrăzneaţă maşină urbană vine cu o
                                        ofertă specială: <strong>Ford Ka Trend 1.2</strong>, <strong>69 CP, la 6.650
                                            Euro* (TVA inclus)! </strong><br> <br> &Icirc;n plus, poţi beneficia de
                                        finanţare prin programul <strong>Prima Maşină de la Ford</strong>. După ce am
                                        creat &icirc;n premieră pentru Rom&acirc;nia programul Prima Maşină de la Ford,
                                        l-am dus şi mai departe, pentru a-l face mai ofertant ca niciodata! Principalele
                                        avantaje de care poţi beneficia sunt:<br> <br>
                                        <ul>
                                        ...
                                        <br>Contactează unul din consultantii nostrii <a></a> pentru un test drive şi
                                        detalii suplimentare!<br><br><span style="font-size: x-small;"><em>*Preţul
                                            exprimat include TVA și este valabil pentru Ford Ka, Trend, 3 uşi, 1.2l
                                            benzină, 69 CP (Euro VI, consum mixt 4.9 l/100 km, emisii CO<sub>2</sub>
                                            (g/km): 115), şi cuprinde contravaloarea tichetului Remat. Ofertă supusă
                                            ...
                                            valoare de 29.925 lei (cu TVA), avans 1.496,25 lei (minim 5%), valoarea
                                            totala a creditului va fi de 28.428,75 lei pe 60 luni: rata anuala a
                                            dobanzii (fixa) 4,57%, comision de analiza dosar 0 lei, comision lunar de
                                            administrare credit 0 lei, valoarea ratei lunare (pentru rate egale) 531
                                            lei, valoarea totala platibila 31.855 lei, DAE 4,67%. In calculul ratei
                                            lunare nu s-a inclus asigurarea optionala de viata si asigurarea CASCO. In
                                            cazul in care se opteaza pentru asigurarea (facultativa) de viata, rata
                                            lunara devine 574,5 lei.</em></span></div>
                                </div>
                            </div>
                            <div class="body">
                            </div>
            ...
            <div id='tab2' class="tab-content" style="display:none;">
                <section class="bto-wrapper">
                    <article class="bto-item">
                        <header class="bto-title">
                            <h1>Ford Ka - lista de preţuri</h1>
                        </header>
                        <div class="bto-body">
                            <div class="abstract">
                                Dacă te interesează un anumit model, consultă ofertele noastre actuale. Sau vizitează
                                cel mai apropiat dealer pentru cele mai bune oferte disponibile. <br>
                                <br>
                                <a TITLE="Listă de prețuri Ford Ka (718 KB)"
                                   HREF="/assets/img/ka/Lista de preturi Ford Ka.pdf" CLASS="download"
                                   onClick="if (typeof sford == 'object') omnitureLinkDownloadClick('brand:pricelist download:confirm:<nameplate>','event15,event43','','event:pricelist:pdf','download pricelist','pdf download','',false,'ford ka','2009','car');">Descarcă
                                    lista de preţuri pentru Ford Ka</a>. <br>
                                <br>
                                <br>

                                <div>Fişierul &icirc;n format PDF a fost creat pentru a-ţi permite să vizualizezi şi să
                                    tipăreşti fişiere fără a avea nevoie de programul &icirc;n care au fost create
                                    iniţial. Adobe&trade; &icirc;ţi pune la dispoziţie o aplicaţie software gratuită
                                    (Acrobat Reader) care &icirc;ţi permite să lucrezi cu aceste fişiere. Dacă ai
                                    instalat deja această aplicaţie pe computerul tău, &icirc;n mod normal o poţi găsi
                                    la &quot;Programe&quot;, &icirc;n &quot;Meniul Start&quot;. &Icirc;n caz contrar,
                                    acceseză link-ul de mai jos pentru a o descărca. <br>
                                    <br>
                                    <a href="http://get.adobe.com/reader/">Descarcă Acrobat Reader de pe situl
                                        adobe.com</a></div>
                            </div>
                            <div class="body">
                                <br>
...
<script id="TagIT.load"
        src='/cs/ContentServer?pagename=RORO4_ENGINE/script/packager&c=Page&cid=1204961328124&location=load&isMobile=false&require=main'
        defer></script>
</div>