...
<script type="text/javascript">
    ...
    MobileHomePageRedirectURL = 'Mondeo\/\/m.ford.ro';
</script>
    ...
    <div class="tab-wrapper">
        <nav class="tabs" id="primaryTabs">
            <ul>
                ...
                <li class="selected"><a href="Mondeo/Prezentare#primaryTabs"
                    ...
                    <div class="secondary-tabs tab-content">
                        ...
                        <div class="innertab-wrapper">
                            <!--  tabTitle : Overview :: btfTabContent : 1205078765933 :: tabContent :  -->
                            <div id='tab1' class="secondary-tab-content">
                                <header class="intro-header">
                                    <h1 class="bigHeading">
                                        Iti prezentam NOUL FORD <b>MONDEO</b>
                                    </h1>
                                    <span class="highlighter"></span>

                                    <p class="intro-text">

                                    <p>Stilul elegant, impunator si ultramodern creeaza un profil dinamic, o declaratie
                                        impunatoare ce exprima performanta si eficienta noului model. Imbinand designul
                                        sofisticat si inteligent, cu executia precisa si tehnologiile de ultima ora,
                                        noul Mondeo duce experienta de condus la un nou nivel.<br><br>
                                    </p>
                                </header>
                                <article class="content-column left">
                                    <div class="img-column">

                                        <img src="/assets/img/mondeo/1214487217360.jpg"
                                             alt="Faruri autoadaptive cu tehnologie LED"/><span
                                            class="fv-overlay-icon"></span></a></div>
                                    <div class="content">
                                        <h3 class="bigHeading02">
                                            Faruri autoadaptive cu tehnologie LED
                                        </h3>

                                        <p>

                                        <p>Pe lunga lista de inovatii Ford, se numara farurile autoadaptive cu
                                            tehnologie LED, care se misca in timp ce rotesti volanul, pentru un plus de
                                            vizibilitate in viraje. Spre deosebire de luminile traditionale, acestea
                                            utilizeaza LED-uri ultra-eficiente si incorporeaza opt moduri diferite de
                                            iluminare.<br><br>Astfel, farurile pot reactiona la mediul inconjurator,
                                            schimband faza si intensitatea luminii, in functie de drumurile si
                                            conditiile meteo.</p>
                                        </p>
                                    </div>
                                </article>
                                <article class="content-column right">
                                    <div class="content">
                                        <h3 class="bigHeading02">
                                            Centuri de siguranta cu airbag incorporat
                                        </h3>

                                        <p>

                                        <p>O alta inovatie remarcabila este reprezentata de sistemul unic de centuri de
                                            siguranta cu airbag incorporat, care ofera pasagerilor din spate, de pe
                                            locurile dinspre exterior, un nivel de protectie superior.</p>
                                        </p>
                                    </div>
                                    <div class="img-column">
                                        <img src="/assets/img/mondeo/1214487219942.jpg"
                                             alt="Un plus de protectie pentru pasagerii din spate"/><span
                                            class="fv-overlay-icon"></span></a></div>
                                </article>
                            </div>
                ...
                <li><a href="Mondeo/Caracteristici#primaryTabs" class=" "
                ...
                <li><a href="Mondeo/Vignale#primaryTabs" class=" "
