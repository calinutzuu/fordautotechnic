...
<script type="text/javascript">var sford = new Object;
    sford.tabName = '';
    sford.pageName = 'brand:passenger:vehicle:promotions:<tab name>:ford edge';
    sford.dlwasSent = false;
    sford.eVar11 = 'brand:passenger:vehicle:promotions:<tab name>';
    sford.hier1 = 'vehicle:promotions:car:ford edge:2015';
    sford.tagViewPhoto = '';
    sford.tagHighlights = '';
    sford.tagDownload = '';
    s.pageName = 'brand:passenger:vehicle:promotions:<tab name>:ford edge';
    s.hier1 = 'vehicle:promotions:car:ford edge:2015';
    s.channel = 'vehicle';
    s.eVar4 = 'rum';
    s.prop4 = 'rum';
