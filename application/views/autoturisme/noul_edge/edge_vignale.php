<script type="text/javascript">
    ...
    MobileHomePageRedirectURL = 'Edge-Vignale\/\/m.ford.ro';
    ...
    <div class="tab-wrapper">
        <nav class="tabs" id="primaryTabs">
            <ul>
                ...
                <li class="selected"><a href="Edge-Vignale#primaryTabs"
                    ...
                    <div class="secondary-tabs tab-content">
                        <nav class="sub-nav">
                            <ul>
                                <li><a href='#tab1' class='omt_tabName'>Vignale</a></li>
                            </ul>
                        </nav>
                        <!-- isBtfTab : from MidPageTabs true -->
                        <div class="innertab-wrapper">
                            <!--  tabTitle : Vignale :: btfTabContent : 1205110250027 :: tabContent :  -->
                            <div id='tab1' class="secondary-tab-content">
                                <header class="intro-header">
                                    <h1 class="bigHeading">
                                        Stil si trasaturi aparte
                                    </h1>
                                    <span class="highlighter"></span>

                                    <p class="intro-text">

                                    <p>Ford Edge Vignale este cel mai contemporan si stilat SUV al nostru de pana acum.
                                        Finisajele deosebite, executate manual, materialele premium si tehnologiile
                                        impresionante se imbina armonios pentru a oferi o experienta de condus
                                        superioara. Pe langa serviciile exclusiviste Ford Vignale oferite fiecarui
                                        proprietar, Ford Edge Vignale stabileste noi standarde de design si performanta.<br>
                                        <br> <a href="https://vignale.ford.ro/ro-RO/" target="_blank">Exploreaza Ford
                                            Vignale</a><br> <a TITLE="Lista de preturi Edge Vignale (302 KB)"
                                                               HREF="../../cs/Lista_de_preturi_Edge_Vignale8319.pdf?blobtable=MungoBlobs&amp;blobcol=urldata&amp;blobheadervalue1=attachment%3Bfilename%3D%22Lista_de_preturi_Edge_Vignale.pdf%22&amp;blobheadervalue2=abinary%3Bcharset%3DUTF-8&amp;blobheadername1=Content-Disposition&amp;blobheadername2=MDT-Type&amp;blobheader=application%2Fpdf&amp;blobwhere=1214563238003&amp;blobkey=id"
                                                               CLASS="download"
                                                               onClick="if (typeof sford == 'object') omnitureLinkDownloadClick('brand:pricelist download:vehicle:confirm:<nameplate>','event15,event43','','event: pricelist:pdf','download pricelist:vehicle','pdf download','',false,'ford edge vignale','2016','car');">Descarca
                                            lista de preturi</a></p>
                                    </p>
                                </header>
                                <article class='three-column'>
                                    <div class="content-block">
                                        <img
                                                src="/assets/img/noul_edge/1214553591537.jpg"
                                                alt="Ford Edge Vignale"/><span class="fv-overlay-icon"></span>
                                    ...
                                    <div class="content-block">
                                        <img
                                                src="/assets/img/noul_edge/1214553591450.jpg"
                                                alt="Ford Edge Vignale Rear"/><span class="fv-overlay-icon"></span>
                                        <h3 class="bigHeading02">
                                        </h3>
                                    ...
                                    <div class="content-block last">
                                        <img
                                                src="/assets/img/noul_edge/1214553591622.jpg"
                                                alt="Ford Edge Vignale Side"/><span class="fv-overlay-icon"></span>
                                        <h3 class="bigHeading02">
                                        </h3>
                            ...
                            <h2><a href='#tab1' class="mp-tab omt_xd_mt_ti">Vignale</a></h2> -->
                            <!--</div>-->
                            <!-- END [MidPageTabs] -->
                            <!--  tabTitle :  :: btfTabContent :  :: tabContent :  -->
                            <!-- BEGIN [MidPageTabs] -->
...
//alert(str);
    ...
    if (isDoubleclickTriggered === 'false') {
        if (typeof TagIT != 'object' || (typeof TagIT.handlesDoubleClick == 'function' || !TagIT.handlesDoubleClick)) {
            ...
            dataLayer.push({"pageTitle": 'New Ford Edge 2016 Vignale | Ford UK'});
...
<script type="text/javascript">var sford = new Object;
    sford.tabName = '';
    sford.pageName = 'brand:passenger:vehicle:model:vignale:<tab name>:ford edge';
    sford.dlwasSent = false;
    sford.eVar11 = 'brand:passenger:vehicle:model:vignale:<tab name>';
    sford.hier1 = 'vehicle:model:car:ford edge:2015';
    sford.tagViewPhoto = '';
    sford.tagHighlights = '';
    sford.tagDownload = '';
    s.pageName = 'brand:passenger:vehicle:model:vignale:<tab name>:ford edge';
    s.hier1 = 'vehicle:model:car:ford edge:2015';
    s.channel = 'vehicle';
    s.eVar4 = 'rum';
    s.prop4 = 'rum';
    s.eVar11 = 'brand:passenger:vehicle:model:vignale:<tab name>';
    s.prop11 = 'brand:passenger:vehicle:model:vignale:<tab name>';
    s.eVar12 = '2015';
    s.prop12 = '2015';
    sford.my = '2015';
    s.eVar14 = 'ford-ro';
