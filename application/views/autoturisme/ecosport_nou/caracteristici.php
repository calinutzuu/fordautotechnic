...
<!--  tabTitle : Experienta la volan :: btfTabContent : 1205150777526 :: tabContent :  -->
<div id='tab1' class="secondary-tab-content">
    ...
    <article class="content-column left">
        ...
        <div class="content">
            ...
            <p>Un Sistem de Tractiune Integrala (AWD) Inteligenta poate determina cata aderenta, balans in viraje si ce
                nivel de reactie sunt necesare in conditii de vreme umeda, uscata sau cu gheata si pe teren schimbator.
                Tehnologia poate muta tractiunea pe puntea din fata sau din spate, in functie de cerinte. Iar acest
                sistem de „cuplu la cerere” asigura o manevrabilitate exceptionala si eficienta imbunatatita.</p>
            </p>
        </div>
    </article>
...
<div id='tab5' class="secondary-tab-content">
    ...
    <article class="content-column right">
        <div class="content">
            ...
            <p>Podeaua de incarcare din portbagaj dispune de trei setari de inaltime, asa ca poti crea un compartiment
                ascuns de diverse dimensiuni, sub podeaua portbagajului. Cand o setezi in cea mai inalta pozitie si cu
...
<script type="text/javascript">var sford = new Object;
    ...
    sford.hier1 = 'vehicle:features:car:ford ecosport:2017';
    sford.tagViewPhoto = '';
    sford.tagHighlights = '';
    sford.tagDownload = '';
    s.pageName = 'brand:passenger:vehicle:features:<tab name>:ford ecosport';
    s.hier1 = 'vehicle:features:car:ford ecosport:2017';
    s.channel = 'vehicle';
    s.eVar4 = 'rum';
    s.prop4 = 'rum';
