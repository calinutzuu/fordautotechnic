...
<div id="xAxis-detailed">
    ...
    <script>
        var vehicleimagepackpresid = '1205150772859';
    ...
    <script type="text/javascript">
        ...
        var bootstrapVehicleData = {"vehicles": [
            ...
            ], "social": {"facebook": "https://facebook.com", "facebookPage": "fordromania"}, "disclaimer": "Modelul prezentat este un Ford EcoSport", "seriesCode": "AUTHORED", "uscCode": "AUTHORED", "presId": "1205150772859", "promos": [
                {"imagePath": "/cs/BlobServer?blobtable=MungoBlobs&blobcol=urldata&blobwhere=1214641470417&blobkey=id", "overlay": false, "link": "/cs/ContentServer?pagename=RORO4_ENGINE/EP2/common/promo/M48_PromoBlock&c=Promo_C&cid=1205150859731", "text": "Vezi oferta speciala"}
            ], "idf": {"options": []}}
        ]} || {};
        ...
        <div itemscope itemtype="http://schema.org/ImageObject">
            <ul class="nameplate x-axis" id="vvmRoot">
                <li class="default-nameplate-vehicle"
                    style="background-image:url(http://www.ford.ro/cs/BlobServer?blobtable=MungoBlobs&amp;blobcol=urldata&amp;blobheader=image%2Fjpg&amp;blobwhere=1214641467623&amp;blobkey=id)">
...
<section id="promoCarousel" class="promo-carousel box-shadow">
    ...
    <div class="slide-wrapper">
        <article class="slate slide">
            <a href='http://www.ford.ro/Promotii/Autoturisme/Noul-EcoSport'>
<span class="active-promo-rover">
<span class="bg-opacity"></span>
<span class="link-icon"></span>
</span>
                <img
                    src="http://www.ford.ro/cs/BlobServer?blobtable=MungoBlobs&amp;blobcol=urldata&amp;blobheader=image%2Fjpg&amp;blobwhere=1214641470417&amp;blobkey=id"
                    alt="Noul Ford EcoSport Offerta Speciala">
...
<section id="non-js-promoCarousel" class="non-js-promo-carousel box-shadow">
    <div class="slide-wrapper">
        <p class="promo-carousel-text"><a
                ...
                target="_blank">Noul Ford EcoSport Offerta Speciala</a></p>
    </div>
</section>
<!-- Tabs -->
<script
...
<ul>
    ...
    <li><a href="/Autoturisme/NoulEcosport" class=" "
    ...
    <li class="selected"><a href="Design#primaryTabs"
        ...
        <div class="secondary-tabs tab-content">
            ...
            <div class="innertab-wrapper">
                <!--  tabTitle : Exterior :: btfTabContent : 1205150773876 :: tabContent :  -->
                <div id='tab1' class="secondary-tab-content">
                    <header class="intro-header">
                        ...
                        <p>Noul EcoSport este fara indoiala un SUV
                            si cu siguranta vei observa cat de solid este.
                            Insa liniile curate, sculptate si
                            forma fluida, eleganta, fac din EcoSport o masina
                            stilata, sofisticata si proiectata
                            pentru a iesi in evidenta, oriunde ar merge. </p>
                        </p>
                    </header>
                    <article class='three-column'>
                        <div class="content-block">
                            <img
                                    src="/assets/img/ecosport/1214641470072.jpg"
                        ...
                        <div class="content-block">
                            <img
                                    src="/assets/img/ecosport/1214641468891.jpg"
                                    alt="Noul Ford EcoSport argintiu in miscare"/><span class="fv-overlay-icon"></span>
                        ...
                        <div class="content-block last">
                            <img
                                    src="/assets/img/ecosport/1214641467092.jpg"
                                    alt="Noul Ford EcoSport albastru in miscare"/><span class="fv-overlay-icon"></span>
                    ...
                    <article class='three-column'>
                        <div class="content-block">
                            <img
                                    src="/assets/img/ecosport/1214641468061.jpg"
                                    alt="Noul Ford EcoSport albastru, vedere din spate"/><span
                        ...
                        <div class="content-block">
                            <img
                                    src="/assets/img/ecosport/1214641467458.jpg"
                                    alt="Noul Ford EcoSport alb, vedere laterala"/><span class="fv-overlay-icon"></span>
                            ...
                            <p>Un profil modern, deosebit</p>
                            </p>
                        </div>
                        <div class="content-block last">
                            <img
                                    src="/assets/img/ecosport/1214641469740.jpg"
                                    alt="Noul Ford EcoSport albastru, vedere din fata"/><span
                                    class="fv-overlay-icon"></span>
                ...
                <!--  tabTitle : Interior :: btfTabContent : 1205150776160 :: tabContent :  -->
                <div id='tab2' class="secondary-tab-content">
                    <header class="intro-header">
                        ...
                        <p>Construit ergonomic in jurul nevoilor tale si ale pasagerilor tai, interiorul frumos executat
                            al noului EcoSport a fost special conceput pentru ca tu sa petreci mult timp, cu placere.
                            Suprafetele curate, simple si ordonate sunt dublate de un design bine gandit si de o atentie
                            deosebita la detalii.
                            Ia un loc, relaxeaza-te si bucura-te de o perspectiva la inaltime, in confort absolut.</p>
                        </p>
                    </header>
                    <article class='three-column'>
                        <div class="content-block">
                            <img
                                    src="/assets/img/ecosport/1214641469231.jpg"
                                    alt="Interiorul noului Ford EcoSport"/><span class="fv-overlay-icon"></span>
                        ...
                        <div class="content-block">
                            <img
                                    src="/assets/img/ecosport/1214641467646.jpg"
                                    alt="Panoul de bord al noului Ford EcoSport"/><span class="fv-overlay-icon"></span>
                        ...
                        <div class="content-block last">
                            <img
                                    src="/assets/img/ecosport/1214641469060.jpg"
                                    alt="Sistemul SYNC al noului Ford EcoSport"/><span
                    ...
                    <article class='three-column'>
                        <div class="content-block">
                            <img
                                    src="/assets/img/ecosport/1214641468476.jpg"
                                    alt="Vedere sofer in noul Ford EcoSport"/><span class="fv-overlay-icon"></span>
                        ...
                        <div class="content-block">
                            <img
                                    src="/assets/img/ecosport/1214641468725.jpg"
                                    alt="Scaunele noului Ford EcoSport"/><span class="fv-overlay-icon"></span>
                        ...
                        <div class="content-block last">
                            <img
                                    src="/assets/img/ecosport/1214641469489.jpg"
                                    alt="Scaunele spate ale noului Ford EcoSport"/><span class="fv-overlay-icon"></span>
...
<script type="text/javascript">var sford = new Object;
    ...
    sford.hier1 = 'vehicle:gallery:car:ford ecosport:2017';
    sford.tagViewPhoto = '';
    sford.tagHighlights = '';
    sford.tagDownload = '';
    s.pageName = 'brand:passenger:vehicle:gallery:<tab name>:ford ecosport';
    s.hier1 = 'vehicle:gallery:car:ford ecosport:2017';
    s.channel = 'vehicle';
    s.eVar4 = 'rum';
    s.prop4 = 'rum';
...
<!-- Mirrored from www.ford.ro/Autoturisme/NoulEcosport/Design by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 23 Oct 2017 09:08:40 GMT -->
</html>
