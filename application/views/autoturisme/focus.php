...
<script type="text/javascript">
    ...
    MobileHomePageRedirectURL = 'Focus\/\/m.ford.ro';
        ...
        <div itemscope itemtype="http://schema.org/ImageObject">
            <ul class="nameplate x-axis" id="vvmRoot">
                <li class="default-nameplate-vehicle"
                    style="background-image:url(/assets/img/noul_focus/1214481762939.jpg)">
...
<span class="link-icon"></span>
                ...
                <img
                    src="/assets/img/noul_focus/1214564411460.jpg"
                    alt="Ford Fiesta">
...
<h2><a href='#tab1' class="mp-tab omt_xd_mt_ti">Prezentare</a></h2> -->
              ...
              <!--  <li><a href="Focus/PreturisiPromotii#primaryTabs" class=" "
                ...
                <li><a href="Focus/Caracteristici#primaryTabs" class=" "
