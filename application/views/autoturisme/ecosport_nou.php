...
<script type="text/javascript">
    ...
    MobileHomePageRedirectURL = 'NoulEcosport\/\/m.ford.ro';
</script>
...
<span class="link-icon"></span>
                ...
                <img
                    src="/assets/img/ecosport/1214641470417.jpg"
...
<script type="text/javascript">var sford = new Object;
    sford.tabName = '';
    sford.pageName = 'brand:passenger:vehicle:overview:<tab name>:ford ecosport';
    sford.dlwasSent = false;
    sford.eVar11 = 'brand:passenger:vehicle:overview:<tab name>';
    sford.hier1 = 'vehicle:overview:car:ford ecosport:2017';
    sford.tagViewPhoto = '';
    sford.tagHighlights = '';
    sford.tagDownload = '';
    s.pageName = 'brand:passenger:vehicle:overview:<tab name>:ford ecosport';
    s.hier1 = 'vehicle:overview:car:ford ecosport:2017';
    s.channel = 'vehicle';
    s.eVar4 = 'rum';
    s.prop4 = 'rum';
