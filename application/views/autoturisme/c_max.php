<script type="text/javascript">
    ...
    MobileRedirectURL = MobileHomePageRedirectURL + '/autoturisme/noul-c-max/info';
</script>
    ...
    <div class="tab-wrapper">
        <nav class="tabs" id="primaryTabs">
            <ul>
                ...
                <li class="selected"><a href="/Autoturisme/NoulC-MAX/Info#primaryTabs" data-ajaxlink="/cs/ContentServer?cid=1205084251905&amp;pagename=ENGInE%2FEP2%2Fbody%2Fcars%2Fxaxis_detailed%2FStateChangeJSON&amp;c=Page&amp;site=RORO4_ENGINE">Descopera noul C-MAX</a>
                    <!--This is where the main content for the selected tab will go -->
                    <!-- secondary tabs -->
                    <div class="secondary-tabs tab-content">
                        <nav class="sub-nav">
                            <ul>
                                <li><a href='#tab1' class='omt_'>Noul C-MAX</a></li>
                            </ul>
                        </nav>
                        <!-- isBtfTab : from MidPageTabs true -->
                        <div class="innertab-wrapper">
                            <!--  tabTitle : Noul C-MAX :: btfTabContent : 1205087696338 :: tabContent :  -->
                            <div id='tab1' class="secondary-tab-content">
                                <header class="intro-header">
                                    <h1 class="bigHeading">
                                        Descopera noul FORD <strong>C-MAX</strong>
                                    </h1>
                                    <span class="highlighter"></span>
                                    <p class="intro-text">
                                    <div><iframe frameborder="0" style="width: 100%; height: 1500px; overflow: hidden" scrolling="no" src="http://tehnologieauto.digitalk.ro/iframeCmaxLanding"></iframe></div>
                                    </p>
                                </header>
                            </div>
                            ...
                            <h2><a href='#tab1' class="mp-tab omt_xd_mt_ti">Noul C-MAX</a></h2> -->
                            <!--</div>-->
                            <!-- END [MidPageTabs] -->
                            <!--  tabTitle :  :: btfTabContent :  :: tabContent :  -->
                            <!-- BEGIN [MidPageTabs] -->
