    ...
    <div class="left_item">
        ...
        <div class="navmenu">
            ...
            <ul id="nextSteps" class="nextSteps">
                ...
                <li id='menu1205082025956' class=''>
                    <a href='/FordLeasing/leasingoperational'>Leasing operational</a>
                    <script type="text/javascript">
                        document.id('menu1205082025956').addClass("navnextSteps");
                    </script>
                </li>
            </ul>
...
<div id="container_main">
    <div id="mediaplayer1">
        ...
        <div class="mdp2Box">
            ...
            <div id="mdp">
                <img src='/assets/img/finantare/1214489051441.jpg' alt='Prezentare' onclick="omnitureViewPhoto()">
            </div>
    ...
    <div id="container_center">
        ...
        <div class="center_item">
            ...
            <div class="BTIRow">
                <div class="BTIOneItem">
                    <div class="BTIarticleTitle">
                        Costuri mai mici, bucurii mai mari
                    </div>
            ...
            <div class="BTIRow">
                <div class="BTIOneItem">
                    <div class="BTIarticleTitle">
                        Înnoiți-vă parcul auto cu Ford
                    </div>
                    <div class='BTIarticleBody'>
                        <div class='BTIarticleText'>
            ...
            <div class="BTIRow">
                <div class="BTIOneItem">
                    <div class="BTIarticleTitle">
                        Rate fixe și management de flote
                    </div>
                    <div class='BTIarticleBody'>
                        <div class='BTIarticleText'>
